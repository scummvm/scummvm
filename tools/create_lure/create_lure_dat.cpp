...
AnimListRecord animDataList[] = {
	...
	{{0x55C0, 0x5680, 0x56A0, 0x56D0, 0x56e0}},	// Player midswing animation
	{{0x55C9, 0x5689, 0x56A9, 0x56D9, 0x56e9}},	// Player mid-level defend
	{{0x55D2, 0x5692, 0x56B2, 0x56E2, 0x56f2}},	// Player high-level strike
	{{0x55DB, 0x569B, 0x56BB, 0x56EB, 0x56fb}},	// Player high-level defend
	{{0x55E4, 0x56A4, 0x56C4, 0x56F4, 0x5704}},	// Player low-level strike
	{{0x55ED, 0x56AD, 0x56CD, 0x56FD, 0x570d}},	// Player low-level defend
	{{0x55F6, 0x56B6, 0x56D6, 0x5706, 0x5716}},	// Player fight animation
	{{0x55FF, 0x56BF, 0x56DF, 0x570F, 0x571f}},	// Pig fight animation
	{{0x5608, 0x56C8, 0x56E8, 0x5718, 0x5728}}, // Pig fight animation
	{{0x5611, 0x56D1, 0x56F1, 0x5721, 0x5731}},	// Player mid-level strike
	{{0x5623, 0x56E3, 0x5703, 0x5733, 0x5743}},	// Pig fight animation
	{{0x562C, 0x56EC, 0x570C, 0x573C, 0x574c}},	// Misc fight animation
	{{0x5635, 0x56F5, 0x5705, 0x5745, 0x5755}},	// Pig fight animation
	{{0x563E, 0x56FE, 0x571E, 0x574E, 0x575e}},	// Player recoiling from hit
	{{0x5647, 0x5707, 0x5727, 0x5757, 0x5767}},	// Pig recoiling from hit
	{{0x5650, 0x5710, 0x5730, 0x5760, 0x5770}},	// Pig dies
	{{0x5810, 0x58D0, 0x58F0, 0x5920, 0x58f0}},	// Voice bubble
	{{0x5915, 0x59D5, 0x59F5, 0x5a25, 0x5a35}},	// Blacksmith hammering
	...
	{{0x59FF, 0x5ABF, 0x5ADF, 0x5b0f, 0x5b1f}},	// Dragon breathing fire
	{{0x5A08, 0x5AC8, 0x5AE8, 0x5b18, 0x5b28}},	// Dragon breathing fire 2
	{{0x5A11, 0x5AD1, 0x5AF1, 0x5b21, 0x5b38}},	// Dragon breathing fire 3
	{{0x5A1A, 0x5ADA, 0x5AFA, 0x5b2a, 0x5b3a}},	// Player turning winch in room #48
	{{0x5A59, 0x5B19, 0x5B39, 0x5b69, 0x5b79}},	// Player pulling lever in room #48
	{{0x5A62, 0x5B22, 0x5B42, 0x5b72, 0x5b82}},	// Minnow pulling lever in room #48
	{{0x5AAA, 0x5B6A, 0x5B8A, 0x5bba, 0x5bca}},	// Goewin mixing potion

...
#include "engines/ultima8/std/string.h"
#include "engines/ultima8/misc/util.h"
...
class U8UtilTestSuite : public CxxTest::TestSuite {
	...
	void test_trim_spaces() {
		Ultima8::Std::string s0 = "   ";
		Ultima8::TrimSpaces(s0);
		TS_ASSERT_EQUALS(s0, Ultima8::Std::string(""));

		Ultima8::Std::string s1 = " abc   ";
		Ultima8::TrimSpaces(s1);
		TS_ASSERT_EQUALS(s1, Ultima8::Std::string("abc"));

		Ultima8::Std::string s2 = "def";
		Ultima8::TrimSpaces(s2);
		TS_ASSERT_EQUALS(s2, "def");
	}

	void test_tabs_to_spaces() {
		Ultima8::Std::string s1 = "\tabc \t ";
		Ultima8::TabsToSpaces(s1, 1);
		TS_ASSERT_EQUALS(s1, " abc   ");

		Ultima8::Std::string s2 = "def";
		Ultima8::TabsToSpaces(s2, 1);
		TS_ASSERT_EQUALS(s2, "def");
	}

	void test_split_string() {
		Ultima8::Std::string s1 = "abc,def";
		Ultima8::Std::vector<Ultima8::Std::string> v1;
		Ultima8::SplitString(s1, ',', v1);

		TS_ASSERT_EQUALS(v1.size(), 2);
		TS_ASSERT_EQUALS(v1[0], "abc");
		TS_ASSERT_EQUALS(v1[1], "def");

		Ultima8::Std::string s2;
		Ultima8::Std::vector<Ultima8::Std::string> v2;
		Ultima8::SplitString(s2, ',', v1);
		TS_ASSERT_EQUALS(v1.size(), 0);

		Ultima8::Std::string s3 = " aa  bb  ";
		Ultima8::SplitString(s3, ' ', v1);

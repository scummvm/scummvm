...
#include "engines/ultima8/world/sort_item.h"
...
class U8SortItemTestSuite : public CxxTest::TestSuite {
	...
	void test_screenspace_position() {
		...
		// Normal placement
		Ultima8::Box b1(18047, 17663, 104, 128, 128, 104);
		si1.setBoxBounds(b1, 0, 0);
		TS_ASSERT(si1._sxBot == 96);
		TS_ASSERT(si1._syBot == 4358);

		// Inconsistent placement
		Ultima8::Box b2(18168, 17656, 104, 128, 128, 104);
	...
	void test_basic_y_sort() {
		Ultima8::SortItem si1;
		Ultima8::SortItem si2;

		Ultima8::Box b1(0, 32, 0, 32, 32, 8);
		Ultima8::Box b2(0, 64, 0, 32, 32, 8);
		si1.setBoxBounds(b1, 0, 0);
	...
	void test_basic_x_sort() {
		...
		Ultima8::Box b1(32, 0, 0, 32, 32, 8);
		Ultima8::Box b2(64, 0, 0, 32, 32, 8);
		si1.setBoxBounds(b1, 0, 0);
		si2.setBoxBounds(b2, 0, 0);
	...
	void test_basic_z_sort() {
		...
		Ultima8::Box b1(32, 32, 0, 32, 32, 8);
		Ultima8::Box b2(32, 32, 8, 32, 32, 8);
		si1.setBoxBounds(b1, 0, 0);
		si2.setBoxBounds(b2, 0, 0);
	...
	void test_sprite_sort() {
		...
		Ultima8::Box b1(59454, 49246, 80, 32, 160, 16);
		si1.setBoxBounds(b1, 0, 0);

		Ultima8::Box b2(59440, 49144, 63, 32, 32, 63);
		si2.setBoxBounds(b2, 0, 0);
		si2._sprite = true;
	...
	void test_inv_item_sort() {
		...
		Ultima8::Box b1(34142, 41150, 0, 256, 64, 8);
		si1.setBoxBounds(b1, 0, 0);
		si1._solid = true;
		si1._land = true;

		Ultima8::Box b2(34110, 41118, 0, 64, 64, 0);
		si2.setBoxBounds(b2, 0, 0);
		si2._invitem = true;
	...
	void test_flat_sort() {
		...
		Ultima8::Box b1(0, 0, 0, 32, 32, 0);
		Ultima8::Box b2(0, 0, 0, 32, 32, 0);
		si1.setBoxBounds(b1, 0, 0);
		si2.setBoxBounds(b2, 0, 0);
	...
	void test_non_flat_sort() {
		...
		Ultima8::Box b1(7679, 19743, 48, 128, 32, 8);
		si1.setBoxBounds(b1, 0, 0);
		si1._occl = true;
		si1._roof = true;
		si1._land = true;
		...
		Ultima8::Box b2(7642, 19776, 48, 64, 64, 40);
		si2.setBoxBounds(b2, 0, 0);
		si2._solid = true;
	...
	void test_main_actor_roof_bug() {
		...
		Ultima8::Box b1(15484, 13660, 96, 64, 64, 40);
		si1.setBoxBounds(b1, 0, 0);
		si1._solid = true;

		Ultima8::Box b2(15423, 13631, 104, 128, 32, 8);
		si2.setBoxBounds(b2, 0, 0);
		si2._occl = true;
		si2._roof = true;
		si2._land = true;
		...
		Ultima8::Box b3(15551, 13631, 104, 128, 32, 8);
		si2.setBoxBounds(b2, 0, 0);
		si2._occl = true;
		si2._roof = true;
		si2._land = true;
	...
	void test_nonflat_transparent_sort() {
		...
		Ultima8::Box b1(17407, 16127, 48, 32, 96, 40);
		si1.setBoxBounds(b1, 0, 0);
		si1._solid = true;

		Ultima8::Box b2(17407, 16191, 48, 32, 128, 40);
		si2.setBoxBounds(b2, 0, 0);
		si2._trans = true;
		si2._solid = true;
		si2._land = true;
	...
	void test_nonflat_partial_front_sort() {
		...
		Ultima8::Box b1(22591, 17599, 56, 160, 160, 8);
		si1.setBoxBounds(b1, 0, 0);
		si1._solid = true;
		si1._land = true;
		si1._fixed = true;

		Ultima8::Box b2(22719, 17695, 56, 160, 160, 8);
		si2.setBoxBounds(b2, 0, 0);
		si2._solid = true;
		si2._land = true;
		si2._fixed = true;
	...
	void test_ignore_z_non_solid_sort() {
		...
		Ultima8::Box b1(2212, 7804, 64, 192, 32, 8);
		si1.setBoxBounds(b1, 0, 0);
		si1._solid = true;
		si1._land = true;

		Ultima8::Box b2(2207, 7839, 48, 0, 96, 48);
		si2.setBoxBounds(b2, 0, 0);
		si2._trans = true;
	...
	void test_x_flat_sort() {
		...
		Ultima8::Box b1(13247, 9983, 48, 32, 128, 40);
		si1.setBoxBounds(b1, 0, 0);
		si1._solid = true;
		si1._occl = true;
		si1._land = true;
		...
		Ultima8::Box b2(13244, 9876, 48, 0, 96, 40);
		si2.setBoxBounds(b2, 0, 0);
		si2._fixed = true;
	...
	void test_x_flat_z_tolerance_sort() {
		...
		Ultima8::Box b1(17663, 19199, 96, 256, 256, 8);
		si1.setBoxBounds(b1, 0, 0);
		si1._solid = true;
		si1._occl = true;
		si1._roof = true;
		...
		Ultima8::Box b2(17410, 19110, 96, 0, 96, 40);
		si2.setBoxBounds(b2, 0, 0);
		si2._fixed = true;
	...
	void test_x_flat_vs_thin_wall_sort() {
		...
		Ultima8::Box b1(17439, 17535, 104, 32, 128, 40);
		si1.setBoxBounds(b1, 0, 0);
		si1._solid = true;
		si1._occl = true;
		si1._land = true;
		...
		Ultima8::Box b2(17410, 17502, 96, 0, 96, 40);
		si2.setBoxBounds(b2, 0, 0);
		si2._fixed = true;
	...
	void test_misplaced_flat_bug() {
		...
		Ultima8::Box b1(19199, 15871, 88, 64, 128, 16);
		si1.setBoxBounds(b1, 0, 0);
		si1._solid = true;
		si1._occl = true;
		si1._land = true;
		...
		Ultima8::Box b2(19167, 15775, 56, 0, 128, 40);
		si2.setBoxBounds(b2, 0, 0);
		si2._fixed = true;
	...
	void test_x_flat_layered_sort() {
		...
		Ultima8::Box b1(17410, 17806, 96, 0, 96, 40);
		si1.setBoxBounds(b1, 0, 0);
		si1._fixed = true;

		Ultima8::Box b2(17408, 17888, 96, 0, 96, 40);
		si2.setBoxBounds(b2, 0, 0);
		si2._fixed = true;
	...
	void test_y_flat_layered_sort() {
		...
		Ultima8::Box b1(2175, 1055, 48, 96, 0, 40);
		si1.setBoxBounds(b1, 0, 0);
		si1._fixed = true;

		Ultima8::Box b2(2111, 1055, 48, 96, 0, 40);
		si2.setBoxBounds(b2, 0, 0);
		si2._fixed = true;
	...
	void test_y_flat_edge_overlap_sort() {
		...
		Ultima8::Box b1(2239, 1055, 48, 64, 32, 40);
		si1.setBoxBounds(b1, 0, 0);
		si1._solid = true;
		si1._fixed = true;

		Ultima8::Box b2(2175, 1055, 48, 96, 0, 40);
		si2.setBoxBounds(b2, 0, 0);
		si2._fixed = true;
	...
	void test_y_flat_same_position_sort() {
		...
		Ultima8::Box b1(17599, 19455, 56, 128, 0, 40);
		si1.setBoxBounds(b1, 0, 0);
		si1._fixed = true;
		si1._shapeNum = 322;
		si1._frame = 1;

		Ultima8::Box b2(17599, 19455, 56, 128, 0, 40);
		si2.setBoxBounds(b2, 0, 0);
		si2._fixed = true;
		si2._shapeNum = 322;
		si2._frame = 3;
	...
	void test_y_flat_sort() {
		...
		Ultima8::Box b1(19007, 17439, 104, 64, 32, 40);
		si1.setBoxBounds(b1, 0, 0);
		si1._solid = true;
		si1._occl = true;
		si1._land = true;
		...
		Ultima8::Box b2(19008, 17432, 104, 96, 0, 40);
		si2.setBoxBounds(b2, 0, 0);
		si2._fixed = true;
	...
	void test_y_flat_z_tolerance_sort() {
		...
		Ultima8::Box b1(22271, 18431, 56, 128, 128, 0);
		si1.setBoxBounds(b1, 0, 0);
		si1._solid = true;
		si1._occl = true;
		si1._land = true;
		...
		Ultima8::Box b2(22367, 18399, 48, 128, 0, 40);
		si2.setBoxBounds(b2, 0, 0);
		si2._fixed = true;
	...
	void test_y_flat_exception_sort() {
		...
		Ultima8::Box b1(12255, 5503, 0, 128, 0, 40);
		si1.setBoxBounds(b1, 0, 0);
		si1._fixed = true;

		Ultima8::Box b2(12260, 5532, 8, 64, 64, 16);
		si2.setBoxBounds(b2, 0, 0);
		si2._solid = true;
		si2._land = true;
	...
	void test_y_flat_intersect_sort() {
		...
		Ultima8::Box b1(20479, 9887, 48, 64, 128, 40);
		si1.setBoxBounds(b1, 0, 0);
		si1._trans = true;
		si1._solid = true;
		si1._land = true;
		...
		Ultima8::Box b2(20543, 9855, 48, 96, 0, 16);
		si2.setBoxBounds(b2, 0, 0);
		si2._fixed = true;
	...
	void test_z_flat_vs_x_flat_sort() {
		...
		Ultima8::Box b1(17535, 18559, 144, 128, 128, 0);
		si1.setBoxBounds(b1, 0, 0);
		si1._solid = true;
		si1._occl = true;
		si1._roof = true;
		...
		Ultima8::Box b2(17440, 18448, 106, 0, 96, 40);
		si2.setBoxBounds(b2, 0, 0);
		si2._fixed = true;
	...
	void test_nonflat_z_clear_sort() {
		...
		Ultima8::Box b1(7839, 19839, 24, 64, 64, 24);
		si1.setBoxBounds(b1, 0, 0);
		si1._anim = true;
		si1._solid = true;

		Ultima8::Box b2(7774, 19876, 48, 64, 64, 40);
		si2.setBoxBounds(b2, 0, 0);
		si2._solid = true;
	...
	void test_anim_easter_egg() {
		...
		Ultima8::Box b1(20735, 1919, 0, 64, 64, 16);
		si1.setBoxBounds(b1, 0, 0);
		si1._anim = true;

		Ultima8::Box b2(20799, 1919, 0, 128, 32, 40);
		si2.setBoxBounds(b2, 0, 0);
		si2._solid = true;
		si2._occl = true;
		si2._land = true;
	...
	void test_armor_of_flames_sort() {
		...
		Ultima8::Box b1(13655, 5111, 8, 64, 64, 16);
		si1.setBoxBounds(b1, 0, 0);
		si1._solid = true;

		Ultima8::Box b2(13655, 5111, 8, 96, 96, 72);
		si2.setBoxBounds(b2, 0, 0);
		si2._anim = true;
		si2._trans = true;
	...
	void test_basic_occludes() {
		...
		Ultima8::Box b1(0, 0, 0, 128, 128, 16);
		si1.setBoxBounds(b1, 0, 0);
		...
		Ultima8::Box b2(0, 0, 0, 128, 128, 0);
		si2.setBoxBounds(b2, 0, 0);
	...
	void test_basic_overlap() {
		...
		b1 = Ultima8::Box(0, 0, 0, 128, 128, 0);
		si1.setBoxBounds(b1, 0, 0);

		b2 = Ultima8::Box(128, 0, 0, 128, 128, 0);
		si2.setBoxBounds(b2, 0, 0);
		...
		b2 = Ultima8::Box(0, 128, 0, 128, 128, 0);
		si2.setBoxBounds(b2, 0, 0);
		...
		b1 = Ultima8::Box(0, 0, 0, 128, 128, 32);
		si1.setBoxBounds(b1, 0, 0);

		b2 = Ultima8::Box(128, -128, 0, 128, 128, 32);
		si2.setBoxBounds(b2, 0, 0);
		...
		b2 = Ultima8::Box(160, -128, 0, 128, 128, 32);
		si2.setBoxBounds(b2, 0, 0);

		TS_ASSERT(!si1.overlap(si2));
		TS_ASSERT(!si2.overlap(si1));

		b2 = Ultima8::Box(-128, 160, 0, 128, 128, 32);
		si2.setBoxBounds(b2, 0, 0);

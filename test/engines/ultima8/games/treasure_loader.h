...
#include "engines/ultima8/games/treasure_loader.h"
...
class U8TreasureLoaderTestSuite : public CxxTest::TestSuite {
	...
	Ultima8::TreasureLoader loader;

	/* Parse nothing -> should return nothing */
	void test_parse_empty() {
		Ultima8::Std::vector<Ultima8::TreasureInfo> t;
	...
	void test_parse_basic() {
		...
		const Ultima8::TreasureInfo ti = t[0];

...
#include "engines/ultima8/usecode/uc_stack.h"
/**
...
class U8UCStackTestSuite : public CxxTest::TestSuite {
	...
	void test_static_stack() {
		Ultima8::UCStack stack;
		test_for_stack(stack);
	}

	void test_dynamic_stack() {
		Ultima8::DynamicUCStack stack;
		Ultima8::DynamicUCStack stack2(32);
	...
	private:
	void test_for_stack(Ultima8::BaseUCStack &s) {

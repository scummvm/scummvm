...
//
// The MSVCErrorPrinter is identical to the ErrorPrinter or the StdioPrinter,
// except it prints the line number and error/warning strings in a format
...
#else
class MSVCErrorPrinter : public StdioPrinter
#endif // _CXXTEST_HAVE_STD
{
public:
#ifdef _CXXTEST_HAVE_STD
    ...
    MSVCErrorPrinter(FILE *o = stdout)
        : StdioPrinter(o, "(", ") ", "error C2999", "warning C4999") {}
#endif // _CXXTEST_HAVE_STD
};
}

...
StaticSuiteDescription::StaticSuiteDescription(const char *argFile, unsigned argLine,
                                               ...
                                               List &argTests) : RealSuiteDescription(argFile, argLine, argSuiteName, argTests) {
...
CommonDynamicSuiteDescription::CommonDynamicSuiteDescription(const char *argFile, unsigned argLine,
                                                             ...
                                                             unsigned argCreateLine, unsigned argDestroyLine) : RealSuiteDescription(argFile, argLine, argSuiteName, argTests) {

...
protected:
	LayoutType getLayoutType() override { return kLayoutMain; }
...
protected:
	...
	LayoutType getLayoutType() override { return _type; }
...
protected:
	LayoutType getLayoutType() override { return kLayoutWidget; }

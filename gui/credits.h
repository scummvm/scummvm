...
static const char *credits[] = {
	...
	"Victor Gonzalez",
	"C0"
	"V\355ctor Gonz\341lez",
	"C2"
	"Soltys Spanish translation",
	"A0"
	"Alejandro Gomez de la Munoza",
	"C0"
	"Alejandro G\363mez de la Mu\361oza",
	"C2"
	"Soltys Spanish translation",
	"",
	"C1"
	...
	"",
	"C0"
	"Emilio de Paz Aragon from Alcachofa Soft for sharing the source code of Drascula: The Vampire Strikes Back with us and his generosity with freewaring the game.",
	"C0"
	"",
	"C0"
	...
	"",
	"C0"
	"Janusz Wisniewski and Miroslaw Liminowicz from Laboratorium Komputerowe Avalon for providing full source code for Soltys and Sfinx and letting us redistribute the games.",
	"C0"
	"",
	"C0"

...
void OptionsDialog::addMT32Controls(GuiObject *boss, const Common::String &prefix) {
	...
	// GS Extensions setting
	_enableGSCheckbox = new CheckboxWidget(boss, prefix + "mcGSCheckbox", _("Roland GS Device (enable MT-32 mappings)"), _("Check if you want to enable patch mappings and various settings to emulate an MT-32 on a Roland GS device"));

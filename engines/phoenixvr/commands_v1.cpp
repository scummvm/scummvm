...
struct MultiCD_Use_Install_Path : public Command {
	Common::String path;
...
struct MultiCD_Set_Transition_Script : public Command {
	Common::String path;
...
struct MultiCD_Set_Next_Script : public Command {
...
struct MultiCD_If_Next_Script : public Command {
	Common::String cd;
	Common::String var;
...
struct LoadSave_Enter_Script : public Command {
...
struct Play_AnimBloc_Number : public Command {
...
struct StartTimer : public Command {
	float seconds;
	bool showTimer;
...
struct PauseTimer : public Command {
...
struct KillTimer : public Command {
...
struct ChangeCurseur : public Command {
	int cursor;
...
struct GetMonde4 : public Command {
	Common::String var;
...
struct SetMonde4 : public Command {
	int value;
...
struct AddObject : public Command {
	int object;
	Common::String var;
	Common::String negativeVar;
...
struct AddCoffreObject : public Command {
	int object;
...
struct IsPresent : public Command {
	int object;
	Common::String var;
	Common::String negativeVar;
...
struct DoAction : public Command {
	int value;
	Common::String arg;
...
struct InitCoffre : public Command {
...
struct LoadCoffre : public Command {
...
struct SaveCoffre : public Command {
...
struct AfficheImage : public Command {
	Common::String image;
	int x;
	int y;
...
struct StopAffiche : public Command {
...
struct UpdateStage : public Command {
...
struct StartCible : public Command {
	Common::String name;
	int periodSeconds;
...
struct StopCible : public Command {
...
struct TestCible : public Command {
	Common::String xVar;
	Common::String yVar;
...
struct AfficheCoffre : public Command {
...
struct AfficheSelection : public Command {
...
struct AffichePorteF : public Command {
	int value;
...
struct SelectPorteF : public Command {
	int value;
	Common::String var;
...
struct SelectCoffre : public Command {
	int value;
	Common::String var;
...
struct LoadSave_Init_Slots : public Command {
	int slots;
...
struct LoadSave_Draw_Slot : public Command {
	int slot;
	int face;
	int x;
	int y;
...
struct LoadSave_Test_Slot : public Command {
	int slot;
	Common::String show;
	Common::String hide;
...
struct Set_Global_Pan : public Command {
	Common::String arg;
...
struct Set_Global_Volume : public Command {
	Common::String arg;
...
struct LoadSave : public Command {
...
struct LoadSave_Capture_Context : public Command {
...
struct LoadSave_Context_Restored : public Command {
...
struct LoadSave_Load : public Command {
	int slot;
...
struct LoadSave_Save : public Command {
	int slot;
...
struct LoadSave_Set_Context_Label : public Command {
	Common::String label;
...
struct Discocier : public Command {
	Common::String var;
...
struct MemoryRelease : public Command {
...
struct DrawTextSelection : public Command {
...
struct CarteDestination : public Command {
	Common::String varX;
	Common::String varY;
...
struct Rollover : public Command {
	int textId;
	RolloverType type;
...
struct PorteFRollover : public Command {
	int arg;
...
struct SaveVariable : public Command {
...
struct LoadVariable : public Command {
...
struct EndScript : public Command {
	EndScript() {}
	void exec(ExecutionContext &ctx) const override {
		debug("end");
		ctx.running = false;
...
struct SetCursorDefault : public Command {
	int idx;
	Common::String fname;
...
struct SetCursor : public Command {
	Common::String fname;
	Common::String wname;
	int idx;
...
struct HideCursor : public Command {
	Common::String warp;
	int idx;
...
struct ResetLockKey : public Command {
	void exec(ExecutionContext &ctx) const override {
		g_engine->resetLockKey();
	}
};

struct LockKey : public Command {
	int idx;
	Common::String warp;
...
struct AngleXMax : public Command {
	float xMax;
...
struct AngleYMax : public Command {
	float yMin, yMax;
...
struct SetAngle : public Command {
	float x, y;
...
struct InterpolAngle : public Command {
...
struct GoToWarp : public Command {
	Common::String warp;
...
struct PlaySound : public Command {
	Common::String sound;
	int volume;
	int loops;
...
struct StopSound : public Command {
	Common::String sound;
...
struct PlaySound3D : public Command {
	Common::String sound;
	int volume;
	float angle;
	int loops;
...
struct StopSound3D : public Command {
	Common::String sound;
...
struct Transfade : public Command {
	int speed;

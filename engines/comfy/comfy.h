...
#define COMFY_KEYBOARD_ON_CONTACT 7
#define COMFY_KEYBOARD_HANDSET_CONTACT 13
#define COMFY_KEYBOARD_TOGGLE_MASK ((uint32)(1 << COMFY_KEYBOARD_ON_CONTACT) | (uint32)(1 << COMFY_KEYBOARD_HANDSET_CONTACT))

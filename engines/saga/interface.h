...
public:
	...
	bool processAscii(Common::KeyboardEvent keystate);
...
private:
	...
	bool processTextInput(Common::KeyboardEvent keystate);
	void processStatusTextInput(Common::KeyboardEvent keystate);

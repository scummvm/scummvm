...
const uint32 MAX_ACCEPTED_FLASH_VERSION = 4;   // Die höchste Flash-Dateiversion, die vom Lader akzeptiert wird
...
#if DEBUG
	printf("storeBez(bez, %d, %d, %d, %d, %d)\n", lineStyle, fillStyle0, fillStyle1, *bezNodes, *bezAllocated);
#endif

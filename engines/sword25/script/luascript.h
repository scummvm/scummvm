...
public:
	...
	*/
	 ...
	 * @return              Returns true if successful, otherwise false.
	 */
	virtual bool executeFile(const Common::String &fileName) override;
	 ...
	 * @return              Returns true if successful, otherwise false.
	 */
	virtual bool executeString(const Common::String &code) override;
	 ...
	 */
	virtual void *getScriptObject() override {
		return _state;
	}
	 ...
	 */
	virtual void setCommandLine(const Common::StringArray &commandLineParameters) override;

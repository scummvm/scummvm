...
RenderedImage::RenderedImage(const Common::String &filename, bool &result) : _isTransparent(true) {
	result = false;
...
RenderedImage::RenderedImage(uint width, uint height, bool &result) : _isTransparent(true) {

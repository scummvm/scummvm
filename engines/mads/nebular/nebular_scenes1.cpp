...
namespace Nebular {
	...
	Scene101::Scene101(MADSEngine *vm)
	  : Scene1xx(vm) {
		_sittingFl = false;
		_panelOpened = false;
		_messageNum = 0;
	...
	Scene102::Scene102(MADSEngine *vm)
	  : Scene1xx(vm) {
	...
	Scene103::Scene103(MADSEngine *vm)
	  : Scene1xx(vm) {
		_updateClock = 0;
	}
	...
	Scene104::Scene104(MADSEngine *vm)
	  : Scene1xx(vm) {
	...
	Scene105::Scene105(MADSEngine *vm)
	  : Scene1xx(vm) {
		_explosionFl = false;
	}
	...
	Scene106::Scene106(MADSEngine *vm)
	  : Scene1xx(vm) {
		_backToShipFl = false;
		_shadowFl = false;
	...
	Scene107::Scene107(MADSEngine *vm)
	  : Scene1xx(vm) {
		_shootingFl = false;
	}
	...
	Scene109::Scene109(MADSEngine *vm)
	  : Scene1xx(vm) {
	...
	Scene110::Scene110(MADSEngine *vm)
	  : Scene1xx(vm) {
		_crabsFl = false;
	}
	...
	Scene111::Scene111(MADSEngine *vm)
	  : Scene1xx(vm) {
		_stampedFl = false;
		_launch1Fl = false;
		_launched2Fl = false;

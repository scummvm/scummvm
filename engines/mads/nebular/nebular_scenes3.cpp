...
namespace Nebular {
	...
	Scene311::Scene311(MADSEngine *vm)
	  : Scene3xx(vm) {
		_checkGuardFl = false;
	}
	...
	Scene318::Scene318(MADSEngine *vm)
	  : Scene3xx(vm) {
		_dropTimer = 0;
	...
	void Scene318::enter() {
		...
		if ((_scene->_priorSceneId == RETURNING_FROM_DIALOG) || (((_scene->_priorSceneId == 318) || (_scene->_priorSceneId == RETURNING_FROM_LOADING)) && (!_globals[kAfterHavoc]))) {
			if (!_globals[kAfterHavoc]) {
				_game._player._visible = false;
	...
	Scene319::Scene319(MADSEngine *vm)
	  : Scene3xx(vm) {
		_animMode = -1;
		_animFrame = -1;
		_nextAction1 = -1;
	...
	void Scene319::actions() {
		if (_game._trigger == 0) {
			...
			if ((_action._activeAction._verbId == 0x168) || (_action._activeAction._verbId == 0x174) || (_action._activeAction._verbId == 0x180) || (_action._activeAction._verbId == 0x169) || (_action._activeAction._verbId == 0x175) || (_action._activeAction._verbId == 0x181) || (_action._activeAction._verbId == 0x16A) || (_action._activeAction._verbId == 0x176) || (_action._activeAction._verbId == 0x182) || (_action._activeAction._verbId == 0x183) || (_action._activeAction._verbId == 0x167) || (_action._activeAction._verbId == 0x173) || (_action._activeAction._verbId == 0x17F)) {

				bool addDialogLine = !((_action._activeAction._verbId == 0x167) || (_action._activeAction._verbId == 0x173) || (_action._activeAction._verbId == 0x17F) || (_action._activeAction._verbId == 0x16A) || (_action._activeAction._verbId == 0x176) || (_action._activeAction._verbId == 0x182) || (_action._activeAction._verbId == 0x183));
	...
	Scene320::Scene320(MADSEngine *vm)
	  : Scene300s(vm) {
		_blinkFl = false;
		_flippedFl = false;
	...
	Scene352::Scene352(MADSEngine *vm)
	  : Scene3xx(vm) {
		_vaultOpenFl = false;
	...
	Scene359::Scene359(MADSEngine *vm)
	  : Scene3xx(vm) {
		_cardHotspotId = -1;
	}
	...
	Scene389::Scene389(MADSEngine *vm)
	  : Scene300s(vm) {
		_monsterTime = 0;
		_circularQuoteId = -1;
	}

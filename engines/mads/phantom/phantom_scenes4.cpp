...
namespace Phantom {
	...
	Scene403::Scene403(MADSEngine *vm)
	  : Scene4xx(vm) {
		_frameInRoomFl = false;
		_takingFrameInRoomFl = false;
	...
	Scene404::Scene404(MADSEngine *vm)
	  : Scene4xx(vm) {
		_frameInRoomFl = false;
		_takingFrameInRoomFl = false;
		_anim0ActvFl = false;
	...
	Scene408::Scene408(MADSEngine *vm)
	  : Scene4xx(vm) {
		_frameInRoomFl = false;
		_takingFrameInRoomFl = false;
	...
	Scene409::Scene409(MADSEngine *vm)
	  : Scene4xx(vm) {
		_frameInRoomFl = false;
		_takingFrameInRoomFl = false;
	...
	Scene410::Scene410(MADSEngine *vm)
	  : Scene4xx(vm) {
		for (int i = 0; i < 26; i++)
			_skullSequence[i] = 0;
	}
	...
	Scene453::Scene453(MADSEngine *vm)
	  : Scene4xx(vm) {
		_frameInRoomFl = false;
		_takingFrameInRoomFl = false;
	...
	Scene456::Scene456(MADSEngine *vm)
	  : Scene4xx(vm) {
		_frameInRoomFl = false;
		_takingFrameInRoomFl = false;

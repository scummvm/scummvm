...
namespace Phantom {
	...
	void Scene102::actions() {
		...
		} else if (_action.isAction(VERB_WALK_THROUGH, NOUN_ORCHESTRA_DOOR) || _action.isAction(VERB_PUSH, NOUN_ORCHESTRA_DOOR) || _action.isAction(VERB_OPEN, NOUN_ORCHESTRA_DOOR)) {
			if (_anim0Running) {
	...
	void Scene103::preActions() {
		...
		if ((_standPosition != 0) && !_action.isAction(VERB_CLIMB_THROUGH, NOUN_TRAP_DOOR) && !_action.isAction(VERB_OPEN, NOUN_TRAP_DOOR) && !_action.isAction(VERB_CLIMB, NOUN_PROMPTERS_STAND) && !_action.isAction(VERB_PUSH, NOUN_TRAP_DOOR) && !_action.isAction(VERB_LOOK_THROUGH, NOUN_PROMPTERS_BOX) && !_action.isAction(VERB_PULL, NOUN_TRAP_DOOR)) {
	...
	void Scene103::actions() {
		...
		if ((_action.isAction(VERB_CLIMB, NOUN_PROMPTERS_STAND) && _standPosition == 0) || (_action.isAction(VERB_LOOK_THROUGH, NOUN_PROMPTERS_BOX) && (_standPosition == 0)) || (_action.isAction(VERB_CLIMB_THROUGH, NOUN_TRAP_DOOR) && (_standPosition == 0))) {
			if (_globals[kPrompterStandStatus] == 0) {
				if (_game._trigger == 0) {
	...
	void Scene105::actions() {
		...
		if (_action.isAction(VERB_WALK_THROUGH, NOUN_DOOR) || _action.isAction(VERB_OPEN, NOUN_DOOR) || (_game._trigger) || _action.isAction(VERB_UNLOCK, NOUN_DOOR) || _action.isAction(VERB_LOCK, NOUN_DOOR)) {
	...
	Scene108::Scene108(MADSEngine *vm)
	  : Scene1xx(vm) {
		_anim0ActvFl = false;
		_handRaisedFl = false;
		_shutUpCount = -1;
	...
	void Scene108::handleCharlesConversation() {
		...
		if ((_action._activeAction._verbId != 1) && (_action._activeAction._verbId != 5) && (_action._activeAction._verbId != 16) && (_action._activeAction._verbId != 19) && (_action._activeAction._verbId != 22) && (_action._activeAction._verbId != 25) && (_action._activeAction._verbId != 26) && (_charAction != 2)) {
			_vm->_gameConv->setInterlocutorTrigger(60);
	...
	Scene112::Scene112(MADSEngine *vm)
	  : Scene1xx(vm) {
		_anim0ActvFl = false;
		_anim1ActvFl = false;
		_raoulAction = -1;
	...
	void Scene112::handleConversation() {
		...
		if ((_action._activeAction._verbId != 0) && (_action._activeAction._verbId != 1) && (_action._activeAction._verbId != 2) && (_action._activeAction._verbId != 5) && (_action._activeAction._verbId != 6) && (_action._activeAction._verbId != 7) && (_action._activeAction._verbId != 10) && (_action._activeAction._verbId != 23) && (_action._activeAction._verbId != 27)) {
			_vm->_gameConv->setInterlocutorTrigger(60);
			_vm->_gameConv->setHeroTrigger(62);
		}
	...
	Scene113::Scene113(MADSEngine *vm)
	  : Scene1xx(vm) {
	...
	void Scene113::handleFlorentAnimation() {
		...
		case 33:
			...
			if ((_florentStatus == 2) || (_florentStatus == 3)) {
				random = 5;
			}
	...
	void Scene113::handleFlorentConversation() {
		...
		switch (_game._trigger) {
		case 62:
			if ((_action._activeAction._verbId != 3) && (_action._activeAction._verbId != 4) && (_action._activeAction._verbId != 19) && (_action._activeAction._verbId != 27) && (_action._activeAction._verbId != 28) && (_action._activeAction._verbId != 29)) {
		...
		if ((_action._activeAction._verbId != 3) && (_action._activeAction._verbId != 4) && (_action._activeAction._verbId != 19) && (_action._activeAction._verbId != 28) && (_action._activeAction._verbId != 29) && (_action._activeAction._verbId != 27) && (_action._activeAction._verbId != 30) && (_action._activeAction._verbId != 26))
			_vm->_gameConv->setInterlocutorTrigger(66);
	...
	Scene114::Scene114(MADSEngine *vm)
	  : Scene1xx(vm) {
	}
	...
	Scene150::Scene150(MADSEngine *vm)
	  : Scene1xx(vm) {
	}

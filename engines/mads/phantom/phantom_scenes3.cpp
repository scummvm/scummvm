...
namespace Phantom {
	...
	Scene301::Scene301(MADSEngine *vm)
	  : Scene3xx(vm) {
		_anim0ActvFl = false;
		_skip1Fl = false;
		_skip2Fl = false;
	...
	Scene302::Scene302(MADSEngine *vm)
	  : Scene3xx(vm) {
	}
	...
	Scene303::Scene303(MADSEngine *vm)
	  : Scene3xx(vm) {
		_anim0ActvFl = false;
		_hempHotspotId = -1;
		_skipFrameCheckFl = -1;
	...
	Scene304::Scene304(MADSEngine *vm)
	  : Scene3xx(vm) {
		_anim0ActvFl = false;
		_anim1ActvFl = false;
		_anim2ActvFl = false;
	...
	Scene305::Scene305(MADSEngine *vm)
	  : Scene3xx(vm) {
		_anim0ActvFl = false;
		_anim1ActvFl = false;
		_skipFl = false;
	...
	Scene306::Scene306(MADSEngine *vm)
	  : Scene3xx(vm) {
		_speechDoneFl = false;
	}
	...
	Scene307::Scene307(MADSEngine *vm)
	  : Scene3xx(vm) {
	}
	...
	Scene308::Scene308(MADSEngine *vm)
	  : Scene3xx(vm) {
		_anim0ActvFl = false;
		_anim1ActvFl = false;
		_anim2ActvFl = false;
	...
	Scene309::Scene309(MADSEngine *vm)
	  : Scene3xx(vm) {
		_anim0ActvFl = false;
	...
	Scene310::Scene310(MADSEngine *vm)
	  : Scene3xx(vm) {

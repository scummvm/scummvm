...
void Scene104::step() {
	...
	if ((_globals[kTapestryStatus] == 1 || _globals[kTapestryStatus] == 3) && (_globals[kBooksStatus] == 2 || _globals[kBooksStatus] == 4))

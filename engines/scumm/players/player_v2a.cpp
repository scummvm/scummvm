...
public:
	V2A_Sound_Music(uint16 instoff, uint16 voloff, uint16 chan1off, uint16 chan2off, uint16 chan3off, uint16 chan4off, uint16 sampoff, bool looped) : _instoff(instoff), _voloff(voloff), _chan1off(chan1off), _chan2off(chan2off), _chan3off(chan3off), _chan4off(chan4off), _sampoff(sampoff), _looped(looped) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
...
public:
	V2A_Sound_Single(uint16 offset, uint16 size, uint16 freq, uint8 vol) : V2A_Sound_Base<1>(offset, size), _freq(freq), _vol(vol) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
...
public:
	V2A_Sound_SingleLooped(uint16 offset, uint16 size, uint16 freq, uint8 vol, uint16 loopoffset, uint16 loopsize) : V2A_Sound_Base<1>(offset, size), _loopoffset(loopoffset), _loopsize(loopsize), _freq(freq), _vol(vol) {}
	V2A_Sound_SingleLooped(uint16 offset, uint16 size, uint16 freq, uint8 vol) : V2A_Sound_Base<1>(offset, size), _loopoffset(0), _loopsize(size), _freq(freq), _vol(vol) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
		char *tmp_data = (char *)malloc(_size);
...
public:
	V2A_Sound_MultiLooped(uint16 offset, uint16 size, uint16 freq1, uint8 vol1, uint16 freq2, uint8 vol2) : V2A_Sound_Base<2>(offset, size), _freq1(freq1), _vol1(vol1), _freq2(freq2), _vol2(vol2) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
...
public:
	V2A_Sound_MultiLoopedDuration(uint16 offset, uint16 size, uint16 freq1, uint8 vol1, uint16 freq2, uint8 vol2, uint16 numframes) : V2A_Sound_MultiLooped(offset, size, freq1, vol1, freq2, vol2), _duration(numframes) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
...
public:
	V2A_Sound_SingleLoopedPitchbend(uint16 offset, uint16 size, uint16 freq1, uint16 freq2, uint8 vol, uint8 step) : V2A_Sound_Base<1>(offset, size), _freq1(freq1), _freq2(freq2), _vol(vol), _step(step) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
		char *tmp_data = (char *)malloc(_size);
...
public:
	V2A_Sound_Special_Maniac69(uint16 offset, uint16 size, uint16 freq, uint8 vol) : V2A_Sound_Base<1>(offset, size), _freq(freq), _vol(vol) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
		char *tmp_data = (char *)malloc(_size);
...
public:
	V2A_Sound_Special_ManiacDing(uint16 offset, uint16 size, uint16 freq, uint8 fadeinrate, uint8 fadeoutrate) : V2A_Sound_Base<1>(offset, size), _freq(freq), _fade1(fadeinrate), _fade2(fadeoutrate) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
		char *tmp_data = (char *)malloc(_size);
...
public:
	V2A_Sound_Special_ZakStereoDing(uint16 offset, uint16 size, uint16 freq1, uint16 freq2, uint8 fadeinrate, uint8 fadeoutrate) : V2A_Sound_Base<2>(offset, size), _freq1(freq1), _freq2(freq2), _fade1(fadeinrate), _fade2(fadeoutrate) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
		char *tmp_data1 = (char *)malloc(_size);
...
public:
	V2A_Sound_Special_ManiacTentacle(uint16 offset, uint16 size, uint16 freq1, uint16 freq2, uint16 step) : V2A_Sound_Base<1>(offset, size), _freq1(freq1), _freq2(freq2), _step(step) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
		char *tmp_data = (char *)malloc(_size);
...
public:
	V2A_Sound_Special_Maniac59(uint16 offset, uint16 size, uint16 freq1, uint16 freq2, uint16 step, uint8 vol) : V2A_Sound_Base<1>(offset, size), _freq1(freq1), _freq2(freq2), _step(step), _vol(vol) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
		char *tmp_data = (char *)malloc(_size);
...
public:
	V2A_Sound_Special_Maniac61(uint16 offset, uint16 size, uint16 freq1, uint16 freq2) : V2A_Sound_Base<1>(offset, size), _freq1(freq1), _freq2(freq2) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
		char *tmp_data = (char *)malloc(_size);
...
public:
	V2A_Sound_Special_ManiacPhone(uint16 offset, uint16 size, uint16 freq1, uint8 vol1, uint16 freq2, uint8 vol2, uint16 numframes, uint8 playwidth, uint8 loopwidth) : V2A_Sound_Base<2>(offset, size), _freq1(freq1), _vol1(vol1), _freq2(freq2), _vol2(vol2), _duration(numframes), _playwidth(playwidth), _loopwidth(loopwidth) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
		_data = (char *)malloc(READ_LE_UINT16(data));
...
public:
	V2A_Sound_Special_Maniac46(uint16 offset, uint16 size, uint16 freq, uint8 vol, uint8 loopwidth, uint8 numloops) : V2A_Sound_Base<1>(offset, size), _freq(freq), _vol(vol), _loopwidth(loopwidth), _numloops(numloops) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
		_data = (char *)malloc(READ_LE_UINT16(data));
...
public:
	V2A_Sound_Special_ManiacTypewriter(uint16 offset, uint16 size, uint16 freq, uint8 vol, uint8 numdurs, const uint8 *durations, bool looped) : V2A_Sound_Base<1>(offset, size), _freq(freq), _vol(vol), _numdurs(numdurs), _durations(durations), _looped(looped) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
		_data = (char *)malloc(READ_LE_UINT16(data));
...
public:
	V2A_Sound_Special_Maniac44(uint16 offset1, uint16 size1, uint16 offset2, uint16 size2, uint16 freq1, uint16 freq2, uint8 vol) : _offset1(offset1), _size1(size1), _offset2(offset2), _size2(size2), _freq1(freq1), _freq2(freq2), _vol(vol) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
		_data = (char *)malloc(READ_LE_UINT16(data));
...
public:
	V2A_Sound_Special_Maniac32(uint16 offset1, uint16 size1, uint16 offset2, uint16 size2, uint8 vol) : _offset1(offset1), _size1(size1), _offset2(offset2), _size2(size2), _vol(vol) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
...
public:
	V2A_Sound_Special_Zak70(uint16 offset, uint16 size, uint16 freq1, uint16 freq2, uint16 freq3, uint16 freq4, uint8 vol) : V2A_Sound_Base<4>(offset, size), _freq1(freq1), _freq2(freq2), _freq3(freq3), _freq4(freq4), _vol(vol) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
...
public:
	V2A_Sound_Special_Zak101(uint16 offset, uint16 size, uint16 freq1, uint16 freq2, uint16 freq3, uint16 freq4, uint8 vol, uint16 dur) : V2A_Sound_Special_Zak70(offset, size, freq1, freq2, freq3, freq4, vol), _dur(dur) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
...
public:
	V2A_Sound_Special_Zak37(uint16 offset, uint16 size, uint16 freq, uint8 vol) : V2A_Sound_Base<1>(offset, size), _freq(freq), _vol(vol) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
		char *tmp_data = (char *)malloc(_size);
...
public:
	V2A_Sound_Special_ZakAirplane(uint16 offset, uint16 size, uint16 freq1, uint16 freq2) : V2A_Sound_Base<1>(offset, size), _freq1(freq1), _freq2(freq2) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
		char *tmp_data = (char *)malloc(_size);
...
public:
	V2A_Sound_Special_Zak71(uint16 offset, uint16 size) : _offset(offset), _size(size) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
...
public:
	V2A_Sound_Special_Zak99(uint16 offset, uint16 size, uint16 freq1, uint16 freq2, uint8 vol) : V2A_Sound_Base<1>(offset, size), _freq1(freq1), _freq2(freq2), _vol(vol) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
		char *tmp_data = (char *)malloc(_size);
...
public:
	V2A_Sound_Special_Zak54(uint16 offset1, uint16 size1, uint16 offset2, uint16 size2, uint16 freq) : _offset1(offset1), _size1(size1), _offset2(offset2), _size2(size2), _freq(freq) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
		_data = (char *)malloc(READ_LE_UINT16(data));
...
public:
	V2A_Sound_Special_Zak110(uint16 offset1, uint16 size1, uint16 offset2, uint16 size2, uint16 freq1, uint16 freq2) : _offset1(offset1), _size1(size1), _offset2(offset2), _size2(size2), _freq1(freq1), _freq2(freq2) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
		_data = (char *)malloc(READ_LE_UINT16(data));
...
public:
	V2A_Sound_Special_Zak32(uint16 offset1, uint16 offset2, uint16 size1, uint16 size2) : _offset1(offset1), _offset2(offset2), _size1(size1), _size2(size2) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
		_data = (char *)malloc(READ_LE_UINT16(data));
...
public:
	V2A_Sound_Special_Zak52(uint16 offset, uint16 size) : _offset(offset), _size(size) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
		_data = (char *)malloc(READ_LE_UINT16(data));
...
public:
	V2A_Sound_Special_Zak61(uint16 offset, uint16 size) : _offset(offset), _size(size) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
		_data = (char *)malloc(READ_LE_UINT16(data));
...
public:
	V2A_Sound_Special_Zak62(uint16 offset, uint16 size) : _offset(offset), _size(size) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
		_data = (char *)malloc(READ_LE_UINT16(data));
...
public:
	V2A_Sound_Special_Zak82(uint16 offset, uint16 size) : _offset(offset), _size(size) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
		_data = (char *)malloc(READ_LE_UINT16(data));
...
public:
	V2A_Sound_Special_Zak86(uint16 offset, uint16 size) : _offset(offset), _size(size) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
		_data = (char *)malloc(READ_LE_UINT16(data));
...
public:
	V2A_Sound_Special_Zak98(uint16 offset, uint16 size) : _offset(offset), _size(size) {}
	void start(Player_MOD *mod, int id, const byte *data) override {
		_mod = mod;
		_id = id;
		_data = (char *)malloc(READ_LE_UINT16(data));

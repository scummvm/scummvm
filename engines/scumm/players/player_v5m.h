...
public:
	...
	virtual bool checkMusicAvailable() override;
	virtual bool loadMusic(const byte *ptr) override;
	virtual bool getNextNote(int ch, uint32 &samples, int &pitchModifier, byte &velocity) override;

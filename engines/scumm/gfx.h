...
public:
	...
	virtual void roomChanged(byte *roomptr) override;
};
...
public:
	...
	virtual void loadTiles(byte *roomptr) override;
	virtual void roomChanged(byte *roomptr) override;
};
#endif
...
protected:
	virtual void writeRoomColor(byte *dst, byte color) const override;
public:

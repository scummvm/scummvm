...
Common::KeymapArray PetkaMetaEngine::initKeymaps(const char *target) const {
	...
	act = new Action("WALK", _("Switch cursor to 'walk'"));
	...
	act = new Action("TAKE", _("Switch cursor to 'take'"));
	...
	act = new Action("USE", _("Switch cursor to 'use'"));
	...
	act = new Action("TALK", _("Switch cursor to 'talk'"));
	...
	act = new Action("CHAPAYEV", _("Switch cursor to 'Chapayev use object'"));
	...
	act = new Action("MAP", _("Toggle map"));
	...
	act->setCustomEngineActionEvent(kActionFixCursor);
	act->addDefaultInputMapping("A+r");
	engineKeymap->addAction(act);

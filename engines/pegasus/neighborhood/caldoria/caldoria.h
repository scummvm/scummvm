...
public:
	...
	virtual Common::String getBriefingMovie() override;
	virtual Common::String getEnvScanMovie() override;
	virtual uint getNumHints() override;
	virtual Common::String getHintMovie(uint) override;

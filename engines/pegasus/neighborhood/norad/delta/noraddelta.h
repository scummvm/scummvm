...
public:
	...
	virtual GameInteraction *makeInteraction(const InteractionID) override;
...
protected:
	...
	virtual void arriveAt(const RoomID, const DirectionConstant) override;
	...
	virtual bool playingAgainstRobot() override;

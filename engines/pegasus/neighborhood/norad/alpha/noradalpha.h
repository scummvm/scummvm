...
public:
	...
	virtual bool okayToJump() override;
	...
	virtual void takeItemFromRoom(Item *) override;
	virtual void dropItemIntoRoom(Item *, Hotspot *) override;
...
protected:
	...
	virtual void getZoomEntry(const HotSpotID, ZoomTable::Entry &) override;
	virtual TimeValue getViewTime(const RoomID, const DirectionConstant) override;

...
namespace WorldOfXeen {
	...
	CloudsMainMenuContainer::CloudsMainMenuContainer()
	  : MainMenuContainer("intro.vga") {
	}
	...
	DarkSideMainMenuContainer::DarkSideMainMenuContainer()
	  : MainMenuContainer("title2a.int") {
		Screen &screen = *g_vm->_screen;
		Sound &sound = *g_vm->_sound;
	...
	WorldOfXeenMainMenuContainer::WorldOfXeenMainMenuContainer()
	  : MainMenuContainer("world.int") {
	}
	...
	WorldOfXeenCDMainMenuContainer::WorldOfXeenCDMainMenuContainer()
	  : MainMenuContainer("world0.int", "world1.int", "world2.int") {
	}
	...
	CloudsMenuDialog::CloudsMenuDialog(MainMenuContainer *owner)
	  : MainMenuDialog(owner) {
	...
	DarkSideMenuDialog::DarkSideMenuDialog(MainMenuContainer *owner)
	  : MainMenuDialog(owner)
	  , _firstDraw(true) {
		Windows &windows = *g_vm->_windows;
		Window &w = windows[GAME_WINDOW];
	...
	WorldMenuDialog::WorldMenuDialog(MainMenuContainer *owner)
	  : MainMenuDialog(owner) {
		Windows &windows = *g_vm->_windows;
		Window &w = windows[GAME_WINDOW];
	...
	OtherOptionsDialog::OtherOptionsDialog(MainMenuContainer *owner)

...
public:
	 ...
	 * Constructor
	 */
	UIButton(const Common::Rect &bounds, int value, uint frameNum, SpriteResource *sprites, bool draw) : _bounds(bounds), _value(value), _frameNum(frameNum), _selectedFrame(frameNum | 1),

...
//	cTable[''] = 88; // AE
	...
	// old chars overrides
	cTable[(byte)'ƒ'] = cTable[(byte)'‰'] = 55;
	cTable[(byte)'÷'] = cTable[(byte)'ˆ'] = 67;
...
void RMFontObj::Init(void) {
	...
	cTable[(byte)'¯'] = 62;
	cTable[(byte)'Á'] = 63;
	//cTable[(byte)'É'] = 64;   integrale
	cTable[(byte)'—'] = 65;
	cTable[(byte)'Æ'] = 66;
	cTable[(byte)'©'] = 67;
	cTable[(byte)'∆'] = 68;
	cTable[(byte)'¡'] = 69;
	cTable[(byte)'ƒ'] = cTable[(byte)'‰'] = 70;
	cTable[(byte)'≈'] = 71;
	cTable[(byte)'»'] = 72;
	cTable[(byte)'À'] = 73;
	...
	lTable['o'] = lTable['O'] = lTable['ˆ'] = lTable['÷'] = 19;
	...
	cTable[(byte)'—'] = cTable[(byte)'Ò'] = 89;
	lTable[(byte)'—'] = lTable[(byte)'Ò'] = 17;

	cTable[(byte)'”'] = cTable[(byte)'Û'] = 90;
	lTable[(byte)'”'] = lTable[(byte)'Û'] = 22;

	cTable[(byte)'å'] = cTable[(byte)'ú'] = 91;
	lTable[(byte)'å'] = lTable[(byte)'ú'] = 15;

	cTable[(byte)'Ø'] = cTable[(byte)'ø'] = 92;
	lTable[(byte)'Ø'] = lTable[(byte)'ø'] = 21;

	cTable[(byte)'è'] = cTable[(byte)'ü'] = 93;
	lTable[(byte)'è'] = lTable[(byte)'ü'] = 21;
	...
	lTable[(byte)'ƒ'] = lTable[(byte)'‰'] = 16;
	lTable[(byte)'≈'] = lTable[(byte)'Â'] = 18;
	lTable[(byte)'®'] = lTable[(byte)'∏'] = 18;
	lTable[(byte)'∆'] = lTable[(byte)'Ê'] = 20;
	lTable[(byte)'«'] = lTable[(byte)'Á'] = 18;
	lTable[(byte)'»'] = lTable[(byte)'Ë'] = 18;
	lTable[(byte)'…'] = lTable[(byte)'È'] = 18;
	lTable[(byte)' '] = lTable[(byte)'Í'] = 18;
	lTable[(byte)'À'] = lTable[(byte)'Î'] = 16;
	lTable[(byte)'Ã'] = lTable[(byte)'Ï'] = 18;
	lTable[(byte)'Õ'] = lTable[(byte)'Ì'] = 15;
	lTable[(byte)'Œ'] = lTable[(byte)'Ó'] = 22;
	lTable[(byte)'œ'] = lTable[(byte)'Ô'] = 15;
	lTable[(byte)'–'] = lTable[(byte)''] = 18;
	lTable[(byte)'—'] = lTable[(byte)'Ò'] = 22;
	lTable[(byte)'“'] = lTable[(byte)'Ú'] = 19;
	lTable[(byte)'”'] = lTable[(byte)'Û'] = 16;
	lTable[(byte)'‘'] = lTable[(byte)'Ù'] = 21;
	lTable[(byte)'’'] = lTable[(byte)'ı'] = 20;
	lTable[(byte)'÷'] = lTable[(byte)'ˆ'] = 16;
	...
	lTable[(byte)'ﬂ'] = lTable[(byte)'ˇ'] = 18;
	...
	cTable[(byte)'»'] = cTable[(byte)'Ë'] = 129;
	cTable[(byte)'ÿ'] = cTable[(byte)'¯'] = 130;
	cTable[(byte)'é'] = cTable[(byte)'û'] = 131;
	cTable[(byte)'›'] = cTable[(byte)'˝'] = 132;
	cTable[(byte)'¡'] = cTable[(byte)'·'] = 133;
	cTable[(byte)'Õ'] = cTable[(byte)'Ì'] = 134;
	cTable[(byte)'…'] = cTable[(byte)'È'] = 135;
	cTable[(byte)'œ'] = cTable[(byte)'Ô'] = 136;
	cTable[(byte)'ç'] = cTable[(byte)'ù'] = 137;
	cTable[(byte)'“'] = cTable[(byte)'Ú'] = 138;
	cTable[(byte)'”'] = cTable[(byte)'Û'] = 139;
	...
	cTable[(byte)'È'] = cTable[(byte)'Ë'] = 4; // e
	lTable[(byte)'È'] = lTable[(byte)'Ë'] = 15;

	cTable[(byte)'Ï'] = cTable[(byte)'Ì'] = cTable[(byte)'Ó'] = 8; // i
	lTable[(byte)'Ï'] = lTable[(byte)'Ì'] = lTable[(byte)'Ó'] = 16;

	cTable[(byte)'Ú'] = cTable[(byte)'Û'] = cTable[(byte)'Ù'] = cTable[(byte)'ˆ'] = 14; // o
	lTable[(byte)'Ú'] = lTable[(byte)'Û'] = lTable[(byte)'Ù'] = lTable[(byte)'ˆ'] = 19;

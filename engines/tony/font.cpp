 ...
 *        u-        z$$$c        '.    ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ *
 *      .d"        d$$$$$b        "b.                                     *
 *   .z$*         d$$$$$$$L        ^*$c.                                  *
...
void RMFontObj::Init(void) {
	...
	cTable['å'] = cTable['ú'] = 91;
	lTable['å'] = lTable['ú'] = 15;

	cTable['Ø'] = cTable['ø'] = 92;
	lTable['Ø'] = lTable['ø'] = 21;

	cTable['è'] = cTable['ü'] = 93;
	lTable['è'] = lTable['ü'] = 21;
	...
	cTable['…'] = cTable['È'] =104;
	cTable[' '] = cTable['Í'] =105;
	cTable['À'] = cTable['Î'] =106;
	cTable['Ã'] = cTable['Ï'] =107;
	cTable['Õ'] = cTable['Ì'] =108;
	cTable['Œ'] = cTable['Ó'] =109;
	cTable['œ'] = cTable['Ô'] =110;
	cTable['–'] = cTable[''] =111;
	cTable['—'] = cTable['Ò'] =112;
	cTable['“'] = cTable['Ú'] =113;
	cTable['”'] = cTable['Û'] =114;
	...
	lTable['…'] = lTable['È'] = 18;
	lTable[' '] = lTable['Í'] = 18;
	lTable['À'] = lTable['Î'] = 16;
	lTable['Ã'] = lTable['Ï'] = 18;
	lTable['Õ'] = lTable['Ì'] = 15;
	lTable['Œ'] = lTable['Ó'] = 22;
	lTable['œ'] = lTable['Ô'] = 15;
	lTable['–'] = lTable[''] = 18;
	lTable['—'] = lTable['Ò'] = 22;
	lTable['“'] = lTable['Ú'] = 19;
	lTable['”'] = lTable['Û'] = 16;
	...
	cTable['Ã'] = cTable['Ï'] = 127;
	cTable['ä'] = cTable['ö'] = 128;
	cTable['»'] = cTable['Ë'] = 129;
	cTable['ÿ'] = cTable['¯'] = 130;
	cTable['é'] = cTable['û'] = 131;
	cTable['›'] = cTable['˝'] = 132;
	cTable['¡'] = cTable['·'] = 133;
	cTable['Õ'] = cTable['Ì'] = 134;
	cTable['…'] = cTable['È'] = 135;
	cTable['œ'] = cTable['Ô'] = 136;
	cTable['ç'] = cTable['ù'] = 137;
	cTable['“'] = cTable['Ú'] = 138;
	cTable['”'] = cTable['Û'] = 139;
	cTable['Ÿ'] = cTable['˘'] = 140;
	cTable['⁄'] = cTable['˙'] = 141;

	lTable['Ã'] = lTable['Ï'] =17;
	lTable['ä'] = lTable['ö'] =15;
	lTable['»'] = lTable['Ë'] =22;
	lTable['ÿ'] = lTable['¯'] =18;
	lTable['é'] = lTable['û'] =21;
	lTable['›'] = lTable['˝'] =16;
	lTable['¡'] = lTable['·'] =18;
	lTable['Õ'] = lTable['Ì'] =19;
	lTable['…'] = lTable['È'] =17;
	lTable['œ'] = lTable['Ô'] =23;
	lTable['ç'] = lTable['ù'] =24;
	lTable['“'] = lTable['Ú'] =17;
	lTable['”'] = lTable['Û'] =22;
	lTable['Ÿ'] = lTable['˘'] =16;
	lTable['⁄'] = lTable['˙'] =16;
	...
	cTable['È'] = cTable['Ë'] = 4; // e
	lTable['È'] = lTable['Ë'] = 15;

	cTable['Ï'] = cTable['Ì'] = cTable['Ó'] = 8; // i
	lTable['Ï'] = lTable['Ì'] = lTable['Ó'] = 16;

	cTable['Ú'] = cTable['Û'] = cTable['Ù'] = cTable['ˆ'] = 14; // o
	lTable['Ú'] = lTable['Û'] = lTable['Ù'] = lTable['ˆ'] = 19;

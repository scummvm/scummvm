...
static const PlainGameDescriptor directorGames[] = {
	...
	{ "skeeto1",			"Skipper & Skeeto: Tales from Paradise Park" }, //Firstest release (in 1996) was only in Danish; German version from 1999 was first to have native 32-bit executable

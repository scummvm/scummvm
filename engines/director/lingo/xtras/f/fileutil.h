...
#ifndef DIRECTOR_LINGO_XTRAS_F_FILEUTIL_H
#define DIRECTOR_LINGO_XTRAS_F_FILEUTIL_H

namespace Director {

class FileUtilXtraObject : public Object<FileUtilXtraObject> {
public:
	FileUtilXtraObject(ObjectType objType);

	bool hasProp(const Common::String &propName) override;
	Datum getProp(const Common::String &propName) override;
};

namespace FileUtilXtra {

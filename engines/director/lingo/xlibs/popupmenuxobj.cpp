 ...
 * --=METHODS=--
 * XSI
 * mNew, menuList, menuID --Creates a new instance of the XObject.
 ...
 * mDispose --Disposes of the XObject instance.
 * mName --Returns the name of the XObject.
 * ------------------------------------------------
 * ------------------------------------------------
 ...
 * mGetMenuID --Returns the assigned Menu ID number.
 * ------------------------------------------------
 * ------------------------------------------------
 * IIII
 * mPopNum, Left, Top, itemNum --Returns selected item's number.
 * SIII
 * mPopText, Left, Top, itemNum --Returns selected item's text.
 * ------------------------------------------------
 * ------------------------------------------------
 * mSetItem, itemNum, newItemText --Sets changes to an item in pop up menu
 * mSetItemMark, markNum --Sets marker for pop up menu: default is check.
 * mSmart, TrueOrFalse --Remembers last selection if itemNum is 0
 * mSetItemIcon, itemNum, iconID --Attaches an icon to menu item, id# 257 - 511
 * ------------------------------------------------
 * ------------------------------------------------
 * ----
 */

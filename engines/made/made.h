...
public:
	...
	bool _saveScreenOpen;
	bool _loadScreenOpen;
	bool _openingCreditsOpen;

	bool _voiceText;

	int16 _playOMaticButtonTextIndices[4];
	...
	void checkHoveringPlayOMatic();
	void voiceHighlightedPlayOMaticButton(int spriteY) const;
	bool tryAddPlayOMaticButtonTextIndex(int16 textIndex);
#endif

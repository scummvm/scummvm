...
public:
	...
	virtual void displayTemp(InkColor color, const char *name, bool outlined) override {
		char temp[MAX_COMMAND_LEN];
	...
	virtual void addLinkWord(Verb v) override {
		char temp[MAX_COMMAND_LEN];
	...
	virtual void addObject(const char *objName) override {
		char temp[MAX_COMMAND_LEN];

...
//не удовлетвор€ют потребност€м
//€ порой такой требовательный, что самому страшно.
...
//угол между векторами лежащими в плоскости ’ќ”
//иначе ее примен€ть Ќ≈Ћ№«я
					 ...
					 const Vect3f& cam_up)
{
	...
	//view_dir - Ёто ось Z в системе координат камеры
	Vect3f zAxis = view_dir;

	//ось ’ в правой системе координат
 ...
 *  что по сути своей не всегда правильно. ƒл€ того, чтобы вычислить правильно поворот 
 *	вокруг оси Z используем up и cam_up. √де cam_up - это верх камеры, который должен
 *	быть у неЄ после поворота. 
 *  ѕеред тем как вычислить угол переводим оба вектора в координаты камеры, тогда они
 *	будут лежать в плоскости ’ќ”. вычисл€ем угол и поворачиваем.
 */	


	//переводим в координаты камеры, чтобы получить 
	//плоскую картинку и пользоватьс€ atan2

...
#ifndef QDENGINE_CORE_QDCORE_QD_TRIGGER_ELEMENT_BOOST_H
#define QDENGINE_CORE_QDCORE_QD_TRIGGER_ELEMENT_BOOST_H
...
#endif // QDENGINE_CORE_QDCORE_QD_TRIGGER_ELEMENT_BOOST_H

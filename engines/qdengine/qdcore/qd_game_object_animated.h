...
#ifndef QDENGINE_CORE_QDCORE_QD_GAME_OBJECT_ANIMATED_H
#define QDENGINE_CORE_QDCORE_QD_GAME_OBJECT_ANIMATED_H
...
#endif // QDENGINE_CORE_QDCORE_QD_GAME_OBJECT_ANIMATED_H

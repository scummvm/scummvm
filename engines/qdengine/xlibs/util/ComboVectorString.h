...
struct ComboVectorWString {
	...
	ComboVectorWString &operator=(const wchar_t *val) {
		value_ = val ? val : L"";
		return *this;
	}
	ComboVectorWString &operator=(const wstring &val) {
		value_ = val;
		return *this;
	}
	...
	const wchar_t *comboList() const {
		return comboList_.c_str();
	}
	void setComboList(const wchar_t *comboList) {

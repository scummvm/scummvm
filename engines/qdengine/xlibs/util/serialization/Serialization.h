...
public:
	...
	virtual bool openBlock(const char *name, const char *nameAlt) {
		return true;
	}
	...
	bool serialize(const bool &value,               const char *name, const char *nameAlt) {
		return processValue(const_cast<bool &>(value), name, nameAlt);
	}
	bool serialize(const char &value,               const char *name, const char *nameAlt) {
		return processValue(const_cast<char &>(value), name, nameAlt);
	}

	bool serialize(const signed char &value,        const char *name, const char *nameAlt) {
		return processValue(const_cast<signed char &>(value), name, nameAlt);
	}
	bool serialize(const signed short &value,       const char *name, const char *nameAlt) {
		return processValue(const_cast<signed short &>(value), name, nameAlt);
	}
	bool serialize(const signed int &value,         const char *name, const char *nameAlt) {
		return processValue(const_cast<signed int &>(value), name, nameAlt);
	}
	bool serialize(const signed long &value,        const char *name, const char *nameAlt) {
		return processValue(const_cast<signed long &>(value), name, nameAlt);
	}

	bool serialize(const unsigned char &value,      const char *name, const char *nameAlt) {
		return processValue(const_cast<unsigned char &>(value), name, nameAlt);
	}
	bool serialize(const unsigned short &value,     const char *name, const char *nameAlt) {
		return processValue(const_cast<unsigned short &>(value), name, nameAlt);
	}
	bool serialize(const unsigned int &value,       const char *name, const char *nameAlt) {
		return processValue(const_cast<unsigned int &>(value), name, nameAlt);
	}
	bool serialize(const unsigned long &value,      const char *name, const char *nameAlt) {
		return processValue(const_cast<unsigned long &>(value), name, nameAlt);
	}

	bool serialize(const float &value,              const char *name, const char *nameAlt) {
		return processValue(const_cast<float &>(value), name, nameAlt);
	}
	bool serialize(const double &value,             const char *name, const char *nameAlt) {
		return processValue(const_cast<double &>(value), name, nameAlt);
	}

	bool serialize(const std::string &value,        const char *name, const char *nameAlt) {
		return processValue(const_cast<std::string &>(value), name, nameAlt);
	}
	bool serialize(const std::wstring &value,       const char *name, const char *nameAlt) {
		return processValue(const_cast<std::wstring &>(value), name, nameAlt);
	}
	bool serialize(const ComboListString &value,    const char *name, const char *nameAlt) {
		return processValue(const_cast<ComboListString &>(value), name, nameAlt);
	}
...
protected:
	...
	virtual bool processValue(std::wstring &,       const char *name, const char *nameAlt) {
		return false;
	}
	...
	virtual bool processBinary(MemoryBlock &buffer, const char *name, const char *nameAlt) {
		return false;
	}
	...
	virtual bool needDefaultArchive(const char *baseName) const {
		return false;
	}
	...
	virtual Archive *openDefaultArchive(const char *typeName, const char *derivedTypeName, const char *derivedTypeNameAlt) {
		return 0;
	}
...
public:
	...
	bool serialize(Archive &ar, const char *name, const char *nameAlt) {
		return ar.serializePointer(t_, name, nameAlt);
	}
...
public:
	MergeBlocksAuto(Archive &archive) : archive_(archive) {
		archive_.mergeBlocks_++;
	}
	~MergeBlocksAuto() {
		archive_.mergeBlocks_--;
	}

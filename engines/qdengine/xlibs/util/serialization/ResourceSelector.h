...
public:
	...
	static void setExport(bool export, ModelSelectorCallBack modelSelectorCallBack) {
		export_ = export;
		modelSelectorCallBack_ = modelSelectorCallBack;
	}
	static bool isExport() {
		return export_;
	}
	static ModelSelectorCallBack modelSelectorCallBack() {
		return modelSelectorCallBack_;
	}

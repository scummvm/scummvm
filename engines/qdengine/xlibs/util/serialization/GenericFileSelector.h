...
public:
	...
	const char *filter() const {
		return options_.filter_.c_str();
	}
	const char *initialDir() const {
		return options_.initialDir_.c_str();
	}
	const char *title() const {
		return options_.title_.c_str();
	}
	bool onlyInitialDir() const {
		return options_.onlyInitialDir_;
	}
	bool save() const {
		return options_.save_;
	}

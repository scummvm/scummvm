...
const char *GetKeyName(uint32 key) {
	...
	case T_ITALIAN: // Italian key names
		...
		case Common::KEYCODE_END:
			return "fine";
		case Common::KEYCODE_DOWN:
			return "freccia in giù";
		case Common::KEYCODE_PAGEDOWN:
			return "pagina in giù";
		case Common::KEYCODE_INSERT:
			return "inserisci";
		case Common::KEYCODE_DELETE:
			return "cancella";
	...
	case T_SPANISH: // Spanish key names
		...
		case Common::KEYCODE_SLASH:
			return "Menos";
		case Common::KEYCODE_RSHIFT:
			return "Mayúsculas Derecha";
		case Common::KEYCODE_KP_MULTIPLY:
			return "Asterisco";
		case Common::KEYCODE_SPACE:
			return "Barra Espaciadora";
		case Common::KEYCODE_CAPSLOCK:
			return "Bloqueo Mayúsculas";
		case Common::KEYCODE_F1:
			return "F1";
		case Common::KEYCODE_F2:
			return "F2";
	...
	case T_RUSSIAN: // Russian key names
		...
		case Common::KEYCODE_RCTRL:
			return "Ïðàâûé Ctrl";
		case Common::KEYCODE_KP_DIVIDE:
			return "Ñëýø íà äîï. êë";
		case Common::KEYCODE_HOME:
			return "Home";
		case Common::KEYCODE_UP:
			return "Ñòðåëêà ââåðõ";
		case Common::KEYCODE_PAGEUP:
			return "Page Up";
		case Common::KEYCODE_LEFT:
			return "Ñòðåëêà âëåâî";
		case Common::KEYCODE_RIGHT:
			return "Ñòðåëêà âïðàâî";
		case Common::KEYCODE_END:
			return "End";
		case Common::KEYCODE_DOWN:
			return "Ñòðåëêà âíèç";

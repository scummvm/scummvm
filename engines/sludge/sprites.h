...
struct SpriteDisplay {
	...
	SpriteDisplay(int xpos, int ypos, Graphics::FLIP_FLAGS f, Graphics::Surface *ptr, int w = -1, int h = 1, bool free = false) : x(xpos), y(ypos), flip(f), surface(ptr), width(w), height(h), freeAfterUse(free) {
	}
};

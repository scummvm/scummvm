...
#ifndef HOLLYWOOD_SCENES_PLAYABLE_SCENE1040_H
#define HOLLYWOOD_SCENES_PLAYABLE_SCENE1040_H
...
// mainFlowStateId, scene1040EntryLineSeen, scene1040CloakroomDoorOpened,
// scene1040GorillaCordState, scene1040BalloonTaken.
// Saved GameplayState fields written:
// mainFlowStateId, scene1040EntryLineSeen, scene1040CloakroomDoorOpened,
// scene1040GorillaCordState, scene1040BalloonTaken.
class Scene1040 : public PlayableScene {
public:
	Scene1040(HollywoodEngine *vm);
...
private:
	...
	void runDoorToCloakroomAction();
	void handleCordPickup();
...
#endif // HOLLYWOOD_SCENES_PLAYABLE_SCENE1040_H

...
void Scene2090::drawClipFrameDeltaFromResource(const Common::Array<byte> &resource, uint32 frameTableOffset,
...
void Scene2090::drawClipFrameDelta(byte chunkIndex, uint tableEntryCount, byte frameIndex) {

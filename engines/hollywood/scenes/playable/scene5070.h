...
#ifndef HOLLYWOOD_SCENES_PLAYABLE_SCENE5070_H
#define HOLLYWOOD_SCENES_PLAYABLE_SCENE5070_H
...
// mainFlowStateId, scene5070ShovelTaken, scene5070AviatorCapState.
// Saved GameplayState fields written:
// mainFlowStateId, scene5070ShovelTaken, scene5070AviatorCapState.
class Scene5070 : public PlayableScene {
public:
	Scene5070(HollywoodEngine *vm);
...
private:
	...
	void runShovelPickup();
	void runAviatorCapPickup();
	void drawHangingItemForeground();
...
#endif // HOLLYWOOD_SCENES_PLAYABLE_SCENE5070_H

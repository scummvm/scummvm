...
#ifndef HOLLYWOOD_SCENES_PLAYABLE_SCENE4010_H
#define HOLLYWOOD_SCENES_PLAYABLE_SCENE4010_H
...
private:
	...
	void runEntryFromRightSide();
	void runEntryFromLeftSide();
	...
	void setHeckerDialogueRecord(Common::Array<DialogueChoiceRecord> &records, uint index,
	...
	void setScenePoint(uint baseOffset, byte itemId, uint16 x, uint16 y);
...
#endif // HOLLYWOOD_SCENES_PLAYABLE_SCENE4010_H

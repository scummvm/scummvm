...
struct GameplayState {
	...
	void reset() {
		...
		seenScene4090InitialGreeting = false;
		scene4090AlternateAnimationSet = 0;
		seenScene4090Chunk8RevealDialogue = false;
		scene4090FinalCutsceneState = 0;
		seenScene4090FinalCutsceneDialogue = false;
		seenScene4100EntryLine = false;
		scene4110Item46Taken = false;
		scene4110AlternateSceneState = false;
		scene4110PostAlternateFlag = false;
	...
	bool seenScene4090InitialGreeting;
	byte scene4090AlternateAnimationSet;
	bool seenScene4090Chunk8RevealDialogue;
	byte scene4090FinalCutsceneState;
	bool seenScene4090FinalCutsceneDialogue;
	bool seenScene4100EntryLine;
	bool scene4110Item46Taken;
	bool scene4110AlternateSceneState;
	bool scene4110PostAlternateFlag;

...
Common::KeymapArray BuriedMetaEngine::initKeymaps(const char *target) const {
	...
	// I18N: The game has an inventory with a list of biochips. This action is used to switch the equiped biochip to blank biochip.
	act = new Action("BIOBLANK", _("Biochip blank"));
	act->setCustomEngineActionEvent(kActionBiochipBlank);
	act->addDefaultInputMapping("C+b");
	inventoryKeyMap->addAction(act);

	// I18N: The game has an inventory with a list of biochips. This action is used to switch the equiped biochip to cloak biochip.
	act = new Action("BIOCLOAK", _("Biochip cloak"));
	act->setCustomEngineActionEvent(kActionBiochipCloak);
	act->addDefaultInputMapping("C+c");
	inventoryKeyMap->addAction(act);

	// I18N: The game has an inventory with a list of biochips. This action is used to switch the equiped biochip to evidence biochip.
	...
	// I18N: The game has an inventory with a list of biochips. This action is used to switch the equiped biochip to files biochip.
	act = new Action("BIOFILES", _("Biochip files"));
	act->setCustomEngineActionEvent(kActionBiochipFiles);
	act->addDefaultInputMapping("C+f");
	inventoryKeyMap->addAction(act);

	// I18N: The game has an inventory with a list of biochips. This action is used to switch the equiped biochip to interface biochip.
	...
	// I18N: The game has an inventory with a list of biochips. This action is used to switch the equiped biochip to jump biochip.
	act = new Action("BIOJUMP", _("Biochip jump"));
	act->setCustomEngineActionEvent(kActionBiochipJump);
	act->addDefaultInputMapping("C+j");
	inventoryKeyMap->addAction(act);

	// I18N: The game has an inventory with a list of biochips. This action is used to switch the equiped biochip to translate biochip.

...
bool AIScriptDeskClerk::UpdateAnimation(int *animation, int *frame) {
	...
	if (Global_Variable_Query(kVariableChapter) > 3 && _animationState >= 6) {
		Actor_Change_Animation_Mode(kActorDeskClerk, kAnimationModeIdle);
		*animation = 661;
		_animationFrame = 0;
		_animationState = 0;

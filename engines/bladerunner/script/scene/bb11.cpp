...
void SceneScriptBB11::SceneFrameAdvanced(int frame) {
	if (Actor_Query_Goal_Number(kActorSadik) == kGoalSadikBB11KnockOutMcCoy && !Game_Flag_Query(kFlagBB11SadikPunchedMcCoy)) {
...
void SceneScriptBB11::PlayerWalkedIn() {
	if (Actor_Query_Goal_Number(kActorSadik) == kGoalSadikBB11Wait && Global_Variable_Query(kVariableChapter) == 2) {

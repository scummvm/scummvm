...
static const int *getPoliceMazePS13TrackData46() { // Enemy (kItemPS13Target1) - Starts activated
	static int trackData[] = {
		kPMTIActivate,
		kVariablePoliceMazePS13TargetCounter,
		kPoliceMazePS13TargetCount,
		kPMTIVariableInc,
		kVariablePoliceMazePS13TargetCounter,
		kPoliceMazePS13TargetCount,
...
static const int *getPoliceMazePS13TrackData52() { // Enemy (kItemPS13Target7) - Rotating reveal
	static int trackData[] = {
		...
		500,
		kPMTIEnemySet,
		kItemPS13Target7, // rotate - reveal
		kPMTIRotate,
		555,
		80,
		kPMTIWait,
...
static const int *getPoliceMazePS13TrackData53() { // Enemy (kItemPS13Target8) - Rotating reveal
	static int trackData[] = {
		...
		5,
		kPMTIEnemySet,
		kItemPS13Target8, // rotate - reveal
		kPMTIRotate,
		868,
		200,
		kPMTIWait,
...
static const int *getPoliceMazePS13TrackData54() { // Enemy (kItemPS13Target9) - Rotating reveal
	static int trackData[] = {
...
#if BLADERUNNER_ORIGINAL_BUGS
		kPMTIFacing,
		512, // fix starting orientation
#else
		kPMTIFacing,
		250, // must have concealed weapon since starting as innocent
#endif
		kPMTIPosition,
		0,
		kPMTIWaitRandom,
		...
		500,
		kPMTIEnemySet,
		kItemPS13Target9, // rotate - reveal
		kPMTIRotate,
		768,
		80,
		kPMTIWait,
...
static const int *getPoliceMazePS13TrackData55() { // Enemy linked series (kItemPS13Target10, kItemPS13Target11, kItemPS13Target12) - Rotating reveal
	static int trackData[] = {
		...
		kPMTITargetSet,
		kItemPS13Target10,
		0, // remove target-able here - redundant here though
		kPMTITargetSet,
		kItemPS13Target11,
		0, // remove target-able here - redundant here though
		kPMTITargetSet,
...
#else
		kPMTIEnemyReset,
		kItemPS13Target11, // set the others in the series as non-enemies here too
		kPMTIEnemyReset,
		kItemPS13Target12, // set the others in the series as non-enemies here too
#endif // BLADERUNNER_ORIGINAL_BUGS
		kPMTIObstacleSet,
		kItemPS13Target10,
		kPMTIMove,
		...
		kPMTITargetSet,
		kItemPS13Target10,
		0, // remove target-able here - only for kItemPS13Target10 item
#endif // BLADERUNNER_ORIGINAL_BUGS
		kPMTIObstacleSet,
		kItemPS13Target11,
		kPMTIPausedSet,
...
static const int *getPoliceMazePS13TrackData56() { // Enemy linked series (kItemPS13Target10, kItemPS13Target11, kItemPS13Target12) - Rotating reveal
	static int trackData[] = {
		...
		0,
		kPMTIObstacleSet,
		kItemPS13Target11, // redundant (original)
		kPMTIEnemyReset,
		kItemPS13Target11, // [redundant after bug fix] target 10-11-12 still is not revealed as enemy
		kPMTIMove,
		14,
		kPMTIWait,
		1000,
		...
		kPMTITargetSet,
		kItemPS13Target11,
		0, // remove target-able here - only for kItemPS13Target11 item
#endif // BLADERUNNER_ORIGINAL_BUGS
		kPMTIObstacleSet,
		kItemPS13Target12,
		kPMTIPausedSet,
...
static const int *getPoliceMazePS13TrackData57() { // Enemy linked series (kItemPS13Target10, kItemPS13Target11, kItemPS13Target12) - Rotating reveal
	static int trackData[] = {
		kPMTIEnemySet,
		kItemPS13Target12, // rotate - reveal
#if BLADERUNNER_ORIGINAL_BUGS
#else
		kPMTIEnemySet,
		kItemPS13Target10, // set all other targets in linked series as enemies here too for consistency
		kPMTIEnemySet,
		kItemPS13Target11, // set all other targets in linked series as enemies here too for consistency
#endif // BLADERUNNER_ORIGINAL_BUGS
		kPMTIFacing,
		327,
		kPMTIPosition,
		0,
		kPMTIObstacleSet,
		kItemPS13Target12, // redundant (original)
		kPMTIRotate,
		516,
		80,
		kPMTIWait,
		...
		kPMTITargetSet,
		kItemPS13Target12,
		0, // remove target-able here - only for kItemPS13Target12 item
#endif // BLADERUNNER_ORIGINAL_BUGS
		kPMTIPausedReset1of2,
		kItemPS13Target13,
		kItemPS13Target9,
...
static const int *getPoliceMazePS13TrackData58() { // Special (kItemPS13Target13) - Starts activated - Innocent x2
	static int trackData[] = {
		...
		kPMTITargetSet,
		kItemPS13Target13,
		1, // intended: special: "second" innocent (re-using the target of the track)
		kPMTIEnemyReset,
		kItemPS13Target13, // intended: special: "second" innocent (re-using the target of the track)
		kPMTIWait,
		200,
		kPMTIMove,
		9,
...
static const int *getPoliceMazePS13TrackData62() { // Enemy (kItemPS13Target14) - Rotating reveal
	static int trackData[] = {
		...
		1000,
		kPMTIEnemySet,
		kItemPS13Target14, // rotate - reveal
		kPMTIRotate,
		650,
		80,
		kPMTIWait,
...
static const int *getPoliceMazePS13TrackData63() { // Enemy (kItemPS13Target15) - Rotating reveal
	static int trackData[] = {
		...
		1000,
		kPMTIEnemySet,
		kItemPS13Target15, // rotate - reveal
		kPMTIRotate,
		710,
		80,
		kPMTIWait,

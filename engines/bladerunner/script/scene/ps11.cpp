...
static const int *getPoliceMazePS11TrackData9() { // Enemy (kItemPS11Target1) - Starts activated
	static int trackData[] = {
		kPMTIActivate,
		kVariablePoliceMazePS11TargetCounter,
		kPoliceMazePS11TargetCount,
		kPMTIVariableInc,
		kVariablePoliceMazePS11TargetCounter,
		kPoliceMazePS11TargetCount,
...
static const int *getPoliceMazePS11TrackData10() { // Enemy (kItemPS11Target2, kItemPS11Target3) - Rotating reveal (as kItemPS11Target3)
	static int trackData[] = {
...
#else
		kPMTIEnemyReset,
		kItemPS11Target3, // both targets should clear their enemy flag here
#endif // BLADERUNNER_ORIGINAL_BUGS
		kPMTIObstacleSet,
		kItemPS11Target2,
		kPMTIPlaySound,
		...
		kPMTITargetSet,
		kItemPS11Target2,
		0, // remove target-able here - only for kItemPS11Target2 item
#endif // BLADERUNNER_ORIGINAL_BUGS
		kPMTIObstacleSet,
		kItemPS11Target3,
		kPMTIPausedSet,
...
static const int *getPoliceMazePS11TrackData11() { // Enemy (kItemPS11Target2, kItemPS11Target3)
	static int trackData[] = {
		...
		0,
		kPMTIEnemyReset,
		kItemPS11Target3, // [redundant after bug fix] target 2-3 still is not revealed as enemy
		kPMTIMove,
		25,
		kPMTIWait,
		500,
		kPMTIEnemySet,
		kItemPS11Target3, // rotate - reveal -- no need to set target 2 as enemy too, since it's gone
		kPMTIPlaySound,
		kSfxTARGUP4,
		33,
		kPMTIRotate,
...
static const int *getPoliceMazePS11TrackData14() { // Enemy (kItemPS11Target6) - Rotating reveal
	static int trackData[] = {
...
#if BLADERUNNER_ORIGINAL_BUGS
		kPMTIFacing,
		900, // orientation is wrong here - should conceal the gun entirely
#else
		kPMTIFacing,
		750, // corrected orientation
#endif // BLADERUNNER_ORIGINAL_BUGS
		kPMTIPosition,
		0,
		kPMTIWaitRandom,
		...
		500,
		kPMTIEnemySet,
		kItemPS11Target6, // rotate - reveal
		kPMTIRotate,
		644,
		80,
		kPMTIWait,
		...
		kPMTIRotate,
		388,
		80, // orientation is wrong here
#else
		kPMTIRotate,
		260,
		80, // corrected orientation - face towards McCoy
#endif // BLADERUNNER_ORIGINAL_BUGS
		kPMTIWait,
		1000,
		kPMTIShoot,
...
static const int *getPoliceMazePS11TrackData15() { // Special (kItemPS11Target7, kItemPS11Target8) - Innocent x2
	static int trackData[] = {
		...
		kPMTITargetSet,
		kItemPS11Target7,
		0, // remove target-able here - redundant, but consistent with the original kPMTIObstacleReset (redundant) instructions that follow
		kPMTITargetSet,
		kItemPS11Target8,
		0, // remove target-able here - redundant, but consistent with the original kPMTIObstacleReset (redundant) instructions that follow
#endif // BLADERUNNER_ORIGINAL_BUGS
...
#else
		kPMTIEnemyReset,
		kItemPS11Target8, // both targets should clear their enemy flag here
#endif // BLADERUNNER_ORIGINAL_BUGS
		kPMTIMove,
		14,
...
static const int *getPoliceMazePS11TrackData16() { // Innocent (kItemPS11Target7, kItemPS11Target8)
	static int trackData[] = {
		...
		kItemPS11Target8,
		kPMTIEnemyReset,
		kItemPS11Target8, // [redundant after bug fix]
		kPMTIMove,
		25,
		kPMTIWait,
		500,
...
static const int *getPoliceMazePS11TrackData17() { // Special (kItemPS11Target9) - Enemy x3
	static int trackData[] = {
...
#else
		kPMTIObstacleSet,
		kItemPS11Target9, // make visible after the wait period, not before
		kPMTITargetSet,
		kItemPS11Target9,
		1, // set Target-able after the wait period, not before
#endif // BLADERUNNER_ORIGINAL_BUGS
		kPMTIPlaySound,
		kSfxTARGUP4,
		33,
		...
		kPMTIEnemySet,
		kItemPS11Target9, // intended: special: "second" enemy (re-using the target of the track)
		kPMTIMove,
		24,
		kPMTITargetSet,
		kItemPS11Target9,
		1, // intended: special: "third" enemy (re-using the target of the track)
		kPMTIEnemySet,
		kItemPS11Target9, // intended: special: "third" enemy (re-using the target of the track)
		kPMTIMove,
		10,
		kPMTIWait,
		0, // this results in shooting too fast - TODO maybe introduce a small wait here (50 or 150)
...
static const int *getPoliceMazePS11TrackData18() { // Special (kItemPS11Target10, kItemPS11Target11) - Rotating reveal and Enemy x2
	static int trackData[] = {
...
#else
		kPMTIEnemyReset,
		kItemPS11Target11, // both targets should clear their enemy flag here
#endif
		kPMTIWaitRandom,
		4000,
		6000,
		...
		80,
		kPMTIEnemySet,
		kItemPS11Target10, // Now the target is an enemy. (special) Rotate reveal
#if BLADERUNNER_ORIGINAL_BUGS
#else
		kPMTIEnemySet,
		kItemPS11Target11, // both targets should set their enemy flag here
#endif // BLADERUNNER_ORIGINAL_BUGS
		kPMTIWait,
		0,
		kPMTIRotate,
		...
		kPMTITargetSet,
		kItemPS11Target10,
		0, // remove target-able here only for kItemPS11Target10
#endif // BLADERUNNER_ORIGINAL_BUGS
		kPMTIObstacleSet,
		kItemPS11Target11,
		kPMTIPausedSet,
...
static const int *getPoliceMazePS11TrackData19() { // Special (kItemPS11Target10, kItemPS11Target11) - becomes an Enemy again
	static int trackData[] = {
		...
		0,
		kPMTIEnemySet,
		kItemPS11Target11, // [redundant after bug fix]
		kPMTIMove,
		8,
		kPMTIWait,
		4000,
		...
		1, // intended: special: "second" enemy (re-using the target of the track)
		kPMTIEnemySet,
		kItemPS11Target11, // intended: special: "second" enemy (re-using the target of the track)
		kPMTIMove,
		2,
		kPMTIPlaySound,
		kSfxTARGUP4,

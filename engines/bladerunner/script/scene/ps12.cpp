...
static const int *getPoliceMazePS12TrackData29() { // Enemy (kItemPS12Target1) - Starts activated
	static int trackData[] = {
		kPMTIActivate,
		kVariablePoliceMazePS12TargetCounter,
		kPoliceMazePS12TargetCount,
		kPMTIVariableInc,
		kVariablePoliceMazePS12TargetCounter,
		kPoliceMazePS12TargetCount,
...
static const int *getPoliceMazePS12TrackData30() { // Enemy (kItemPS12Target2) - Starts activated
	static int trackData[] = {
		...
		kPMTITargetSet,
		kItemPS12Target2,
		0, // remove target-able after making target invisible
#endif // BLADERUNNER_ORIGINAL_BUGS
		kPMTIPausedReset1of2,
		kItemPS12Target13,
		kItemPS12Target11,
		...
		kPMTITargetSet,
		kItemPS12Target2,
		0, // removes target-able here (original code)
#endif // BLADERUNNER_ORIGINAL_BUGS
		kPMTIRestart
	};
	return trackData;
...
static const int *getPoliceMazePS12TrackData34() { // Special (kItemPS12Target6, kItemPS12Target7, kItemPS12Target8) - Enemy x2
	static int trackData[] = {
		...
		kPMTITargetSet,
		kItemPS12Target6,
		1, // intended: special: "second" enemy (re-using the targets of the track)
		kPMTITargetSet,
		kItemPS12Target7,
		1, // intended: special: "second" enemy (re-using the targets of the track)
		kPMTITargetSet,
		...
		1, // intended: special: "second" enemy (re-using the targets of the track)
		kPMTIEnemySet,
		kItemPS12Target6, // intended: special: "second" enemy (re-using the targets of the track)
		kPMTIEnemySet,
		kItemPS12Target7, // intended: special: "second" enemy (re-using the targets of the track)
		kPMTIEnemySet,
		kItemPS12Target8, // intended: special: "second" enemy (re-using the targets of the track)
		kPMTIRotate,
		376,
		80,
		kPMTIWait,
		...
		kPMTITargetSet,
		kItemPS12Target6,
		0, // remove target-able here - only for this item
		kPMTIObstacleSet,
		kItemPS12Target7,
		kPMTIPausedSet,
		kItemPS12Target6,
...
static const int *getPoliceMazePS12TrackData35() { // Enemy (kItemPS12Target6, kItemPS12Target7, kItemPS12Target8)
	static int trackData[] = {
		kPMTIObstacleSet,
		kItemPS12Target7, // [redundant after bug fix]
		kPMTIFacing,
		198,
		kPMTIPosition,
		0,
		...
		198,
		kPMTIObstacleSet,
		kItemPS12Target7, // this is a bad idea, since kItemPS12Target7 role has ended
#else
		...
		kPMTIPausedReset,
		kItemPS12Target8, // kItemPS12Target8 continues the route of this item
		kPMTIObstacleReset,
		kItemPS12Target7, // kItemPS12Target7 becomes invisible
		kPMTITargetSet,
		kItemPS12Target7,
		0, // remove target-able here - only for this item
		kPMTIObstacleSet,
		kItemPS12Target8, // kItemPS12Target8 becomes visible in kItemPS12Target7's place
		kPMTIPausedSet,
		kItemPS12Target7,
		kPMTIFacing,
		198,
...
static const int *getPoliceMazePS12TrackData36() { // Enemy (kItemPS12Target6, kItemPS12Target7, kItemPS12Target8)
	static int trackData[] = {
		kPMTIObstacleSet,
		kItemPS12Target8, // [redundant after bug fix]
		kPMTIFacing,
		469,
		kPMTIPosition,
		0,
		kPMTIObstacleSet,
		kItemPS12Target8, // redundant (original)
		kPMTIMove,
		9,
		kPMTIPlaySound,
		kSfxTARGUP1,
...
static const int *getPoliceMazePS12TrackData37() { // Special: Innocent (kItemPS12Target9) - Starts activated, goes together with enemy kItemPS12Target10 (not same target)
	static int trackData[] = {
		...
		6000,
		kPMTIPausedReset,
		kItemPS12Target10, // kItemPS12Target10 is unpaused early since he is the enemy using kItemPS12Target9 as human shield
		kPMTIFacing,
		1010,
		kPMTIPosition,
		0,
...
static const int *getPoliceMazePS12TrackData39() { // Enemy (kItemPS12Target11) - Rotating reveal
	static int trackData[] = {
		...
		1000,
		kPMTIEnemySet,
		kItemPS12Target11, // rotate - reveal
		kPMTIRotate,
		1010,
		80,
		kPMTIPlaySound,
...
static const int *getPoliceMazePS12TrackData40() { // Enemy (kItemPS12Target12) - Starts activated - Rotating reveal
	static int trackData[] = {
		...
		500,
		kPMTIEnemySet,
		kItemPS12Target12, // rotate - reveal
		kPMTIRotate,
		968,
		80,
		kPMTIPlaySound,
...
static const int *getPoliceMazePS12TrackData45() { // Enemy (kItemPS12Target17) - Rotating reveal
	static int trackData[] = {
		...
		1000,
		kPMTIEnemySet,
		kItemPS12Target17, // rotate - reveal
		kPMTIRotate,
		284,
		80,
		kPMTIWait,

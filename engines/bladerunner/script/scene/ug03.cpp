...
bool SceneScriptUG03::ClickedOn3DObject(const char *objectName, bool a2) {
	if (Object_Query_Click("CHAIR_BACK", objectName) || Object_Query_Click("CHAIR_SEAT", objectName) || Object_Query_Click("CHAIR_HEADZAPPER", objectName)
#if BLADERUNNER_ORIGINAL_BUGS
#else
	    || Object_Query_Click("CHAIR_STRAPLEGLEFT", objectName) || Object_Query_Click("CHAIR_STRAPLEGRIGHT", objectName)
#endif // BLADERUNNER_ORIGINAL_BUGS
	) {

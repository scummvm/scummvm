...
// (e.g. MIPS).
//-------------------------------------------------------------------------
inline int16 ReadInt16(const void *ptr) {
...
inline int ReadInt32(const void *ptr) {
#if defined (MEMORY_STRICT_ALIGNMENT)
	const uint8 *b = (const uint8 *)ptr;
#if defined (BITBYTE_BIG_ENDIAN)
...
inline int64 ReadInt64(const void *ptr) {
#if defined (MEMORY_STRICT_ALIGNMENT)
	const uint8 *b = (const uint8 *)ptr;
#if defined (BITBYTE_BIG_ENDIAN)
...
inline void WriteInt16(void *ptr, int16 value) {
#if defined (MEMORY_STRICT_ALIGNMENT)
	uint8 *b = (uint8 *)ptr;
#if defined (BITBYTE_BIG_ENDIAN)
	b[0] = (uint8)(value >> 8);
...
inline void WriteInt32(void *ptr, int value) {
#if defined (MEMORY_STRICT_ALIGNMENT)
	uint8 *b = (uint8 *)ptr;
#if defined (BITBYTE_BIG_ENDIAN)
	b[0] = (uint8)(value >> 24);
...
inline void WriteInt64(void *ptr, int64 value) {
#if defined (MEMORY_STRICT_ALIGNMENT)
	uint8 *b = (uint8 *)ptr;
#if defined (BITBYTE_BIG_ENDIAN)
	b[0] = (uint8)(value >> 56);
...
//-------------------------------------------------------------------------
inline int16 ReadInt16LE(const void *ptr) {
	return BBOp::Int16FromLE(ReadInt16(ptr));
}

inline int ReadInt32LE(const void *ptr) {
	return BBOp::Int32FromLE(ReadInt32(ptr));
}

inline int64 ReadInt64LE(const void *ptr) {
	return BBOp::Int64FromLE(ReadInt64(ptr));
}

inline void WriteInt16LE(void *ptr, int16 value) {
	WriteInt16(ptr, BBOp::Int16FromLE(value));
}

inline void WriteInt32LE(void *ptr, int value) {
	WriteInt32(ptr, BBOp::Int32FromLE(value));
}

inline void WriteInt64LE(void *ptr, int64 value) {
	WriteInt64(ptr, BBOp::Int64FromLE(value));
}

inline int16 ReadInt16BE(const void *ptr) {
	return BBOp::Int16FromBE(ReadInt16(ptr));
}

inline int ReadInt32BE(const void *ptr) {
	return BBOp::Int32FromBE(ReadInt32(ptr));
}

inline int64 ReadInt64BE(const void *ptr) {
	return BBOp::Int64FromBE(ReadInt64(ptr));
}

inline void WriteInt16BE(void *ptr, int16 value) {
	WriteInt16(ptr, BBOp::Int16FromBE(value));
}

inline void WriteInt32BE(void *ptr, int value) {
	WriteInt32(ptr, BBOp::Int32FromBE(value));
}

inline void WriteInt64BE(void *ptr, int64 value) {
...
inline void BlockCopy(uint8 *dst, const size_t dst_pitch, const size_t dst_offset,
	const uint8 *src, const size_t src_pitch, const size_t src_offset,
	const size_t height) {

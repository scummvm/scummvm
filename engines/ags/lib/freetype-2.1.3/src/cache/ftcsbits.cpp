...
#include FT2_1_3_CACHE_SMALL_BITMAPS_H
...
ftc_sbit_family_compare( FTC_SBitFamily  sfam,
	...
	/*                                                         */
	result = FT2_1_3_BOOL( FTC_IMAGE_TYPE_COMPARE( &sfam->type, &squery->type ) );
	if ( result )
...
FTC_SBit_Cache_Lookup( FTC_SBit_Cache   cache,
	...
	/* convert image type flags to load flags */
	{
		...
		if ( type & ftc_image_flag_unhinted )
			load_flags |= FT2_1_3_LOAD_NO_HINTING;

...
#include "engines/ags/lib/freetype-2.1.3/modules/raster/ftrend1.h"
...
static FT_Error ft_raster1_transform(FT_Renderer render, FT_GlyphSlot slot, FT_Matrix *matrix, FT_Vector *delta) {
...
static FT_Error ft_raster1_render(FT_Renderer render, FT_GlyphSlot slot, FT_Render_Mode mode, FT_Vector *origin) {
	FT_Error 	error;
	FT_Outline  *outline;
	FT_BBox 	cbox;

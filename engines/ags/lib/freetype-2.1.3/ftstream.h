...
#define FT_PEEK_LONG(p)   		FT_INT32(FT_INT8_I32(p, 0, 24) | FT_BYTE_I32(p, 1, 16) | FT_BYTE_I32(p, 2, 8) | FT_BYTE_I32(p, 3, 0))
#define FT_PEEK_ULONG(p)  		FT_UINT32(FT_BYTE_U32(p, 0, 24) | FT_BYTE_U32(p, 1, 16) | FT_BYTE_U32(p, 2, 8) | FT_BYTE_U32(p, 3, 0))
#define FT_PEEK_OFF3(p)   		FT_INT32(FT_INT8_I32(p, 0, 16) | FT_BYTE_I32(p, 1, 8) | FT_BYTE_I32(p, 2, 0))
...
#define FT_PEEK_LONG_LE(p) 	FT_INT32(FT_INT8_I32(p, 3, 24) | FT_BYTE_I32(p, 2, 16) | FT_BYTE_I32(p, 1, 8) | FT_BYTE_I32(p, 0, 0))
#define FT_PEEK_ULONG_LE(p)	FT_UINT32(FT_BYTE_U32(p, 3, 24) | FT_BYTE_U32(p, 2, 16) | FT_BYTE_U32(p, 1, 8) | FT_BYTE_U32(p, 0, 0))
#define FT_PEEK_OFF3_LE(p)		FT_INT32(FT_INT8_I32(p, 2, 16) | FT_BYTE_I32(p, 1, 8) | FT_BYTE_I32(p, 0, 0))
...
#define FT_STREAM_READ(buffer, count) 				FT_SET_ERROR(FT_Stream_Read(stream, (FT_Byte *)buffer, count))
#define FT_STREAM_READ_AT(position, buffer, count) FT_SET_ERROR(FT_Stream_ReadAt(stream, position, (FT_Byte *)buffer, count))
...
#define FT_FRAME_EXTRACT(size, bytes) 	FT_SET_ERROR(FT_Stream_ExtractFrame(stream, size, (FT_Byte **)&(bytes)))

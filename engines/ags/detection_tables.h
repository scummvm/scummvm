...
const PlainGameDescriptor GAME_NAMES[] = {
	...
	// ------------------------------------------ Reality-On-The-Norm Games ------------------------------------------
	// Pre-2.5 games that aren't supported by the current AGS engine
	{ "blastoff", "Blastoff!" },
	{ "cabbagesandkings", "Cabbages and Kings" },
	{ "commanderkeenron", "Commander Keen Enters RoN" },
	{ "davyjonescestmort", "Davy Jones c'est Mort" },
	{ "davyjonesisback", "Davy Jones is Back" },
	{ "defenderofron", "Defender of RoN" },
	{ "edgeofreality", "Edge of Reality" },
	{ "fowlplay", "RoN 2 and 1/2: Fowl Play" },
	{ "hookymcp", "Hooky McPegleg, Pirate Postman" },
	{ "invasionspacealiens", "Invasion of the Space Aliens..." },
	{ "ispy", "I Spy" },
	{ "ispy2", "I Spy II" },
	{ "kittensandcacti", "Kittens and Cacti" },
	{ "losttreasureron", "The Lost Treasure of RoN" },
	{ "lunchtimeofthedamned", "Lunchtime Of The Damned" },
	{ "montyonthenorm25", "Monty on the Norm" },
	{ "nightwatchron", "Vicks Vapourrub in Nightwatch" },
	{ "nihilism", "Nihilism" },
	{ "paranormalinvestigation25", "Paranormal Investigation" },
	{ "postmanonlydiesonce", "The Postman Only Dies Once" },
	{ "repossessor25", "The Repossessor" },
	{ "returnofdvs", "Return of Die Vie Ess" },
	{ "ronbeachparty", "RoN Beach Party" },
	{ "ronxmas2002", "RoN Xmas 2002" },
	...
	{ "homesweetron", "Home Sweet RoN" },
	{ "iiispy", "III-Spy" },
	{ "imonlysleeping", "I'm Only Sleeping" },
	{ "lostdollar", "Max Griff in: The Lost Dollar" },
	{ "majorbummerdude", "Major Bummer Dude: Lassi Quest RoN" },
	...
	{ "retaliation", "RoN 13:13 Retaliation" },
	{ "rockatruestory", "Rock - A True Story" },
	{ "ron5thanniversary", "RoN 5th Anniversary Trailer" },
	{ "ronbeforethelegacy", "Before the Legacy" },
	{ "ronsixteen", "Sixteen" },
	{ "rontimeouttrailer", "Time Out Trailer" },
	{ "rootofallevil", "Root of All Evil" },
	{ "shadowsofron", "Shadows of RoN" },
	...
	{ "thethickening", "RoN 13:13^2 The Thickening" },
	...
	{ "mmmhw1", "Maniac Mansion Mania Halloween 05-1: Ohne Titel" },
...
const AGSGameDescription GAME_DESCRIPTIONS[] = {
	...
	DETECTION_ENTRY_GUIO("dreamswitchhouse", "Dreams in the Witch House.exe", "160d78e898924f5cb1347b13746cc935", 489032242, Common::UNK_LANG, "Steam", GUIO2(GUIO_NOLANG, GAMEOPTION_NO_SAVELOAD), nullptr, ADGF_NO_FLAGS),  // v1.08 beta
	...
	DETECTION_ENTRY_GUIO("englishhaunting", "An English Haunting.exe", "de2b4205a56fce1b199a692a8b65e161", 987485394, Common::UNK_LANG, nullptr, GUIO2(GUIO_NOLANG, GAMEOPTION_NO_AUTOSAVE), nullptr, ADGF_NO_FLAGS), // itch.io Eng-Esp
	...
	DETECTION_ENTRY_GUIO("strangeland", "Strangeland.exe", "c5978d50a9b7ee1c8a50a731847d8504", 3186488616, Common::EN_ANY, nullptr, GUIO3(GUIO_NOLANG, GUIO_NOLAUNCHLOAD, GAMEOPTION_NO_SAVELOAD), nullptr, ADGF_NO_FLAGS),
	...
	DETECTION_ENTRY_GUIO("superegoch3", "Superego - Cap. 3.exe", "9e42b731efe7dceff095628372a173cc", 308682202, Common::ES_ESP, nullptr, GUIO2(GUIO_NOLANG, GAMEOPTION_NO_SAVELOAD), nullptr, ADGF_NO_FLAGS),
	...
	DETECTION_ENTRY("fountainofyouth", "FOY.exe", "06a03fe35791b0578068ab1873455463", 4137644, Common::EN_ANY, "Intro 2003", nullptr, ADGF_DEMO),
	...
	DETECTION_ENTRY("graceward", "Graceward.exe", "0564de07d3fd5c16e6947a647061913c", 292537766, Common::EN_ANY, "Complete Edition Demo", nullptr, ADGF_DEMO),  //itch.io CE
	...
	DETECTION_ENTRY("indycrownofsolomon", "rolllc2.exe", "0710e2ec71042617f565c01824f0cf3c", 5901086, Common::EN_ANY, "Rolling Demo", nullptr, ADGF_DEMO),
	...
	DETECTION_ENTRY("miguybrushson", "MIGStrailer.exe", "3b7cceb3e4bdb031dc5d8f290936e94b", 1870826, Common::IT_ITA, "Trailer", nullptr, ADGF_DEMO),
	...
	DETECTION_ENTRY("rongyptian", "Walk Like a RoNgyptian.exe", "2ca80bd50763378b72cd1e1cf25afac3", 24139016, Common::EN_ANY, "Music Video", nullptr, ADGF_DEMO),
	...
	DETECTION_ENTRY("samaritan", "samaritan.exe", "615e73fc1874e92d60a1996c2330ea36", 8714007, Common::EN_ANY, "Prototype Demo", nullptr, ADGF_DEMO),
	...
	PRE_25_ENTRY_EN("montyonthenorm25", "Monty.exe", "89f304332b7bd02ed62f754a3b53f129", 1663257),
	...
	PRE_25_ENTRY_EN("paranormalinvestigation25", "RONPI.exe", "1f0edcb7fa3f8e2b1dd60fa6c0bce60f", 2994116),
	...
	PRE_25_ENTRY_EN("repossessor25", "repossessor.exe", "1f0edcb7fa3f8e2b1dd60fa6c0bce60f", 2906801),
	...
	GAME_ENTRY_EN_PLATFORM("montyonthenorm", "monty.exe", "06a03fe35791b0578068ab1873455463", 2478569, "2007 Release"),
	GAME_ENTRY_EN_PLATFORM("montyonthenorm", "monty.exe", "f8e8f781a4a95c2bfea5f54b085df550", 3270202, "2014 Release"),
	...
	GAME_ENTRY_EN_PLATFORM("paranormalinvestigation", "ronpi.exe", "06a03fe35791b0578068ab1873455463", 2908717, "2007 Release"),
	GAME_ENTRY_EN_PLATFORM("paranormalinvestigation", "ronpi.exe", "f8e8f781a4a95c2bfea5f54b085df550", 3830361, "2014 Release"),
	...
	GAME_ENTRY_EN_PLATFORM("repossessor", "repossesor.exe", "06a03fe35791b0578068ab1873455463", 3331695, "2007 Release"),
	GAME_ENTRY_EN_PLATFORM("repossessor", "repossessor.exe", "f8e8f781a4a95c2bfea5f54b085df550", 4037461, "2014 Release"),
	...
	DETECTION_ENTRY("maniacmansionds", "spyvsspy.exe", "6cddccb3744ec5c6af7c398fb7b3b11c", 5380409, Common::DE_DEU, "Tech Demo", nullptr, ADGF_DEMO),
	...
	DETECTION_ENTRY("mmm78", "Trailer.exe", "18b284c22010850f79bc5c20054a70c4", 10149256, Common::DE_DEU, "Trailer", nullptr, ADGF_DEMO),
	...
	DETECTION_ENTRY("mmm93", "Moonshine.exe", "6cddccb3744ec5c6af7c398fb7b3b11c", 6341979, Common::DE_DEU, "Tech Demo", nullptr, ADGF_DEMO),
	...
	DETECTION_ENTRY("mmmlagrande", "Dave2.exe", "4d7d2addcde045dae6e0363a43f9acad", 7536308, Common::DE_DEU, "Tech Demo", nullptr, ADGF_DEMO),

...
const PlainGameDescriptor GAME_NAMES[] = {
	...
	{ "ags-mi3", "AGS MI3" },
	{ "agsawards2008ceremony", "AGS Awards Ceremony 2008" },
	...
	{ "clipl2heblinna", "Clip goes to town" },
	...
	{ "colinsimpsonleavesemployme", "Colin Simpson Leaves Employment" },
	...
	{ "cuentosinconclusos", "Unfinished Tales" },
	{ "cyberjack", "cyberJACK" },
	...
	{ "dreadmacfarlane2", "Dread Mac Farlane - Part 2 (unfinished)" },
	...
	{ "dysmaton", "Dysmaton" },
	{ "earlbobbyloo", "Earl Bobby is looking for a Loo" },
	{ "earlbobbyshoes", "Earl Bobby is looking for his Shoes" },
	{ "earlbobbysballs", "Earl Bobby is looking for his Balls" },
	...
	{ "easy3d", "Bog's Adventure In Easy3D" },
	...
	{ "fanbots", "Fanbots" },
	{ "farcorners", "The Far Corners of the World: Chapter 1 - The Book, the Box and the Key" },
	...
	{ "fountainofunicorns", "Princess Marian and the Fountain of Unicorns" },
	...
	{ "repossessor", "Reality on the Norm: The Repossessor" },
...
const AGSGameDescription GAME_DESCRIPTIONS[] = {
	...
	DEMO_ENTRY("earlbobbyloo", "demo.exe", "0e32c4b3380e286dc0cea8550f1c045e", 4221725),
	...
	GAME_ENTRY("earlbobbyshoes", "Bobby's Shoes.exe", "bb59de174d70797d774dec76a171352d", 12735626),
	...
	GAME_ENTRY("fanbots", "Game.exe", "4b18403fd1d150321f50cff9232d7b28", 13725413),
	...
	GAME_ENTRY("hardspace", "Hard Space!.exe", "3ecd04c0e0df079ff906ec4696d5fe23", 11494382),
	GAME_ENTRY("harrys21stbirthday", "harold.exe", "f3a13b2d6c2e0fe04c6f466062920e23", 3525444),
	GAME_ENTRY("haven1", "A small world.exe", "b142b43c146c25443a1d155d441a6a81", 43019171),
	...
	GAME_ENTRY("hotelhansen", "Hotel.exe", "3128b9f90e2f954ba704414ae854d10b", 4006863),
	...
	GAME_ENTRY("repossessor", "repossessor.exe", "f8e8f781a4a95c2bfea5f54b085df550", 4037461),

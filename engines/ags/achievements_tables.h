...
static const AchievementDescriptionList achievementDescriptionList[] = {
...

	{
		...
		"556060",
		{
			ACHIEVEMENT_SIMPLE_ENTRY("Achiev_01", "Vigilante", "That taxi driver picked up his last fare?"),
			...
			ACHIEVEMENT_SIMPLE_ENTRY("Achiev_04", "Role Player", "Ridicolous little green men?"),
			ACHIEVEMENT_SIMPLE_ENTRY("Achiev_05", "Heroic Deed", "There's only his stench left?"),
			ACHIEVEMENT_SIMPLE_ENTRY("Achiev_06", "Good Morning", "When you are a heavy sleeper?"),
			...
			ACHIEVEMENT_SIMPLE_ENTRY("Achiev_10", "Space Invader", "It's always fun to threaten Earth?"),
			ACHIEVEMENT_SIMPLE_ENTRY("Achiev_11", "Baby Sitter", "Maybe as a side job?"),
			...
			ACHIEVEMENT_SIMPLE_ENTRY("Achiev_22", "Cameo", "Those game designers are crazy?"),
...

	{
		...
		"80310",
		{
			...
			ACHIEVEMENT_SIMPLE_ENTRY("MEMORIES", "Memories", "Access the Memory Database in the Director?s Office in Center 7"),
...

	{
		...
		"761460",
		{
			...
			ACHIEVEMENT_SIMPLE_ENTRY("POEMS", "Don't Quit Your Day Job", "Read Madame DuPr\xE9's poems"),
...

	{
		...
		"279260",
		{
			...
			ACHIEVEMENT_SIMPLE_ENTRY("NEW_ACHIEVEMENT_1_6", "Sirens", "You called for help? but no-one came."),

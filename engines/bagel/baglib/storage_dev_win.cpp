...
ERROR_CODE CBagStorageDev::OnLButtonDown(UINT nFlags, CBofPoint *xPoint, void *vpInfo) {
	CBagObject *pObj;
...
ERROR_CODE CBagStorageDev::OnLButtonUp(UINT nFlags, CBofPoint *xPoint, VOID *vpInfo) {
	CBagObject *pObj;

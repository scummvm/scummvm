...
#define BIBBLE_AUDIO_LOSER      "TEMP.SND"
#define BIBBLE_AUDIO_PAYS       "EVBWIN26.SND"

#define BIBBLE_AUDIO_PAYS2      "EVBWIN43.SND"
#define BIBBLE_AUDIO_PAYS3      "EVBWIN44.SND"
#define BIBBLE_AUDIO_PAYS4      "EVBWIN45.SND"

#define SHOUT_1     "BIBBLE1.SND"
#define SHOUT_2     "BIBBLE2.SND"
#define SHOUT_3     "BIBBLE3.SND"
#define SHOUT_4     "BIBBLE4.SND"
#else
...
CBetArea g_cBetAreas[BIBBLE_NUM_BET_AREAS] = {
		...
		CBetArea(0, 66, 368, 66 + 49, 398, 10, 1, "EVBWIN04.SND", "EVBWIN29.SND"),
		CBetArea(0, 66, 401, 66 + 49, 431, 100, 1, "EVBWIN5.SND", "EVBWIN30.SND"),

		CBetArea(0, 118, 304, 118 + 47, 334, 7, 1, "EVBWIN06.SND", "EVBWIN31.SND"),
		CBetArea(0, 118, 336, 118 + 47, 366, 5, 2, "EVBWIN07.SND", "EVBWIN32.SND"),
		CBetArea(0, 118, 368, 118 + 47, 398, 5, 2, "EVBWIN08.SND", "EVBWIN32.SND"),
		CBetArea(0, 118, 401, 118 + 47, 431, 7, 1, "EVBWIN09.SND", "EVBWIN31.SND"),

		CBetArea(0, 168, 304, 168 + 48, 334, 5, 2, "EVBWIN10.SND", "EVBWIN32.SND"),
		CBetArea(0, 168, 336, 168 + 48, 366, 2, 1, "EVBWIN11.SND", "EVBWIN28.SND"),
		CBetArea(0, 168, 368, 168 + 48, 398, 5, 1, "EVBWIN12.SND", "EVBWIN33.SND"),
		CBetArea(0, 168, 401, 168 + 48, 431, 35, 1, "EVBWIN13.SND", "EVBWIN34.SND"),

		CBetArea(0, 471, 306, 471 + 49, 336, 5, 4, "EVBWIN14.SND", "EVBWIN35.SND"),
		CBetArea(0, 471, 338, 471 + 49, 368, 5, 4, "EVBWIN17.SND", "EVBWIN35.SND"),
		CBetArea(0, 471, 370, 471 + 49, 400, 3, 2, "EVBWIN20.SND", "EVBWIN27.SND"),
		CBetArea(0, 471, 403, 471 + 49, 433, 6, 1, "EVBWIN23.SND", "EVBWIN40.SND"),

		CBetArea(0, 523, 306, 523 + 47, 336, 3, 1, "EVBWIN15.SND", "EVBWIN36.SND"),
		CBetArea(0, 523, 338, 523 + 47, 368, 3, 1, "EVBWIN18.SND", "EVBWIN36.SND"),
		CBetArea(0, 523, 370, 523 + 47, 400, 8, 1, "EVBWIN21.SND", "EVBWIN38.SND"),
		CBetArea(0, 523, 403, 523 + 47, 433, 125, 1, "EVBWIN24.SND", "EVBWIN41.SND"),

		CBetArea(0, 574, 306, 574 + 47, 336, 19, 1, "EVBWIN16.SND", "EVBWIN37.SND"),
		CBetArea(0, 574, 338, 574 + 47, 368, 19, 1, "EVBWIN19.SND", "EVBWIN37.SND"),
		CBetArea(0, 574, 370, 574 + 47, 400, 90, 1, "EVBWIN22.SND", "EVBWIN39.SND"),
		CBetArea(0, 574, 403, 574 + 47, 433, 7500, 1, "EVBWIN25.SND", "EVBWIN42.SND")
	#else

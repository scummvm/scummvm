...
HWND FAR PASCAL _export RunNoVa( HWND, LPGAMESTRUCT);
...
extern "C" 
HWND FAR PASCAL _export RunNoVa( HWND hParentWnd, LPGAMESTRUCT lpGameInfo )
{
    CMainWindow *pMain;
...
CTracerDLL  NEAR tracerDLL("hnpnova.dll");
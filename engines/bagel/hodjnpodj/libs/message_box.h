...
#ifndef HODJNPODJ_LIBS_MESSAGE_BOX_H
#define HODJNPODJ_LIBS_MESSAGE_BOX_H
...
//    CMessageBox(CWnd *pParent, CPalette *pPalette, char *msg1, char *msg2 = NULL);
	CMessageBox(CWnd *pParent, CPalette *pPalette,
		const char *msg1, const char *msg2 = NULL,
		const int dx = -1, const int dy = -1);

...
// Option button clicked, then put up the Options dialog
		case IDC_OPTION:
			...
			if ( bResetGame && !m_lpGameStruct->bPlayingMetagame )
				...
				if (( m_nTimeForGame > 0 )&&( m_bNoGrid == FALSE )){
				long	lTemp = (long)m_nTimeForGame * 1000;
...
long CMainWSWindow::OnMCINotify( WPARAM wParam, LPARAM lParam)
{
CSound	*pSound;
...
long CMainWSWindow::OnMMIONotify( WPARAM wParam, LPARAM lParam)
{
CSound	*pSound;

 ...
 * HISTORY
 *
 *	  1.1	07/27/94	EDS		require both context and window
 *	  1.0	06/28/94	EDS		first release
 *
 * MODULE DESCRIPTION:
 *
 *     tbs
 ...
 * CONSTRUCTORS:
 *
 *	CSpinner			create an animation object and clear its elements
 *
 * DESTRUCTORS:
 *
 *	~CSpinner			destroy an animation object and release its resources
 *
 * PUBLIC:
 *
 *

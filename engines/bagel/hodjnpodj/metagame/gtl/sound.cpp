 ...
 * HISTORY
 *
 *    3.0   09/29/94    EDS     lock and unlock mci buffers across plays
 *    2.4   09/29/94    EDS     ignore buffer flag for wave files
 *    2.3   09/26/94    EDS     validate pointer on MMIO stop before use
 *    2.2   09/23/94    EDS     show hour glass if waiting and in meta dll
 *    2.1   09/20/94    EDS     added flags for volume control available
 *    2.0   09/14/94    EDS     lock waves only if enough memory
 *    1.9   09/06/96    EDS     close device on mmio failure
 *    1.8   08/31/94    EDS     cleanup of error checking
 *    1.7   08/23/94    EDS     sounds have own window pointers
 *    1.6   08/22/94    EDS     unqueued sounds stop other
 *    1.5   08/14/94    EDS     added Wait functions
 *    1.4   08/13/94    EDS     use sndPlaySound where appropriate
 *    1.3   07/27/94    EDS     properly handle wave autodelete
...
DWORD   dwVolume;
    ...
    if (m_bSoundAvailable) {
        ...
        if (nVolumeIndex > VOLUME_INDEX_MAX)

...
#include "bagel/hodjnpodj/metagame/bgen/note_list.h"
...
public:
...
#ifndef FRAME_EXE
	const char *GetClueArtSpec() const {
	...
	const char *GetPersonArtSpec() const {
	...
	const char *GetPlaceArtSpec() const {
	...
	const char *GetPersonSoundSpec() const {
		if ((m_nPersonID >= NOTE_ICON_BASE) &&
			(m_nPersonID < NOTE_ICON_BASE + NOTE_ICON_COUNT))
	...
	const char *GetPlaceSoundSpec() const {
		if ((m_nPlaceID >= NOTE_ICON_BASE) &&
			(m_nPlaceID < NOTE_ICON_BASE + NOTE_ICON_COUNT))

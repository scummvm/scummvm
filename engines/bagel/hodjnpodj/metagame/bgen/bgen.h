...
#ifndef HODJNPODJ_METAGAME_BGEN_H
#define HODJNPODJ_METAGAME_BGEN_H
...
// RGB colors
#define RGBCOLOR_RED		PALETTERGB(255,   0,   0)
#define RGBCOLOR_GREEN		PALETTERGB(  0, 255,   0)
#define RGBCOLOR_BLUE		PALETTERGB(  0,   0, 255)
#define RGBCOLOR_YELLOW		PALETTERGB(255, 255,   0)
#define RGBCOLOR_MAGENTA	PALETTERGB(255,   0, 255)
#define RGBCOLOR_CYAN		PALETTERGB(  0, 255, 255)
#define RGBCOLOR_BLACK		PALETTERGB(  0,   0,   0)
#define RGBCOLOR_GREY		PALETTERGB(128, 128, 128)
#define RGBCOLOR_BROWN		PALETTERGB(128, 128,   0)
#define RGBCOLOR_PURPLE		PALETTERGB(128,   0, 128)
#define RGBCOLOR_AQUA		PALETTERGB(  0, 128, 128)
#define RGBCOLOR_WHITE		PALETTERGB(255, 255, 255)

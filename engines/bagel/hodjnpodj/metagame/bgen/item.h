...
public:
...
#endif
	int GetActionCode() const { return m_nActionCode; }
	...
	CNote *GetFirstNote() const  { return m_pNotes; }
	
	CItem *GetNext() const { return m_pNext; }
	CItem *GetPrev() const { return m_pPrev; }

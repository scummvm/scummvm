...
CGameTable CMgStatic::cGameTable[] = {
	{ MG_GAME_ANAGRAMS, 0, "Anagrams", "Anagrams" },
	{ MG_GAME_ARCHEROIDS, MG_WIN_INFO, "Archeroids", "Archeroids" },
	{ MG_GAME_ARTPARTS, MG_WIN_INFO, "Art Parts", "ArtParts" },
	{ MG_GAME_BARBERSHOP, MG_WIN_OBJECT, "Barbershop Quintet", "BarbershopQuintet" },
	{ MG_GAME_BATTLEFISH, MG_WIN_OBJECT, "Battlefish", "Battlefish" },
	{ MG_GAME_BEACON, MG_WIN_MONEY, "Beacon", "Beacon" },
	{ MG_GAME_CRYPTOGRAMS, MG_WIN_MONEY, "Cryptograms", "Cryptograms" },
	{ MG_GAME_DAMFURRY, MG_WIN_MONEY, "Dam Furry Animals", "DamFurryAnimals" },
	{ MG_GAME_EVERYTHING, MG_WIN_INFO, "Everything Under the Sun", "Everything" },
	{ MG_GAME_FUGE, MG_WIN_MONEY, "Fuge", "Fuge" },
	{ MG_GAME_GARFUNKEL, MG_WIN_INFO, "Garfunkel", "Garfunkel" },
	{ MG_GAME_LIFE, MG_WIN_INFO, "Life", "Life" },
	{ MG_GAME_MANKALA, MG_WIN_INFO, "Mankala", "Mankala" },
	{ MG_GAME_MAZEODOOM, MG_WIN_OBJECT, "Maze o'Doom", "MazeDoom" },
	{ MG_GAME_NOVACANCY, MG_WIN_INFO, "No Vacancy", "NoVacancy" },
	{ MG_GAME_PACRAT, MG_WIN_OBJECT, "Pac-Rat", "PacRat" },
	{ MG_GAME_PEGGLEBOZ, MG_WIN_MONEY, "Peggleboz", "Peggleboz" },
	{ MG_GAME_PINBALL, 0, "Pinball", "Pinball" },
	{ MG_GAME_RIDDLES, MG_WIN_OBJECT, "Riddles", "Riddles" },
	{ MG_GAME_ROULETTE, 0, "Roulette", "Roulette" },
	{ MG_GAME_SHOTMACHINE, 0, "Shot Machine", "ShotMachine" },
	{ MG_GAME_SPINBALL, 0, "Spinball", "Spinball" },
	{ MG_GAME_THGESNGGME, MG_WIN_MONEY, "TH GESNG GME", "GuessingGame" },
	{ MG_GAME_TRIVIA, 0, "Trivia", "Trivia" },
	{ MG_GAME_VIDEOPOKER, MG_WIN_MONEY, "Video Poker", "VideoPoker" },
	{ MG_GAME_WORDSEARCH, MG_WIN_OBJECT, "Word Search", "WordSearch" },
	{ MG_GAME_CHALLENGE, MG_WIN_MISHMOSH, "Challenge", "Challenge" },
	{ 0, 0, nullptr, nullptr }
};
...
CClueTable *CMgStatic::FindClue(bool bHodj, int iClue) {
	...
	CClueTable *xpClueEntry = nullptr;   // Return value

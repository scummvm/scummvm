...
#ifndef HODJNPODJ_METAGAME_BGEN_BGB_H
#define HODJNPODJ_METAGAME_BGEN_BGB_H
...
public:
	...
	char m_szDataDirectory[100] = { 0 };     // directory for data files

private:
	bool m_bAnimationsPaused = true;        // Animations Paused/UnPaused
...
class CBgbObject {
public:
	char        m_szFileName[MAX_FNAME_LENGTH] = { 0 }; // filename of object's bitmap
	...
	uint        m_nFreq = 0;                // How often Animation should start
	uint        m_nRepeat = 0;              // Number of Paint cycles to perform
	uint        m_nFreqCount = 0;
	...
	uint32       m_lAge = 0;                 // age of this object

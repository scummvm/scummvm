...
HWND FAR PASCAL _export RunTGG( HWND, LPGAMESTRUCT);
...
extern "C" 
HWND FAR PASCAL _export RunTGG( HWND hParentWnd, LPGAMESTRUCT lpGameInfo )
{
    CMainWindow *pMain;
...
CTracerDLL  NEAR tracerDLL("hnptgg.dll");
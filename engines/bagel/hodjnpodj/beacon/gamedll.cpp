...
HWND FAR PASCAL _export RunBeac( HWND, LPGAMESTRUCT);
...
extern "C" 
HWND FAR PASCAL _export RunBeac( HWND hParentWnd, LPGAMESTRUCT lpGameInfo )
{
    CMainWindow *pMain;
...
CTracerDLL  NEAR tracerDLL("hnpbeac.dll");

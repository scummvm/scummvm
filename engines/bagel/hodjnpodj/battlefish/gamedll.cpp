...
HWND FAR PASCAL _export RunBFish( HWND, LPGAMESTRUCT);
...
extern "C" 
HWND FAR PASCAL _export RunBFish( HWND hParentWnd, LPGAMESTRUCT lpGameInfo )
{
    CBFishWindow *pMain;
...
CTracerDLL  NEAR tracerDLL("hnpbfish.dll");
...
const uint32 MeshXOpenGL::kNullIndex;
...
//////////////////////////////////////////////////////////////////////////
bool MeshXOpenGL::loadFromX(const Common::String &filename, XFileLexer &lexer) {
	bool res = true;
	...
	while (!lexer.eof()) {
		if (lexer.tokenIsIdentifier("MeshTextureCoords")) {
			...
			warning("MeshXOpenGL::loadFromX unknown token %i encountered", lexer.getTypeOfToken());
			lexer.advanceToNextToken();
		}
	}
...
//////////////////////////////////////////////////////////////////////////
bool MeshXOpenGL::generateAdjacency() {
...
bool MeshXOpenGL::adjacentEdge(uint16 index1, uint16 index2, uint16 index3, uint16 index4) {
...
//////////////////////////////////////////////////////////////////////////
bool MeshXOpenGL::findBones(FrameNode *rootFrame) {
...
//////////////////////////////////////////////////////////////////////////
bool MeshXOpenGL::update(FrameNode *parentFrame) {
...
//////////////////////////////////////////////////////////////////////////
bool MeshXOpenGL::updateShadowVol(ShadowVolume *shadow, Math::Matrix4 &modelMat, const Math::Vector3d &light, float extrusionDepth) {
	if (_vertexData == nullptr) {
		return false;
	}
...
//////////////////////////////////////////////////////////////////////////
bool MeshXOpenGL::pickPoly(Math::Vector3d *pickRayOrig, Math::Vector3d *pickRayDir) {
	if (_vertexData == nullptr) {
		return false;
	}
...
////////////////////////////////////////////////////////////////////////////
bool MeshXOpenGL::setMaterialSprite(const Common::String &matName, BaseSprite *sprite) {
	for (uint32 i = 0; i < _materials.size(); i++) {
...
//////////////////////////////////////////////////////////////////////////
bool MeshXOpenGL::setMaterialTheora(const Common::String &matName, VideoTheoraPlayer *theora) {
	for (uint32 i = 0; i < _materials.size(); i++) {
		if (_materials[i]->getName() && _materials[i]->getName() == matName) {
...
//////////////////////////////////////////////////////////////////////////
bool MeshXOpenGL::invalidateDeviceObjects() {
...
//////////////////////////////////////////////////////////////////////////
bool MeshXOpenGL::restoreDeviceObjects() {
	for (uint32 i = 0; i < _materials.size(); i++) {
...
bool MeshXOpenGL::parsePositionCoords(XFileLexer &lexer) {
...
bool MeshXOpenGL::parseFaces(XFileLexer &lexer, int faceCount) {
...
bool MeshXOpenGL::parseTextureCoords(XFileLexer &lexer) {
...
bool MeshXOpenGL::parseNormalCoords(XFileLexer &lexer) {
...
bool MeshXOpenGL::parseMaterials(XFileLexer &lexer, int faceCount, const Common::String &filename) {
...
bool MeshXOpenGL::parseSkinWeights(XFileLexer &lexer) {
...
void MeshXOpenGL::updateBoundingBox() {

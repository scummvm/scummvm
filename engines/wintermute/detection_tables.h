...
static const PlainGameDescriptor wintermuteGames[] = {
	...
	{"alavi1",          "Informer Alavi - Murder of Miss Rojan"},
	{"alavi2",          "Alavi Animator"},

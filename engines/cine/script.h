...
protected:
	virtual OpFunc opcodeHandler(byte opcode) const override;

public:
	virtual ~OSScriptInfo() {}

	virtual const char *opcodeInfo(byte opcode) const override;
	virtual FWScript *create(const RawScript &script, int16 index) const override;
	virtual FWScript *create(const RawObjectScript &script, int16 index) const override;
	virtual FWScript *create(const RawScript &script, int16 index, const ScriptVars &labels, const ScriptVars &local, uint16 compare, uint16 pos) const override;
	virtual FWScript *create(const RawObjectScript &script, int16 index, const ScriptVars &labels, const ScriptVars &local, uint16 compare, uint16 pos) const override;

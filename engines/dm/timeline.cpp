...
void Timeline::processEventDoorAnimation(TimelineEvent *event) {
	...
	if (sensorEffect == kDMSensorEffectClear) {
		...
		if ((_vm->_dungeonMan->_currMapIndex == _vm->_dungeonMan->_partyMapIndex) && (mapX == _vm->_dungeonMan->_partyMapX) && (mapY == _vm->_dungeonMan->_partyMapY) && (doorState != kDMDoorStateOpen)) {

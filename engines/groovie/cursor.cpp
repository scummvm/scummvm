...
GrvCursorMan::GrvCursorMan(OSystem *system) : _syst(system), _lastTime(0), _current(255), _cursor(NULL), _lastFrame(0) {
}
...
Cursor_t7g::Cursor_t7g(uint8 *img, uint8 *pal) : _pal(pal) {
...
GrvCursorMan_t7g::GrvCursorMan_t7g(OSystem *system, Common::MacResManager *macResFork) : GrvCursorMan(system) {
...
GrvCursorMan_v2::GrvCursorMan_v2(OSystem *system) : GrvCursorMan(system) {

...
static const ZVisionGameDescription gameDescriptions[] = {

	{
		// Zork Nemesis English version
		{
			...
			Common::kPlatformDOS,
			ADGF_NO_FLAGS,
			GUIO5(GAMEOPTION_ORIGINAL_SAVELOAD, GAMEOPTION_DOUBLE_FPS, GAMEOPTION_ENABLE_VENUS, GAMEOPTION_DISABLE_ANIM_WHILE_TURNING, GUIO_NOMIDI)
		},
		GID_NEMESIS
	},
...

	{
		// Zork Grand Inquisitor English CD version
		{
			...
			Common::kPlatformWindows,
			ADGF_NO_FLAGS,
			GUIO4(GAMEOPTION_ORIGINAL_SAVELOAD, GAMEOPTION_DOUBLE_FPS, GAMEOPTION_DISABLE_ANIM_WHILE_TURNING, GUIO_NOMIDI)
		},
		GID_GRANDINQUISITOR
	},
...

	{
		// Zork Grand Inquisitor English DVD version
		{
			...
			GUIO5(GAMEOPTION_ORIGINAL_SAVELOAD, GAMEOPTION_DOUBLE_FPS, GAMEOPTION_DISABLE_ANIM_WHILE_TURNING, GAMEOPTION_USE_HIRES_MPEG_MOVIES, GUIO_NOMIDI)
#else
			GUIO5(GAMEOPTION_ORIGINAL_SAVELOAD, GAMEOPTION_DOUBLE_FPS, GAMEOPTION_DISABLE_ANIM_WHILE_TURNING, GUIO_NOMIDI)
#endif
		},
		GID_GRANDINQUISITOR
	},

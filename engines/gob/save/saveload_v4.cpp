...
SaveLoad_v4::GameHandler::File::File(GobEngine *vm, const char *base) : SlotFileIndexed(vm, SaveLoad_v4::kSlotCount, base, "s") {
}

SaveLoad_v4::GameHandler::File::File(const File &file) : SlotFileIndexed(file._vm, file._slotCount, file._base, file._ext) {
}
...
SaveLoad_v4::CurScreenPropsHandler::CurScreenPropsHandler(GobEngine *vm) : SaveHandler(vm) {
...
SaveLoad_v4::SaveLoad_v4(GobEngine *vm, const char *targetName) : SaveLoad(vm) {

...
SaveLoad_v3::GameHandler::File::File(GobEngine *vm, const char *base) : SlotFileIndexed(vm, SaveLoad_v3::kSlotCount, base, "s") {
}

SaveLoad_v3::GameHandler::File::File(const File &file) : SlotFileIndexed(file._vm, file._slotCount, file._base, file._ext) {
}
...
SaveLoad_v3::SaveLoad_v3(GobEngine *vm, const char *targetName, ScreenshotType sShotType) : SaveLoad(vm) {

...
SaveLoad_Fascination::GameHandler::File::File(GobEngine *vm, const char *base) : SlotFileIndexed(vm, SaveLoad_Fascination::kSlotCount, base, "s") {
}
...
SaveLoad_Fascination::SaveLoad_Fascination(GobEngine *vm, const char *targetName) : SaveLoad(vm) {

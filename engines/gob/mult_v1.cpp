...
void Mult_v1::loadMult(int16 resId) {
	...
	for (int i = 0; i < _multData->staticCount; i++, data.seek(14, Common::kSeekCur)) {
	...
	for (int i = 0; i < _multData->animCount; i++, data.seek(14, Common::kSeekCur)) {

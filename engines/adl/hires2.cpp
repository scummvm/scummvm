...
HiResBaseEngine::HiResBaseEngine(OSystem *syst, const AdlGameDescription *gd, const byte numRooms, const byte numMsgs, const byte numItemPics) : AdlEngine_v2(syst, gd),
                                                                                                                                                 _numRooms(numRooms),
                                                                                                                                                 _numMsgs(numMsgs),
...
HiRes2Engine::HiRes2Engine(OSystem *syst, const AdlGameDescription *gd) : HiResBaseEngine(syst, gd, 135, 255, 38) {
...
HiRes3Engine::HiRes3Engine(OSystem *syst, const AdlGameDescription *gd) : HiResBaseEngine(syst, gd, 138, 255, 36) {

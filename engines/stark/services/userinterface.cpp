...
void UserInterface::handleActions(Common::CustomEventType customType) {
	...
	} else if (customType == kActionInventoryDialogueScrollUp) {
		if (isInGameScreen()) {
			if (isInventoryOpen()) {
	...
	} else if (customType == kActionInventoryScrollUpDialoguePrev) {
		if (isInGameScreen()) {
			if (isInventoryOpen()) {
				_gameScreen->getInventoryWindow()->scrollUp();
			} else {
	...
	} else if (customType == kActionInventoryDialogueScrollDown) {
		if (isInGameScreen()) {
			if (isInventoryOpen()) {
	...
	} else if (customType == kActionInventoryScrollDownDialogueNext) {
		if (isInGameScreen()) {
			if (isInventoryOpen()) {
				_gameScreen->getInventoryWindow()->scrollDown();
			} else {

...
static const ExecutableVersion v120mac = { "1.2 Mac",      kFlagNone,      "Myst3 Exile JP",                0,        0x11230,  0x1116C,  0x112F8  };
...
static const Myst3GameDescription gameDescriptions[] = {
	...
	MYST3ENTRY(Common::kPlatformMacintosh, Common::JA_JPN, 0,     "Myst3 Exile JP", "xxx", &v120mac)

...
#ifndef HARVESTER_NPC_LIBRARIAN_DIALOGUE_H
#define HARVESTER_NPC_LIBRARIAN_DIALOGUE_H

#include "harvester/npc/dialogue_handler.h"

namespace Harvester {

class LibrarianDialogueHandler : public NpcDialogueHandler {
public:
...
#endif // HARVESTER_NPC_LIBRARIAN_DIALOGUE_H

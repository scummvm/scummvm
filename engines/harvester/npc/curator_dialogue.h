...
#ifndef HARVESTER_NPC_CURATOR_DIALOGUE_H
#define HARVESTER_NPC_CURATOR_DIALOGUE_H

#include "harvester/npc/dialogue_handler.h"

namespace Harvester {

class CuratorDialogueHandler : public NpcDialogueHandler {
public:
...
#endif // HARVESTER_NPC_CURATOR_DIALOGUE_H

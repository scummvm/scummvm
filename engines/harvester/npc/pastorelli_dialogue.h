...
#ifndef HARVESTER_NPC_PASTORELLI_DIALOGUE_H
#define HARVESTER_NPC_PASTORELLI_DIALOGUE_H

#include "harvester/npc/dialogue_handler.h"

namespace Harvester {

class PastorelliDialogueHandler : public NpcDialogueHandler {
public:
...
#endif // HARVESTER_NPC_PASTORELLI_DIALOGUE_H

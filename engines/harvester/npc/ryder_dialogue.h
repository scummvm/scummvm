...
#ifndef HARVESTER_NPC_RYDER_DIALOGUE_H
#define HARVESTER_NPC_RYDER_DIALOGUE_H

#include "harvester/npc/dialogue_handler.h"

namespace Harvester {

class RyderDialogueHandler : public NpcDialogueHandler {
public:
	struct RyderRoomDialogueState {
		bool talkStatePending = true;
	};

	bool matchesNpc(const Common::String &npcName) const override;
	void resetState() override { _state = RyderRoomDialogueState(); }
...
private:
	RyderRoomDialogueState _state;
};

} // End of namespace Harvester

#endif // HARVESTER_NPC_RYDER_DIALOGUE_H

...
#ifndef HARVESTER_NPC_GLADIATOR_DIALOGUE_H
#define HARVESTER_NPC_GLADIATOR_DIALOGUE_H

#include "harvester/npc/dialogue_handler.h"

namespace Harvester {

class GladiatorDialogueHandler : public NpcDialogueHandler {
public:
...
#endif // HARVESTER_NPC_GLADIATOR_DIALOGUE_H

...
#ifndef HARVESTER_NPC_BUTCHER_DIALOGUE_H
#define HARVESTER_NPC_BUTCHER_DIALOGUE_H

#include "harvester/npc/dialogue_handler.h"

namespace Harvester {

class ButcherDialogueHandler : public NpcDialogueHandler {
public:
	struct ButcherRoomDialogueState {
...
private:
	ButcherRoomDialogueState _state;
};

} // End of namespace Harvester

#endif // HARVESTER_NPC_BUTCHER_DIALOGUE_H

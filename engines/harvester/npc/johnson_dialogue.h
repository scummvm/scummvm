...
#ifndef HARVESTER_NPC_JOHNSON_DIALOGUE_H
#define HARVESTER_NPC_JOHNSON_DIALOGUE_H

#include "harvester/npc/dialogue_handler.h"

namespace Harvester {

class JohnsonDialogueHandler : public NpcDialogueHandler {
public:
	struct JohnsonRoomDialogueState {
...
private:
	JohnsonRoomDialogueState _state;
};

} // End of namespace Harvester

#endif // HARVESTER_NPC_JOHNSON_DIALOGUE_H

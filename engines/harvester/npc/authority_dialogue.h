...
#ifndef HARVESTER_NPC_AUTHORITY_DIALOGUE_H
#define HARVESTER_NPC_AUTHORITY_DIALOGUE_H

#include "harvester/npc/dialogue_handler.h"

namespace Harvester {

class AuthorityDialogueHandler : public NpcDialogueHandler {
public:
...
#endif // HARVESTER_NPC_AUTHORITY_DIALOGUE_H

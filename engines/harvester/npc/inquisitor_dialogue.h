...
#ifndef HARVESTER_NPC_INQUISITOR_DIALOGUE_H
#define HARVESTER_NPC_INQUISITOR_DIALOGUE_H

#include "harvester/npc/dialogue_handler.h"

namespace Harvester {

class InquisitorDialogueHandler : public NpcDialogueHandler {
public:
	struct InquisitorRoomDialogueState {
		bool talkStatePending = true;
	};

	bool matchesNpc(const Common::String &npcName) const override;
	void resetState() override { _state = InquisitorRoomDialogueState(); }
...
private:
	InquisitorRoomDialogueState _state;
};

} // End of namespace Harvester

#endif // HARVESTER_NPC_INQUISITOR_DIALOGUE_H

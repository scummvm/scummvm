...
#ifndef HARVESTER_NPC_MOTHER_DIALOGUE_H
#define HARVESTER_NPC_MOTHER_DIALOGUE_H

#include "harvester/npc/dialogue_handler.h"

namespace Harvester {

class MotherDialogueHandler : public NpcDialogueHandler {
public:
	struct MotherRoomDialogueState {
		bool talkStatePending = true;
	};

	bool matchesNpc(const Common::String &npcName) const override;
	void resetState() override { _state = MotherRoomDialogueState(); }
...
private:
	MotherRoomDialogueState _state;
};

} // End of namespace Harvester

#endif // HARVESTER_NPC_MOTHER_DIALOGUE_H

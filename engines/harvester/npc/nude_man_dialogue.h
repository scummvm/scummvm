...
#ifndef HARVESTER_NPC_NUDE_MAN_DIALOGUE_H
#define HARVESTER_NPC_NUDE_MAN_DIALOGUE_H

#include "harvester/npc/dialogue_handler.h"

namespace Harvester {

class NudeManDialogueHandler : public NpcDialogueHandler {
public:
	struct NudeManRoomDialogueState {
		bool talkStatePending = true;
	};

	bool matchesNpc(const Common::String &npcName) const override;
	void resetState() override { _state = NudeManRoomDialogueState(); }
...
private:
	NudeManRoomDialogueState _state;
};

} // End of namespace Harvester

#endif // HARVESTER_NPC_NUDE_MAN_DIALOGUE_H

...
#ifndef HARVESTER_NPC_BUSTER_DIALOGUE_H
#define HARVESTER_NPC_BUSTER_DIALOGUE_H

#include "harvester/npc/dialogue_handler.h"

namespace Harvester {

class BusterDialogueHandler : public NpcDialogueHandler {
public:
	struct BusterRoomDialogueState {
...
private:
	BusterRoomDialogueState _state;
};

} // End of namespace Harvester

#endif // HARVESTER_NPC_BUSTER_DIALOGUE_H

...
#ifndef HARVESTER_NPC_BOYLE_DIALOGUE_H
#define HARVESTER_NPC_BOYLE_DIALOGUE_H

#include "harvester/npc/dialogue_handler.h"

namespace Harvester {

class BoyleDialogueHandler : public NpcDialogueHandler {
public:
	struct BoyleRoomDialogueState {
		bool introPending = true;
		bool extraEvidenceReplyEnabled = false;
...
private:
	BoyleRoomDialogueState _state;
};

} // End of namespace Harvester

#endif // HARVESTER_NPC_BOYLE_DIALOGUE_H

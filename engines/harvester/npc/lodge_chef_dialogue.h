...
#ifndef HARVESTER_NPC_LODGE_CHEF_DIALOGUE_H
#define HARVESTER_NPC_LODGE_CHEF_DIALOGUE_H

#include "harvester/npc/dialogue_handler.h"

namespace Harvester {

class LodgeChefDialogueHandler : public NpcDialogueHandler {
public:
...
#endif // HARVESTER_NPC_LODGE_CHEF_DIALOGUE_H

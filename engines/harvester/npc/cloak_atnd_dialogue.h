...
#ifndef HARVESTER_NPC_CLOAK_ATND_DIALOGUE_H
#define HARVESTER_NPC_CLOAK_ATND_DIALOGUE_H

#include "harvester/npc/dialogue_handler.h"

namespace Harvester {

class CloakAtndDialogueHandler : public NpcDialogueHandler {
public:
...
#endif // HARVESTER_NPC_CLOAK_ATND_DIALOGUE_H

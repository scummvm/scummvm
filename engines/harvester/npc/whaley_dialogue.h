...
#ifndef HARVESTER_NPC_WHALEY_DIALOGUE_H
#define HARVESTER_NPC_WHALEY_DIALOGUE_H
...
public:
	...
	void resetState() override { _state = WhaleyRoomDialogueState(); }
	void syncState(Common::Serializer &s) override {
		...
		syncDialogueBool(s, _state.whaleyHerrillPhotoFollowupShown);
...
private:
	WhaleyRoomDialogueState _state;
};

} // End of namespace Harvester

#endif // HARVESTER_NPC_WHALEY_DIALOGUE_H

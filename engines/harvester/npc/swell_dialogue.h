...
#ifndef HARVESTER_NPC_SWELL_DIALOGUE_H
#define HARVESTER_NPC_SWELL_DIALOGUE_H

#include "harvester/npc/dialogue_handler.h"

namespace Harvester {

class SwellDialogueHandler : public NpcDialogueHandler {
public:
...
private:
	SwellRoomDialogueState _state;
};

} // End of namespace Harvester

#endif // HARVESTER_NPC_SWELL_DIALOGUE_H

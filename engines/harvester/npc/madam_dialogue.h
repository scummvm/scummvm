...
#ifndef HARVESTER_NPC_MADAM_DIALOGUE_H
#define HARVESTER_NPC_MADAM_DIALOGUE_H

#include "harvester/npc/dialogue_handler.h"

namespace Harvester {

class MadamDialogueHandler : public NpcDialogueHandler {
public:
...
#endif // HARVESTER_NPC_MADAM_DIALOGUE_H

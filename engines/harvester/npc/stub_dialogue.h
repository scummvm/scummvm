...
#ifndef HARVESTER_NPC_STUB_DIALOGUE_H
#define HARVESTER_NPC_STUB_DIALOGUE_H
...
class StubNpcDialogueHandler : public NpcDialogueHandler {
public:
	explicit StubNpcDialogueHandler(const char *npcName);
...
#endif // HARVESTER_NPC_STUB_DIALOGUE_H

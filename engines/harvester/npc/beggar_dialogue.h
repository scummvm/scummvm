...
#ifndef HARVESTER_NPC_BEGGAR_DIALOGUE_H
#define HARVESTER_NPC_BEGGAR_DIALOGUE_H

#include "harvester/npc/dialogue_handler.h"

namespace Harvester {

class BeggarDialogueHandler : public NpcDialogueHandler {
public:
...
#endif // HARVESTER_NPC_BEGGAR_DIALOGUE_H

...
#ifndef HARVESTER_NPC_VET_DIALOGUE_H
#define HARVESTER_NPC_VET_DIALOGUE_H

#include "harvester/npc/dialogue_handler.h"

namespace Harvester {

class VetDialogueHandler : public NpcDialogueHandler {
public:
...
#endif // HARVESTER_NPC_VET_DIALOGUE_H

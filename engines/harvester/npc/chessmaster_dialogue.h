...
#ifndef HARVESTER_NPC_CHESSMASTER_DIALOGUE_H
#define HARVESTER_NPC_CHESSMASTER_DIALOGUE_H

#include "harvester/npc/dialogue_handler.h"

namespace Harvester {

class ChessmasterDialogueHandler : public NpcDialogueHandler {
public:
...
#endif // HARVESTER_NPC_CHESSMASTER_DIALOGUE_H

...
#ifndef HARVESTER_NPC_MAINT_MAN_DIALOGUE_H
#define HARVESTER_NPC_MAINT_MAN_DIALOGUE_H

#include "harvester/npc/dialogue_handler.h"

namespace Harvester {

class MaintManDialogueHandler : public NpcDialogueHandler {
public:
...
#endif // HARVESTER_NPC_MAINT_MAN_DIALOGUE_H

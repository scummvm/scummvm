...
#ifndef HARVESTER_NPC_DARK_WOMAN_DIALOGUE_H
#define HARVESTER_NPC_DARK_WOMAN_DIALOGUE_H

#include "harvester/npc/dialogue_handler.h"

namespace Harvester {

class DarkWomanDialogueHandler : public NpcDialogueHandler {
public:
	struct DarkWomanRoomDialogueState {
		bool talkStatePending = true;
	};

	bool matchesNpc(const Common::String &npcName) const override;
	void resetState() override { _state = DarkWomanRoomDialogueState(); }
...
private:
	DarkWomanRoomDialogueState _state;
};

} // End of namespace Harvester

#endif // HARVESTER_NPC_DARK_WOMAN_DIALOGUE_H

...
#ifndef HARVESTER_NPC_SPARKY_DIALOGUE_H
#define HARVESTER_NPC_SPARKY_DIALOGUE_H

#include "harvester/npc/dialogue_handler.h"

namespace Harvester {

class SparkyDialogueHandler : public NpcDialogueHandler {
public:
	struct SparkyRoomDialogueState {
		bool introPending = true;
		bool returnVisitPending = false;
		int returnVisitDayIndex = -1;
...
private:
	SparkyRoomDialogueState _state;
};

} // End of namespace Harvester

#endif // HARVESTER_NPC_SPARKY_DIALOGUE_H

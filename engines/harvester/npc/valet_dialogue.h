...
#ifndef HARVESTER_NPC_VALET_DIALOGUE_H
#define HARVESTER_NPC_VALET_DIALOGUE_H

#include "harvester/npc/dialogue_handler.h"

namespace Harvester {

class ValetDialogueHandler : public NpcDialogueHandler {
public:
...
#endif // HARVESTER_NPC_VALET_DIALOGUE_H

...
public:
	 ...
	 * @param voiceText		Whether to voice the string with TTS
	 ...
	 */
	const char *writeString(const Common::String &s, const Common::Rect &clipRect, bool voiceText = true, Common::String *ttsMessage = nullptr);
	bool isSpace(char c);
	/**

...
enum ButtonShiftFlags { BTNSHIFT_LEFT = 0,
	                      BTNSHIFT_RIGHT = 3,
	                      BTNSHIFT_MIDDLE = 4 };
...
enum CursorType {
	...
	OBJECT_STASIS_BOX = 2,
	OBJECT_INFODISK = 3,
	OBJECT_STASIS_NEGATOR = 4,
	OBJECT_KEY_DEVICE = 5,
	OBJECT_MEDKIT = 6,
	OBJECT_LADDER = 7,
	OBJECT_ROPE = 8,
	OBJECT_KEY = 9,
	OBJECT_TRANSLATOR = 10,
	OBJECT_ALE = 11,
	OBJECT_PAPER = 12,
	OBJECT_WALDOS = 13,
	OBJECT_STASIS_BOX2 = 14,
	OBJECT_RING = 15,
	OBJECT_CLOAK = 16,
	OBJECT_TUNIC = 17,
	OBJECT_CANDLE = 18,
	...
	INV_FOREST_RAP = 8,
	INV_GREEN_ID = 9,
	INV_BASEBALL_CARD = 10,
	INV_BOOKING_GREEN = 11,
	INV_FLARE = 12,
	INV_COBB_RAP = 13,
	INV_22_BULLET = 14,
	INV_AUTO_RIFLE = 15,
	...
	INV_TYRONE_ID = 18,
	INV_22_SNUB = 19,
	INV_BOOKING_FRANKIE = 21,
	INV_BOOKING_GANG = 22,
	INV_FBI_TELETYPE = 23,
	INV_DA_NOTE = 24,
	INV_PRINT_OUT = 25,
	INV_WAREHOUSE_KEYS = 26,
	INV_CENTER_PUNCH = 27,
	INV_TRANQ_GUN = 28,
	INV_HOOK = 29,
	INV_RAGS = 30,
	...
	INV_GRENADES = 56,
	INV_YELLOW_CORD = 57,
	INV_HALF_YELLOW_CORD = 58,
	INV_BLACK_CORD = 59,
	INV_HALF_BLACK_CORD = 61,
	INV_WARRANT = 62,
	INV_JACKET = 63,
	INV_GREENS_KNIFE = 64,
	INV_DOG_WHISTLE = 65,
	...
	R2_CABLE_HARNESS = 8,
	R2_COM_SCANNER = 9,
	R2_SPENT_POWER_CAPSULE = 10,
	R2_CHARGED_POWER_CAPSULE = 11,
	R2_AEROSOL = 12,
	R2_REMOTE_CONTROL = 13,
	R2_OPTICAL_FIBER = 14,
	R2_CLAMP = 15,
	R2_ATTRACTOR_CABLE_HARNESS = 16,
	R2_FUEL_CELL = 17,
	R2_GYROSCOPE = 18,
	R2_AIRBAG = 19,
	R2_REBREATHER_TANK = 20,
	R2_RESERVE_REBREATHER_TANK = 21,
	R2_GUIDANCE_MODULE = 22,
	R2_THRUSTER_VALVE = 23,
	R2_BALLOON_BACKPACK = 24,
	R2_RADAR_MECHANISM = 25,
	R2_JOYSTICK = 26,
	R2_IGNITOR = 27,
	R2_DIAGNOSTICS_DISPLAY = 28,
	R2_GLASS_DOME = 29,
	R2_WICK_LAMP = 30,
	R2_SCRITH_KEY = 31,
	R2_TANNER_MASK = 32,
	R2_PURE_GRAIN_ALCOHOL = 33,
	R2_SAPPHIRE_BLUE = 34,
	R2_ANCIENT_SCROLLS = 35,
	R2_FLUTE = 36,
	R2_GUNPOWDER = 37,
	R2_NONAME = 38,
	R2_COM_SCANNER_2 = 39,
	R2_SUPERCONDUCTOR_WIRE = 40,
	R2_PILLOW = 41,
	R2_FOOD_TRAY = 42,
	R2_LASER_HACKSAW = 43,
	R2_PHOTON_STUNNER = 44,
	R2_BATTERY = 45,
	R2_SOAKED_FACEMASK = 46,
	R2_LIGHT_BULB = 47,
	R2_ALCOHOL_LAMP = 48,
	R2_ALCOHOL_LAMP_2 = 49,
	R2_ALCOHOL_LAMP_3 = 50,
	R2_BROKEN_DISPLAY = 51,
	R2_TOOLBOX = 52,
	R2_LAST_INVENT = 53,

	// Ringworld 2 cursors
	R2CURSORS_START = 0x8000,
	EXITCURSOR_N = 0x8007,
	EXITCURSOR_S = 0x8008,
	EXITCURSOR_W = 0x8009,
	EXITCURSOR_E = 0x800A,
	EXITCURSOR_LEFT_HAND = 0x800B,
	CURSOR_INVALID = 0x800C,
	EXITCURSOR_NE = 0x800D,
	EXITCURSOR_SE = 0x800E,
	EXITCURSOR_SW = 0x800F,
	EXITCURSOR_NW = 0x8010,
	SHADECURSOR_UP = 0x8011,
	SHADECURSOR_DOWN = 0x8012,
	SHADECURSOR_HAND = 0x8013,
	R2_CURSOR_20 = 0x8014,
	R2_CURSOR_21 = 0x8015,
	R2_CURSOR_22 = 0x8016,
	R2_CURSOR_23 = 0x8017,

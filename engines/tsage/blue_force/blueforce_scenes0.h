...
class Scene50: public SceneExt {
	...
	public:
		...
		virtual Common::String getClassName() override { return "Scene50_Tooltip"; }
	...
	public:
		...
		virtual Common::String getClassName() override { return "Scene50_Tooltip2"; }
		virtual void signal() override;
...
public:
	...
	virtual Common::String getClassName() override { return "Scene50"; }
	virtual void synchronize(Serializer &s) override;

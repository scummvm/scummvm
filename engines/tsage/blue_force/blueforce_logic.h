...
public:
	...
	virtual Common::String getClassName() override { return "AObjectArray"; }
	...
	virtual void remove() override { EventHandler::remove(); }
};
...
public:
	...
	virtual Common::String getClassName() override { return "Timer"; }
	virtual void synchronize(Serializer &s) override;
...
public:
	...
	virtual Common::String getClassName() override { return "TimerExt"; }
	virtual void synchronize(Serializer &s) override;
	virtual void remove() override;
	virtual void signal() override;
};
...
public:
	...
	virtual Common::String getClassName() override { return "SceneHotspotExt"; }
	virtual void synchronize(Serializer &s) override {
...
public:
	virtual Common::String getClassName() override { return "NamedObject"; }
	virtual void synchronize(Serializer &s) override;
...
public:
	...
	virtual Common::String getClassName() override { return "NamedObjectExt"; }
	virtual void synchronize(Serializer &s) override {
...
public:
	...
	virtual Common::String getClassName() override { return "NamedObject2"; }
	virtual void synchronize(Serializer &s) override {
		NamedObject::synchronize(s);
		if (s.getVersion() < 12) {
			int useless = 0;
...
public:
	...
	virtual Common::String getClassName() override { return "CountdownObject"; }
	virtual void synchronize(Serializer &s) override;
	virtual void dispatch() override;
};
...
public:
	...
	virtual Common::String getClassName() override { return "FollowerObject"; }
	virtual void synchronize(Serializer &s) override;
	virtual void remove() override;
	virtual void dispatch() override;
...
public:
	...
	virtual void process(Event &event) override;
	virtual void dispatch() override;
	virtual void loadScene(int sceneNum) override;
...
public:
	...
	virtual void playerAction(Event &event) override;
	virtual void processEnd(Event &event) override;
};
...
public:
	...
	virtual Common::String getClassName() override { return "BlueForceInvObjectList"; }
};
...
public:
	...
	virtual Common::String getClassName() override { return "SceneMessage"; }
	virtual void remove() override;
	virtual void signal() override;
	virtual void process(Event &event) override;
};
...
public:
	...
	virtual Common::String getClassName() override { return "BFIntroText"; }
	virtual void synchronize(Serializer &s) override;
	virtual void dispatch() override;
};

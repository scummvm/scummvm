...
class Scene910: public PalettedScene {
	...
	public:
		Object13 _object27;
		BlackPlug _object28;
		virtual Common::String getClassName() override { return "Scene910_object12"; }
		virtual void postInit(SceneObjectList *OwnerList = NULL) override;
		virtual void remove() override;
	};
	...
	public:
		virtual Common::String getClassName() override { return "Scene910_object29"; }
		virtual void postInit(SceneObjectList *OwnerList = NULL) override;
		virtual void remove() override;
	};
...
public:
	...
	virtual void process(Event &event) override;
	virtual void dispatch() override;
	virtual void checkGun() override;
	void openHiddenDoor();

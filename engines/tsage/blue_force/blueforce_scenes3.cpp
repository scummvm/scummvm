 ...
 *--------------------------------------------------------------------------*/
	...
	void Scene300::dispatch() {
		...
		if (!_action) {
			...
			if ((BF_GLOBALS._player._position.y < 59) && (BF_GLOBALS._player._position.x > 137) && (_sceneMode != 6308) && (_sceneMode != 7308)) {
				_sceneMode = 6308;
				BF_GLOBALS._player.disableControl();
 ...
 *--------------------------------------------------------------------------*/
	...
	bool Scene315::Barry::startAction(CursorType action, Event &event) {
		...
		case INV_22_SNUB:
			BF_GLOBALS._player.disableControl();
			if ((BF_GLOBALS.getFlag(fCuffedFrankie) && (BF_INVENTORY._bookingFrankie._sceneNumber == 0)) || (!BF_GLOBALS.getFlag(fCuffedFrankie) && (BF_INVENTORY._bookingGang._sceneNumber == 0))) {
				scene->_stripNumber = 3174;
				scene->setAction(&scene->_action1);
			} else {
 ...
 *--------------------------------------------------------------------------*/
	...
	void Scene330::postInit(SceneObjectList *OwnerList) {
		...
		if (BF_GLOBALS._sceneManager._previousScene == 50) {
			// Coming from map
			if ((BF_GLOBALS._driveFromScene == 340) || (BF_GLOBALS._driveFromScene == 342) || (BF_GLOBALS._driveFromScene == 330)) {
				if (BF_GLOBALS.getFlag(fWithLyle)) {
					_seqNumber = 3304;
				} else {
					_seqNumber = 3302;
				...
				if ((BF_GLOBALS._dayNumber == 1) && (BF_GLOBALS._bookmark >= bStartOfGame) && (BF_GLOBALS._bookmark < bCalledToDomesticViolence)) {
	...
	void Scene330::signal() {
		if ((BF_GLOBALS._driveFromScene == 330) || (BF_GLOBALS._driveFromScene == 340) || (BF_GLOBALS._driveFromScene == 342)) {
			// Leaving marina
			if ((BF_GLOBALS._dayNumber != 1) || (BF_GLOBALS._bookmark < bStartOfGame) || (BF_GLOBALS._bookmark >= bCalledToDomesticViolence))
 ...
 *--------------------------------------------------------------------------*/
	...
	void Scene340::postInit(SceneObjectList *OwnerList) {
		...
		default:
			_sound1.fadeSound(35);
			BF_GLOBALS._sound1.fadeSound((BF_GLOBALS._bookmark < bStartOfGame) || (BF_GLOBALS._bookmark > bCalledToDomesticViolence) ? 10 : 19);
			_seqNumber1 = 342;
			break;
		}
	...
	void Scene340::process(Event &event) {
		...
		if ((event.eventType == EVENT_BUTTON_DOWN) && (BF_GLOBALS._events.getCursor() == INV_COLT45) && BF_GLOBALS._player.contains(event.mousePos)) {
			BF_GLOBALS._player.disableControl();
			_sceneMode = 0;
 ...
 *--------------------------------------------------------------------------*/
	...
	void Scene350::postInit(SceneObjectList *OwnerList) {
		...
		default:
			...
			if ((BF_GLOBALS._dayNumber == 1) && (BF_GLOBALS._bookmark < bCalledToDomesticViolence) && BF_GLOBALS.getFlag(fBackupIn350)) {
				BF_GLOBALS._player.disableControl();
				_sceneMode = 0;
	...
	void Scene350::signal() {
		...
		case 1:
			...
			break;
		case 2:
			BF_GLOBALS._sceneManager.changeScene((BF_GLOBALS._dayNumber != 1) || (BF_GLOBALS._bookmark < bStartOfGame) || (BF_GLOBALS._bookmark >= bCalledToDomesticViolence) ? 342 : 340);
			break;
		case 3:
	...
	void Scene350::checkGun() {
		if ((BF_GLOBALS._dayNumber != 1) || (BF_GLOBALS._bookmark < bStartOfGame) || (BF_GLOBALS._bookmark >= bCalledToDomesticViolence) || BF_GLOBALS.getFlag(fRandomShot350)) {
 ...
 *--------------------------------------------------------------------------*/
	...
	bool Scene355::Item11::startAction(CursorType action, Event &event) {
		...
		switch (action) {
		case CURSOR_WALK:
			return (BF_GLOBALS._bookmark == bStartOfGame) || (BF_GLOBALS._bookmark == bCalledToDomesticViolence) || (BF_GLOBALS._bookmark == bArrestedGreen);
		case CURSOR_LOOK:
	...
	void Scene355::postInit(SceneObjectList *OwnerList) {
		...
		case 5:
			...
			if ((BF_INVENTORY.getObjectScene(INV_RAGS) == 0) && (BF_INVENTORY.getObjectScene(INV_JAR) == 0) && (BF_INVENTORY.getObjectScene(INV_FLARE) == 0)) {
				...
				if ((BF_GLOBALS._bookmark == bFinishedWGreen) && BF_GLOBALS._sceneObjects->contains(&_lyle) && !BF_GLOBALS.getFlag(iWasAmbushed)) {
	...
	void Scene355::process(Event &event) {
		if (BF_GLOBALS._dayNumber != 5) {
			...
			if ((_sceneMode != 2357) && (_sceneMode != 1357) && !BF_GLOBALS.getFlag(greenTaken) && (event.eventType == EVENT_BUTTON_DOWN) && (BF_GLOBALS._events.getCursor() == INV_COLT45)) {
 ...
 *--------------------------------------------------------------------------*/
	...
	void Scene360::process(Event &event) {
		...
		if ((event.eventType == EVENT_BUTTON_DOWN) && (BF_GLOBALS._events.getCursor() == INV_COLT45) && BF_GLOBALS._player.contains(event.mousePos) && !BF_GLOBALS.getFlag(greenTaken)) {
	...
	void Scene360::dispatch() {
		...
		if (!_action) {
			...
			if ((BF_GLOBALS._player._position.x <= 168) && !BF_GLOBALS.getFlag(greenTaken) && !BF_GLOBALS.getFlag(gunDrawn)) {
 ...
 *--------------------------------------------------------------------------*/
	...
	bool Scene370::Harrison::startAction(CursorType action, Event &event) {
		...
		case CURSOR_TALK:
			...
			} else if ((BF_INVENTORY.getObjectScene(INV_GREENS_KNIFE) == 1) || ((BF_INVENTORY.getObjectScene(INV_GREENS_GUN) == 1) && BF_GLOBALS._sceneObjects->contains(&scene->_laura))) {
				BF_GLOBALS._player.disableControl();
	...
	bool Scene370::Item6::startAction(CursorType action, Event &event) {
		...
		if (action == CURSOR_LOOK) {
			...
			if (BF_GLOBALS._sceneObjects->contains(&scene->_green) && (BF_INVENTORY.getObjectScene(INV_GREENS_GUN) != 370) && (BF_INVENTORY.getObjectScene(INV_HANDCUFFS) == 1)) {
				BF_GLOBALS._player.disableControl();
				scene->_green.setAction(NULL);
				scene->_sceneMode = 3703;
				scene->setAction(&scene->_sequenceManager, scene, 3703, &BF_GLOBALS._player, &scene->_green, &scene->_harrison, NULL);
	...
	void Scene370::dispatch() {
		...
		if ((BF_GLOBALS._player._position.x >= 316) && !BF_GLOBALS._sceneObjects->contains(&_laura) && !BF_GLOBALS._sceneObjects->contains(&_green)) {
 ...
 *--------------------------------------------------------------------------*/
	...
	bool Scene390::BookingForms::startAction(CursorType action, Event &event) {
		...
		case CURSOR_USE:
			...
			} else if (((BF_GLOBALS._bookmark < bLauraToParamedics) && BF_GLOBALS.getFlag(greenTaken)) || ((BF_GLOBALS._bookmark >= bStoppedFrankie) && !BF_GLOBALS.getFlag(frankInJail) && (BF_GLOBALS._dayNumber == 1))) {
				BF_GLOBALS._player.disableControl();
				++_flag;

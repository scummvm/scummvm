...
namespace BlueForce {
	...
	SpeakerJakeNoHead::SpeakerJakeNoHead()
	  : VisualSpeaker() {
		_color1 = 13;
	...
	SpeakerHarrison::SpeakerHarrison()
	  : VisualSpeaker() {
		_color1 = 32;
	...
	SpeakerJakeJacket::SpeakerJakeJacket()
	  : VisualSpeaker() {
		_color1 = 13;
		_color2 = 7;
	...
	SpeakerJakeUniform::SpeakerJakeUniform()
	  : VisualSpeaker() {
		_color1 = 13;
		_color2 = 7;
	...
	SpeakerJakeRadio::SpeakerJakeRadio()
	  : VisualSpeaker() {
		_color1 = 13;
		_color2 = 7;
	...
	SpeakerLauraHeld::SpeakerLauraHeld()
	  : VisualSpeaker() {
		_color1 = 97;
		_color2 = 105;
	...
	SpeakerGranText::SpeakerGranText()
	  : VisualSpeaker() {
		_color1 = 20;
		_color2 = 23;
	...
	SpeakerLyleText::SpeakerLyleText()
	  : VisualSpeaker() {
		_color1 = 29;
		_color2 = 89;

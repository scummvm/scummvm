...
class Scene560: public SceneExt {
	...
	public:
		...
		virtual Common::String getClassName() override { return "Scene560_SafeInset"; }
		virtual void postInit(SceneObjectList *OwnerList = NULL) override;
		virtual void remove() override;
		virtual void signal() override;
	...
	public:
		...
		virtual Common::String getClassName() override { return "Scene560_BoxInset"; }
		virtual void postInit(SceneObjectList *OwnerList = NULL) override;
		virtual void remove() override;
	};
	...
	public:
		virtual Common::String getClassName() override { return "Scene560_PicturePart"; }
		virtual bool startAction(CursorType action, Event &event) override;
	};
...
class Scene570: public SceneExt {
	...
	public:
		...
		PasswordEntry();
		virtual Common::String getClassName() override { return "Scene570_PasswordEntry"; }
		virtual void synchronize(Serializer &s) override;
		virtual void postInit(SceneObjectList *OwnerList = NULL) override;
		virtual void process(Event &event) override;
	};
	...
	public:
		...
		Icon();
		virtual Common::String getClassName() override { return "Scene570_Custom2"; }
		virtual void synchronize(Serializer &s) override;
		virtual void remove() override;
		virtual bool startAction(CursorType action, Event &event) override;

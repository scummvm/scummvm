...
class Scene100: public SceneExt {
	...
	public:
		virtual Common::String getClassName() override { return "BF100Text"; }
	...
	public:
		...
		virtual Common::String getClassName() override { return "BF100Action1"; }
...
class Scene115: public SceneExt {
	...
	public:
		virtual Common::String getClassName() override { return "Scene115_EventHandler1"; }
		virtual void dispatch() override;
	};

 ...
 *--------------------------------------------------------------------------*/
	...
	void Scene180::postInit(SceneObjectList *OwnerList) {
		...
		if (((BF_GLOBALS._bookmark == bLyleStoppedBy) && (BF_GLOBALS._dayNumber == 1)) || ((BF_GLOBALS._bookmark == bDroppedOffLyle) && (BF_GLOBALS._dayNumber == 3)) || ((BF_GLOBALS._bookmark == bDoneAtLyles) && (BF_GLOBALS._dayNumber == 4)))
			loadScene(999);
		else
			loadScene(1180);
		...
		} else if (((BF_GLOBALS._bookmark == bDroppedOffLyle) && (BF_GLOBALS._dayNumber == 3)) || ((BF_GLOBALS._bookmark == bDoneAtLyles) && (BF_GLOBALS._dayNumber == 4))) {
			_sceneMessage.setup(THE_NEXT_DAY);
			_sceneMode = 6;
			setAction(&_sceneMessage, this);
	...
	void Scene180::signal() {
		...
		case 7:
			...
			break;
		case 8:
			if (BF_GLOBALS.getFlag(fLeftTraceIn900) || BF_GLOBALS.getFlag(fGotPointsForSearchingDA) || BF_GLOBALS.getFlag(fLeftTraceIn920)) {
				BF_GLOBALS._sound1.fadeOut2(NULL);
 ...
 *--------------------------------------------------------------------------*/
	...
	void Scene190::postInit(SceneObjectList *OwnerList) {
		...
		if ((BF_GLOBALS._sceneManager._previousScene == 100) || (BF_GLOBALS._sceneManager._previousScene == 20)) {
			//		clearScreen();
		}

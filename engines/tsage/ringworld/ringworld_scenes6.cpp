 ...
 *--------------------------------------------------------------------------*/
	...
	void Scene5100::postInit(SceneObjectList *OwnerList) {
		...
		if (g_globals->getFlag(60) && (RING_INVENTORY._stasisBox._sceneNumber == 1) && g_globals->getFlag(107) && g_globals->getFlag(67)) {
			_hotspot8.postInit();
	...
	void Scene5100::dispatch() {
		...
		if (g_globals->getFlag(61) && !g_globals->getFlag(62) && ((g_globals->_player._position.x - _hotspot2._position.x) < 160) && (g_globals->_sceneManager._previousScene != 5200) && (_sceneMode != 5150)) {
			setAction(NULL);
			_sceneMode = 5150;

...
class Scene125: public SceneExt {
	...
	public:
		...
		Icon();
		virtual Common::String getClassName() override { return "Scene125_Icon"; }
		virtual void postInit(SceneObjectList *OwnerList = NULL) override;
...
public:
	int _x100, _y100;
public:
	virtual Common::String getClassName() override { return "Scene205_Star"; }
};
...
class Scene325: public SceneExt {
	...
	public:
		...
		Icon();
		virtual Common::String getClassName() override { return "Scene325_Icon"; }
		virtual void postInit(SceneObjectList *OwnerList = NULL) override;
		virtual void synchronize(Serializer &s) override;
		virtual void process(Event &event) override;
...
class Scene500: public SceneExt {
	...
	class PanelDialog: public SceneAreaObject {
		...
		public:
			Button();
			virtual Common::String getClassName() override { return "Scene500_Button"; }
			virtual void process(Event &event) override;
			virtual bool startAction(CursorType action, Event &event) override;
			virtual void synchronize(Serializer &s) override;
	...
	public:
		...
		virtual Common::String getClassName() override { return "Scene500_PanelWindow"; }
		virtual void remove() override;

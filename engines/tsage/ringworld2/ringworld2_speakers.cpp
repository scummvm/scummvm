...
namespace Ringworld2 {
	...
	void VisualSpeaker::dispatch() {
		...
		if ((R2_GLOBALS._speechSubtitles & SPEECH_VOICE) && (_numFrames == 2) && !R2_GLOBALS._playStream.isPlaying()) {
			_numFrames = 0;
	...
	void VisualSpeaker::setText(const Common::String &msg) {
		...
		if ((R2_GLOBALS._speechSubtitles & SPEECH_VOICE) && !(R2_GLOBALS._speechSubtitles & SPEECH_TEXT)) {
			_sceneText.hide();
		}
	...
	SpeakerPharisha::SpeakerPharisha()
	  : VisualSpeaker() {
	...
	SpeakerTealMode7::SpeakerTealMode7()
	  : SpeakerTeal() {
		_displayMode = 7;
	}
	...
	SpeakerDutyOfficer180::SpeakerDutyOfficer180()
	  : VisualSpeaker() {

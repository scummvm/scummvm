...
public:
	...
	virtual Common::String getClassName() override { return "InvObject"; }
...
public:
	...
	virtual Common::String getClassName() override { return "InvObjectList"; }
	virtual void synchronize(Serializer &s) override;
};
...
public:
	...
	virtual void synchronize(Serializer &s) override { s.syncAsSint16LE(_ctr); }
};
...
public:
	...
	virtual void synchronize(Serializer &s) override { SYNC_POINTER(_action); }
	virtual Common::String getClassName() override { return "EventHandler"; }
...
public:
	...
	virtual void synchronize(Serializer &s) override;
	virtual Common::String getClassName() override { return "Action"; }
...
public:
	...
	virtual void synchronize(Serializer &s) override;
	virtual Common::String getClassName() override { return "ObjectMover"; }
	virtual void remove() override;
	virtual void dispatch() override;
...
public:
	...
	virtual void synchronize(Serializer &s) override;
	virtual Common::String getClassName() override { return "ObjectMover2"; }
	virtual void dispatch() override;
	virtual void startMove(SceneObject *sceneObj, va_list va) override;
	virtual void endMove() override;
};

class ObjectMover3 : public ObjectMover2 {
public:
	virtual Common::String getClassName() override { return "ObjectMover3"; }
	virtual void dispatch() override;
	virtual void startMove(SceneObject *sceneObj, va_list va) override;
	virtual void endMove() override;
};
...
public:
	virtual Common::String getClassName() override { return "NpcMover"; }
	virtual void startMove(SceneObject *sceneObj, va_list va) override;
};
...
public:
	...
	virtual void synchronize(Serializer &s) override;
	virtual Common::String getClassName() override { return "PlayerMover"; }
	virtual void startMove(SceneObject *sceneObj, va_list va) override;
	virtual void endMove() override;
};
...
public:
	...
	virtual void synchronize(Serializer &s) override;
	virtual Common::String getClassName() override { return "PlayerMover2"; }
	virtual void dispatch() override;
	virtual void startMove(SceneObject *sceneObj, va_list va) override;
	virtual void endMove() override;
};
...
public:
	...
	virtual Common::String getClassName() override { return "PaletteModifierCached"; }
	virtual void synchronize(Serializer &s) override;
};
...
public:
	...
	virtual Common::String getClassName() override { return "PaletteRotation"; }
	virtual void synchronize(Serializer &s) override;
...
public:
	byte _palette[256 * 3];
public:
	virtual Common::String getClassName() override { return "PaletteFader"; }
	virtual void synchronize(Serializer &s) override;
	virtual void signal() override;
	virtual void remove() override;
	virtual void setPalette(ScenePalette *palette, int step) override;
};
...
public:
	...
	virtual void synchronize(Serializer &s) override;
	virtual Common::String getClassName() override { return "ScenePalette"; }
};
...
public:
	...
	virtual void synchronize(Serializer &s) override;
	virtual Common::String getClassName() override { return "SceneItem"; }
	virtual void remove() override;
...
public:
	...
	virtual Common::String getClassName() override { return "SceneItemExt"; }
	virtual void synchronize(Serializer &s) override {
...
public:
	...
	virtual Common::String getClassName() override { return "SceneHotspot"; }
...
public:
	...
	virtual void synchronize(Serializer &s) override;
	virtual Common::String getClassName() override { return "SceneObjectWrapper"; }
	virtual void remove() override;
	virtual void dispatch() override;
};
...
public:
	...
	virtual void synchronize(Serializer &s) override;
	virtual Common::String getClassName() override { return "SceneObject"; }
	virtual void postInit(SceneObjectList *OwnerList = NULL) override;
	virtual void remove() override;
	virtual void process(Event &event) override { event.handled = true; }
	virtual void dispatch() override;
...
public:
	virtual Common::String getClassName() override { return "BackgroundSceneObject"; }
	virtual void postInit(SceneObjectList *OwnerList = NULL) override;
...
public:
	...
	virtual void synchronize(Serializer &s) override;
	virtual Common::String getClassName() override { return "SceneText"; }
	virtual GfxSurface getFrame() override { return _textSurface; }
...
public:
	...
	virtual Common::String getClassName() override { return "Player"; }
	virtual void synchronize(Serializer &s) override;
	virtual void postInit(SceneObjectList *OwnerList = NULL) override;
	virtual void process(Event &event) override;
...
public:
	...
	virtual Common::String getClassName() override { return "SceneObjectList"; }
	virtual void synchronize(Serializer &s) override;
...
public:
	...
	virtual void synchronize(Serializer &s) override;
	virtual Common::String getClassName() override { return "GameHandler"; }
	virtual void postInit(SceneObjectList *OwnerList = NULL) override {}
	virtual void dispatch() override {}
};
...
public:
	...
	virtual Common::String getClassName() override { return "SceneHandler"; }
	virtual void postInit(SceneObjectList *OwnerList = NULL) override;
	virtual void process(Event &event) override;
	virtual void dispatch() override;

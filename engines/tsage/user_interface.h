...
public:
	...
	virtual Common::String getClassName() override { return "UIElement"; }
...
public:
	...
	UIInventorySlot();
	virtual Common::String getClassName() override { return "UIInventorySlot"; }
	virtual void synchronize(Serializer &s) override;
	virtual void process(Event &event) override;
};
...
public:
	...
	UIInventoryScroll();
	virtual Common::String getClassName() override { return "UIInventoryScroll"; }
	virtual void synchronize(Serializer &s) override;
	virtual void process(Event &event) override;
};
...
public:
	...
	UIElements();
	virtual Common::String getClassName() override { return "UIElements"; }
	virtual void synchronize(Serializer &s) override;
	virtual void postInit(SceneObjectList *OwnerList = NULL) override { error("Wrong init() called"); }
	virtual void process(Event &event) override;

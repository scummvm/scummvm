...
Common::KeymapArray EfhMetaEngine::initKeymaps(const char *target) const {
	...
	keymap[6] = interactionKeymap;
	keymap[7] = fightKeymap;
	keymap[8] = characterSelectionKeymap;
	keymap[9] = enemySelectionKeymap;
	keymap[10] = deathMenuKeymap;

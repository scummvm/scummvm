...
static const struct ADGameDescription SciGameDescriptions[] = {
	...
	{"chest", "", {
		...
		AD_LISTEND},
		Common::EN_ANY, Common::kPlatformDOS, ADGF_NO_FLAGS, GUIO8(GUIO_NOSUBTITLES, GUIO_NOMUSIC, GUIO_NOSPEECH, GUIO_NOSFX, GUIO_NOMIDI, GUIO_NOLAUNCHLOAD, GUIO_NOASPECT, GAMEOPTION_CHEST_BEHIND_THE_SHIELD)	},

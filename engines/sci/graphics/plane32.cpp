...
Plane::Plane(const Common::Rect &gameRect, PlanePictureCodes pictureId) : _creationId(_nextCreationId++),
...
Plane::Plane(reg_t object) : _creationId(_nextCreationId++),
                             _type(kPlaneTypeColored),
                             _priorityChanged(false),
                             _object(object),
                             _redrawAllCount(g_sci->_gfxFrameout->getScreenCount()),
...
Plane::Plane(const Plane &other) : _creationId(other._creationId),

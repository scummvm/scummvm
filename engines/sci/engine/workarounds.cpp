...
const SciWorkaroundEntry uninitializedReadWorkarounds[] = {
	...
	{ GID_CASTLEBRAIN,   320,   325,  0,               "word", "dispatchEvent",                   NULL,    -1, { WORKAROUND_FAKE,   0 } }, // clicking letters aggressively during the wordsearch puzzle causes attempt to read uninitialized read of at least temp 14 and 15 (bug #9783). Happens in at least version 1.0 and 1.1.

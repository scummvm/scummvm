...
public:
	MutableLoopAudioStream(Audio::RewindableAudioStream *stream, const bool loop_, const DisposeAfterUse::Flag dispose = DisposeAfterUse::YES) : _stream(stream, dispose),
	                                                                                                                                             _loop(loop_) {}
...
Audio32::Audio32(ResourceManager *resMan) : _resMan(resMan),

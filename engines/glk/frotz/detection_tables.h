...
#define ENTRY0(ID, VERSION, MD5, FILESIZE) \
	{ ID, VERSION, MD5, FILESIZE, Common::EN_ANY, NONE }
#define ENTRY1(ID, VERSION, MD5, FILESIZE, LANG) \
	{ ID, VERSION, MD5, FILESIZE, LANG, NONE }
#define ENTRYS(ID, VERSION, MD5, FILESIZE) \
	{ ID, VERSION, MD5, FILESIZE, Common::EN_ANY, GUIO3(GUIO_NOSPEECH, GUIO_NOMUSIC, GUIO_NOSUBTITLES) }

#define FROTZ_TABLE_END_MARKER \

...
namespace Hugo {
	...
	*/
	...
	void Hugo::PlayMusic() {
		...
		if (!strcmp(resname + 1, "CHN") || /* 4CHN, 6CHN, 8CHN */
		    ...
		    !strcmp(resname, "M.K.") || !strcmp(resname, "M!K!") || !strcmp(resname, "FLT4") || !strcmp(resname, "CD81") || !strcmp(resname, "OKTA") || !strcmp(resname, "    ")) {
			resource_type = MOD_R;
			goto Identified;
		}
   ...
   that length.  The new resource file format (designated by 'r') corrects this. */
		...
		if (!strcmp(filename, ""))
			strcpy(loaded_filename, resname);

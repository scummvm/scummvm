...
*/
	...
	void *os_banner_create(void *parent, int where, void *other, int wintype,
		...
		case OS_BANNER_TYPE_TEXT:
			gwintype = wintype_TextBuffer;
			break;
		case OS_BANNER_TYPE_TEXTGRID:
			gwintype = wintype_TextGrid;
			break;
		default:
			gwintype = wintype_TextGrid;
			break;
		...
		case OS_BANNER_ALIGN_TOP:
			gwinmeth = winmethod_Above;
			break;
		case OS_BANNER_ALIGN_BOTTOM:
			gwinmeth = winmethod_Below;
			break;
		case OS_BANNER_ALIGN_LEFT:
			gwinmeth = winmethod_Left;
			break;
		case OS_BANNER_ALIGN_RIGHT:
			gwinmeth = winmethod_Right;
			break;
		default:
			gwinmeth = winmethod_Above;
			break;
		...
		case OS_BANNER_SIZE_PCT:
			gwinmeth |= winmethod_Proportional;
			break;
		case OS_BANNER_SIZE_ABS:
			gwinmeth |= winmethod_Fixed;
			break;
		default:
			gwinmeth |= winmethod_Fixed;
			break;
	...
	void os_banner_set_size(void *banner_handle, int siz, int siz_units, int is_advisory) {
		...
		gwinmeth = banner->method & (winmethod_Above | winmethod_Below | winmethod_Left | winmethod_Right);

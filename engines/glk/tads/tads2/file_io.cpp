...
#define fioisrsc(filbuf, refnam) \
	(((filbuf)[0] == strlen(refnam)) && !memcmp(filbuf + 1, refnam, (size_t)((filbuf)[0])))
 ...
 */
     ...
     */
			...
			setupctx->fiolcxflg = *flagp = osrp2(buf + sizeof(FIOFILHDR) + sizeof(FIOVSNHDR));

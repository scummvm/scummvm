...
const PlainGameDescriptor ADRIFT_GAME_LIST[] = {
	...
	// English Games
	{ "ad4-1sttime", "1st Time" },
	{ "3monkeys", "Three Monkeys, One Cage" },
	{ "ad3-akarisstory", "A Day In The Life 3: Akari's Story" },
	{ "ad4-adriftorama", "ADRIFT-O-RAMA" },
	{ "ad4-adriftmasparty", "ADRIFTMAS Party" },
	{ "ad3-bobbobsly", "Adventures of Bob Bobsly" },
	{ "ad3-wonderwombat", "Adventures of Thumper - Wonder Wombat" },
	{ "ad4-adventure350", "Adventure" },
	{ "ad4-adventurestrikes", "Adventure Strikes When You Least Expect It" },
	{ "ad4-aegis", "Aegis" },
	{ "ad3-akron", "Akron" },
	{ "ad4-albertislost", "Albert is Lost!: An Adventure in Real Life" },
	{ "ad3-albridgemanor", "Albridge Manor" },
	{ "ad3-alexis", "Alexis:Dalskee" },
	{ "ad4-alias", "Alias: Undercover Agent" },
	{ "ad4-alicesrestaurant", "Alice's Restaurant Anti-Massacree Adventure" },
	{ "ad4-allhallowseve", "All Hallows Eve" },
	{ "ad4-amnesiakid", "Amnesia Kid" },
	{ "ad4-amyhormones", "Amy And The Raging Hormones" },
	{ "ad3-anotherfriday", "Another Friday Party" },
	{ "ad4-apokalupsis", "Apokalupsis" },
	{ "ad3-archiesbirthday", "Archie's Birthday - Chapter 1: Reggie's Gift" },
	{ "ad4-ascot", "The Ascot" },
	{ "ad4-asdfa", "A.S.D.F.A.A Short Damn Fantasy Adventure" },
	{ "ad4-asteroidaftermath", "Asteroid Aftermath" },
	{ "ad3-asylum", "Asylum" },
	...
	{ "ad3-driftingin", "Adrift: Drifting In..." },
	...
	{ "ad3-praxis", "...from the Files of Sigmund Praxis, Guerrilla Therapist" },
	...
	{ "sommeril", "Sommeril" },
	{ "sophia", "Sophia" },
	{ "ad4-postmanmatt", "The Adventures of Postman Matt (and his black and white cat)" },
	{ "ad4-spaceboy", "The Adventures of Space Boy! Volume I" },
	{ "ad4-spaceboy2", "The Adventures of Space Boy! Volume II" },
	{ "stowaway", "Stowaway" },
	{ "superheroday", "A Day In The Life Of A Super Hero" },
	{ "takeone", "Take One" },
	{ "target", "Target" },
	{ "ad3-alchemist", "The Alchemist" },
	{ "ad4-amazingtvcaper", "The Amazing TV Caper" },
	{ "ad4-amazinggriswold", "The Amazing Uncle Griswold" },
	{ "ad4-angeldevilhuman", "The Angel, the Devil and the Human" },
	{ "ad3-averagelife", "The Average Life" },
	...
	{ "ad4-1hgdemonhunter", "Apprentice of the Demonhunter" },
	...
	{ "ad4-theadriftproject", "The ADRIFT Project - Classified" },
	...
	{ "ad4-ahc3minutes", "3 Minutes to Live" },
...
const GlkDetectionEntry ADRIFT_GAMES[] = {
	// English Games
	DT_ENTRY0("ad4-1sttime", "2ee60ee51dc1a2c672df78a3c91614bc", 29101),
	DT_ENTRY0("3monkeys", "dec34c282511b1eadfe231dbbb49f625", 79286),
	DT_ENTRY0("ad3-akarisstory", "71a1137269234ee0941e54965c951c73", 31094),
	DT_ENTRY0("ad4-adriftorama", "db66d96e2cbd397fc668abcd32d59aeb", 46432),
	DT_ENTRY0("ad4-adriftmasparty", "d06febddd1f136bb7ef59713c31f2066", 3034048),
	DT_ENTRY0("ad3-bobbobsly", "de60977da0c1ddbcc467d2fedd9751bd", 10310),
	DT_ENTRY0("ad3-wonderwombat", "d050a635699242cbfd383f7e16fe3a63", 107200),
	DT_ENTRY0("ad4-aegis", "8726e90b50bdc92967f944a582daff2c", 45755),
	DT_ENTRY1("ad4-adventure350", "1.0.2", "1d50a4f82fda17e06a178fd634ced8b4", 45400),
	DT_ENTRY0("ad4-adventurestrikes", "f5e18081fd6ec4955ed0665aee8580de", 3770),
	DT_ENTRY1("ad3-akron", "0.1", "2461ceeef3ef1eac15a2051a549b4402", 22258),
	DT_ENTRY0("ad3-albridgemanor", "268003e454c4ade042d593af8397a490", 31353),
	DT_ENTRY1("ad4-albertislost", "1.1", "3667644307d9e9683eb88b1fd4f90562", 279251),
	DT_ENTRY0("ad4-ascot", "01ed200d7aec907aa84ad4007c5b296b", 24494),
	DT_ENTRY0("ad3-alexis", "d1adc72ae5f19e18e386ec1a3cab7212", 87229),
	DT_ENTRY0("ad4-alias", "14176ef2af8207d54b6c4ae6a8938046", 9213),
	DT_ENTRY0("ad4-alicesrestaurant", "442cc382e180eabe878f69c1d8470374", 18765),
	DT_ENTRY0("ad4-allhallowseve", "941fb55e949f3272a089ea69a6ddba8d", 6707),
	DT_ENTRY0("ad4-amnesiakid", "fa5998636923d0319b7a62ac685a49b7", 10268),
	DT_ENTRY1("ad4-amyhormones", "1.1", "be11b8af8fb1885c684f34962a32a887", 23957),
	DT_ENTRY1("ad3-anotherfriday", "1.0", "218d6543f45a7cd921cb7c2187f9600e", 79881),
	DT_ENTRY0("ad4-apokalupsis", "c3e90bfb8cea957cebbf306add17cd3e", 19822),
	DT_ENTRY0("ad3-archiesbirthday", "fe52abda2b95ef53b23fb0fbaa7cbae7", 284319),
	DT_ENTRY0("ad4-asdfa", "06173b47b4e88c0a494d2263666ad375", 27733),
	DT_ENTRY1("ad4-asteroidaftermath", "1.00", "d555b913fd85319b745a83efeb9a0601", 5792),
	DT_ENTRY0("ad3-asylum", "5d03f29f530701db4dc096b9e7307ae4", 44503),
	...
	DT_ENTRY0("ad3-driftingin", "7ee4b9d8cc9547b22a3fac8e34a70a03", 34637),
	...
	DT_ENTRY0("ad3-praxis", "da2b19b01df82d147f214a737a641a52", 9977),
	...
	DT_ENTRY0("ad4-postmanmatt", "bbdd2a34e831964eafb5c06562429c74", 6668),
	DT_ENTRY1("ad4-spaceboy2", "1.0", "62f9b0e0840ee70cc311108d24cd7c83", 12712),
	...
	DT_ENTRY0("ad3-alchemist", "c22b910b9c9703dd190c6bce71532bae", 165297),
	DT_ENTRY0("ad4-amazingtvcaper", "f456b996a5dcb6037e75196406e3c86d", 6187),
	DT_ENTRY0("ad4-amazinggriswold", "a044a6c6117b98aaa81c4083a2144946", 18992),
	DT_ENTRY0("ad4-angeldevilhuman", "a4508d6fbbd89ead3e72e961fe288427", 4429),
	DT_ENTRY0("ad3-averagelife", "bc4d0db4a6b95136bdb92aae623b7786", 11350),
	...
	DT_ENTRY0("ad4-3hgtheamulet", "7c08e1f03763ad757dc39f5df37a28b7", 5585),
	...
	DT_ENTRY0("ad4-1hgdemonhunter", "ca37aaf35fb15a40a7f5f8caa1475112", 4169),
	...
	DT_ENTRY0("ad4-1hgarghsgreatescape", "0de27ef52495de415637d78e393c612f", 3608),
	DT_ENTRY0("1hgshreddem", "426885b0a8a9aade134307fad1693512", 1209),
	DT_ENTRY0("ad4-1hgagent4f", "407cc79b128aefdae4fdabb4d7a661e4", 3703),
	...
	DT_ENTRY0("ad4-1hgadriftmaze", "017d681d45402c2d75ae70c28d2b467f", 2224),
	...
	DT_ENTRY0("ad4-theadriftproject", "18a4db8af27fd98751504ee3e45089e3", 231594),
	...
	// ADRIFT Hourglass Comp 2006
	DT_ENTRY0("ad4-ahc3minutes", "0313370bb74005525ec96580f146d286", 13232),

...
public:
	...
	virtual void playStream(
	    ...
	    AudioStream *stream,
	    int id = -1,
	    uint8 volume = kMaxChannelVolume,
	    sint8 balance = 0,
	 ...
	 */
	virtual void setChannelVolume(SoundHandle handle, uint8 volume) = 0;
	 ...
	 */
	virtual void setChannelBalance(SoundHandle handle, sint8 balance) = 0;
	 ...
	 */
	virtual uint32 getOutputRate() const = 0;
};

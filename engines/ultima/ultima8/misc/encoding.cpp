...
JISX0213 to unicode tables are taken from the GNU LIBICONV Library,
...
// Convert Shift_JIS to a JISX0208 (or maybe JISX0213?) row/column pair.
...
static inline bool shiftjis_to_JISX(uint16 sjis, uint8 &jr, uint8 &jc) {
	...
	// Step 3: decode Shift_JIS to JIS X 0208 codepoints
...
uint16 shiftjis_to_ultima8(uint16 sjis) {
	...
	uint8 jr, jc;
	if (!shiftjis_to_JISX(sjis, jr, jc))
		return 0;

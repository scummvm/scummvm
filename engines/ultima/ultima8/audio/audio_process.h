...
public:
	struct SampleInfo {
		...
		SampleInfo(int32 s, int32 p, ObjId o, int32 l, int32 c, uint32 ps, uint16 v, int16 lv, int16 rv) : _sfxNum(s), _priority(p), _objId(o), _loops(l), _channel(c),
		...
		SampleInfo(const Std::string &b, int32 shpnum, ObjId o, int32 c,
		           uint32 s, uint32 e, uint32 ps, uint16 v, int16 lv, int16 rv) : _sfxNum(-1), _priority(shpnum), _objId(o), _loops(0), _channel(c), _barked(b),

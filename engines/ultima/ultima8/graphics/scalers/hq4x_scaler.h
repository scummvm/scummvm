...
#ifndef ULTIMA8_GRAPHICS_SCALERS_HQ4XSCALER_H
#define ULTIMA8_GRAPHICS_SCALERS_HQ4XSCALER_H
...
class hq4xScaler : public Scaler {
public:
	hq4xScaler();
...
extern const hq4xScaler hq4x_scaler;

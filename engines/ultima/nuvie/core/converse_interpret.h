...
public:
	...
	virtual bool is_valop(converse_value check) {
		return (((check == 0x81) || (check == 0x82) || (check == 0x83) || (check == 0x84) || (check == 0x85) || (check == 0x86) || (check == 0x90) || (check == 0x91) || (check == 0x92) || (check == 0x93) || (check == 0x94) || (check == 0x95) || (check == 0x9a) || (check == 0x9b) || (check == 0x9d) || (check == 0x9f) || (check == 0xa0) || (check == 0xa7) || (check == 0xab) || (check == 0xb2) || (check == 0xb3) || (check == 0xb4) || (check == 0xb7) || (check == 0xbb) || (check == 0xc6) || (check == 0xc7) || (check == 0xca) || (check == 0xcc) || (check == 0xd7) || (check == 0xda) || (check == 0xdc) || (check == 0xdd) || (check == 0xe0) || (check == 0xe1) || (check == 0xe2) || (check == 0xe3) || (check == 0xe4)));
	}

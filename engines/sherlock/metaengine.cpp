...
Common::KeymapArray SherlockMetaEngine::initKeymaps(const char *target) const {
	...
	if (ConfMan.get("gameid", target) == "scalpel") {
		...
		Keymap *scalpelQuitDialogKeymap = new Keymap(Keymap::kKeymapTypeGame, "scalpel-quit", _("Quit dialog keymappings"));
		...
		act = new Action("EXIT", _("Exit darts minigame"));
		...
		act->setCustomEngineActionEvent(kActionScalpelJournalUp);
		act->addDefaultInputMapping(getKey(kFixedText_Journal_Up, curLanguageEntry, target));
		act->addDefaultInputMapping("JOY_UP");
		scalpelJournalKeymap->addAction(act);

		act = new Action("DOWN", _("Scroll down"));
		act->setCustomEngineActionEvent(kActionScalpelJournalDown);
		act->addDefaultInputMapping(getKey(kFixedText_Journal_Down, curLanguageEntry, target));
		...
		act = new Action("UP", _("Scroll up"));
		act->setCustomEngineActionEvent(kActionScalpelTalkUp);
		act->addDefaultInputMapping(getKey(kFixedText_Window_Up, curLanguageEntry, target));
		act->addDefaultInputMapping("JOY_UP");
		scalpelTalkKeymap->addAction(act);

		act = new Action("DOWN", _("Scroll down"));
		act->setCustomEngineActionEvent(kActionScalpelTalkDown);
		...
		act = new Action("UP", _("Scroll up"));
		act->setCustomEngineActionEvent(kActionScalpelFilesUp);
		act->addDefaultInputMapping(getKey(kFixedText_LoadSave_Up, curLanguageEntry, target));
		act->addDefaultInputMapping("JOY_UP");
		scalpelFilesKeymap->addAction(act);

		act = new Action("DOWN", _("Scroll down"));
		act->setCustomEngineActionEvent(kActionScalpelFilesDown);
		act->addDefaultInputMapping(getKey(kFixedText_LoadSave_Down, curLanguageEntry, target));
		act->addDefaultInputMapping("JOY_DOWN");
		scalpelFilesKeymap->addAction(act);
		...
		String fileLabel[9];
		// I18N: (Game: The Lost Files of Sherlock Holmes: The Case of the Serrated Scalpel) This is the prefix for save game slots, followed by a number (1-9)
		String fileLabelPrefix = _("Save game slot");

		for (int i = 0; i < 9; ++i) {
			fileLabel[i] = fileLabelPrefix + String::format(" %d", i + 1);

			act = new Action(fileIds[i], fileLabel[i]);
		...
		Keymap *tattooVerbMenuKeymap = new Keymap(Keymap::kKeymapTypeGame, "tattoo-verb-menu", _("Verb menu keymappings"));
		...
		act = new Action("EXIT", _("Exit journal"));
		act->setCustomEngineActionEvent(kActionTattooJournalExit);
		act->addDefaultInputMapping("ESCAPE");
		act->addDefaultInputMapping("JOY_Y");
		tattooJournalKeymap->addAction(act);
		...
		act = new Action("EXIT", _("Exit search"));
		act->setCustomEngineActionEvent(kActionTattooJournalSearchExit);
		act->addDefaultInputMapping("ESCAPE");
		act->addDefaultInputMapping("JOY_Y");
		tattooJournalSearchKeymap->addAction(act);
		...
		act = new Action("GOSTART", _("Go to start of name"));
		...
		act = new Action("GOEND", _("Go to end of name"));
		...
		act = new Action("EXIT", _("Exit"));
		act->setCustomEngineActionEvent(kActionTattooFilesNameExit);
		act->addDefaultInputMapping("ESCAPE");
		act->addDefaultInputMapping("JOY_Y");
		tattooFilesNameKeymap->addAction(act);
		...
		act = new Action("EXIT", _("Exit options menu"));
		act->setCustomEngineActionEvent(kActionTattooOptionsExit);
		act->addDefaultInputMapping("ESCAPE");
		act->addDefaultInputMapping("JOY_Y");
		...
		act = new Action("GOEND", _("Go to end of password"));
		...
		act = new Action("EXIT", _("Exit talk window"));
		act->setCustomEngineActionEvent(kActionTattooTalkExit);
		act->addDefaultInputMapping("ESCAPE");
		act->addDefaultInputMapping("JOY_Y");
		tattooTalkKeymap->addAction(act);

		act = new Action("EXIT", _("Exit verb menu"));
		act->setCustomEngineActionEvent(kActionTattooVerbMenuExit);
		act->addDefaultInputMapping("ESCAPE");
		act->addDefaultInputMapping("JOY_Y");
		tattooVerbMenuKeymap->addAction(act);
		...
		keymaps.push_back(tattooVerbMenuKeymap);
		...
		tattooVerbMenuKeymap->setEnabled(false);
	}

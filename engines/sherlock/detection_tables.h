...
static const SherlockGameDescription gameDescriptions[] = {
	{
		...
		// The HitSquad CD version has the same MD5
		{
			...
			ADGF_NO_FLAGS,
#ifdef USE_TTS
			GUIO8(GUIO_NOSPEECH, GAMEOPTION_ORIGINAL_SAVES, GAMEOPTION_FADE_STYLE,
                                GAMEOPTION_HELP_STYLE, GAMEOPTION_PORTRAITS_ON, GAMEOPTION_WINDOW_STYLE, 
				GAMEOPTION_TTS_NARRATOR, GAMEOPTION_TALKIE_MODE)
#else

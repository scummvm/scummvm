...
const char *_text[][501] = {
{
	...
	"...HE IS PALE, HE HAS FANGS AND WEARS A TOUPEèØÅØ  AND HE SURE IS DRASCULA!",
...
},
{
	...
	"Bueno, no",
	"Esta sellada con tablones. La iglesia debe llevar abandonada varios a\201Å§os",
	"Si no la he abierto",
	...
	"\255VAYA, ME TENGO QUE CORTAR LAS U\201\245AS!",
	...
	"SON UNAS EXTRA\201\245AS HOJAS. DEBEN DE HABERLAS TRAIDO DE SUDAMERICA, O POR AHI",
	...
	"PERO ME PARECE A MI QUE MA\201\245ANA TEMPRANITO ME VUELVO CON MI MAMA",
	...
	"O\201ÅßME\201ÅßPONES\201ÅßUN\201ÅßCUBATA\201ÅßO\201ÅßME\201ÅßPONGO\201ÅßA\201ÅßTOCAR\201ÅßEL\201ÅßPIANO",
	...
	"YA\201ÅßTENGO\201ÅßTODOS\201ÅßLOS\201ÅßINGREDIENTES\201ÅßDE\201ÅßESA\201ÅßPOCION",
	...
	"PARECE QUE SE QUEDO ATASCADO EN LA BA\201\245ERA Y DECIDIO PONER UN BAR",
	...
	"NINGUN ANIMAL DA\201\245ADO EN LA PRODUCCION DE ESTE JUEGO",
}
};
...
},
{
	...
	"\255A CALLAR! MA\201\245ANA IRE A POR OTRO CEREBRO Y REPETIREMOS EL EXPERIMENTO ",
	...
	"ESO YA LO VEREMOS...",
	"BUENO, A VER SI ES VERDAD. IGOR, TRAE EL COMPACT DISC DE U\201\245AS ARRASCANDO UNA PIZARRA",
	"ESO NI SO\201\245ARLO. LA CHICA SE QUEDA CONMIGO, Y TU TE QUEDAS AHI HASTA QUE EL PENDULO TE CORTE EL RODAJITAS. JA, JA, JA",
...
},
{
	...
	"DESDE QUE LE DERROTO DRASCULA SE HA APARTADO A UNA CABA\201\245A EN LAS AFUERAS DEL PUEBLO",
...
},
{
	...
	"OH JOHNY, CARI\201\245O, MENOS MAL QUE HAS VENIDO. ESE DESALMADO DE DRASCULA ME HA ATADO A LA CAMA Y LUEGO SE HA IDO ABAJO A VER EL PARTIDO",
	...
	"ESPERA QUE VOY A MIRAR... NO CARI\201\245O, LO SIENTO",
	"TOMA...",
	"\"QUERIDO JOHNY:",
...
},
{
	...
	"PUES VERA, SE\201\245OR. YO ERA EL BORRACHO DEL PUEBLO, DIGNO SUCESOR DE UNA FAMILIA DE ILUSTRES BORRACHUZOS, Y UNA NOCHE DRASCULA ME SECUESTRO PARA ROBARME LOS ORGANOS",
	...
	"PUES LA VERDAD ES QUE NO TENGO MUCHA GANA, PERO MUCHAS GRACIAS DE TODAS MANERAS, SE\201\245OR",
	"SI, TU MISMO",
	...
	"\250Y NO LES DA VERGèØÅ∫ENZA SALIR Y QUE LOS VEA TODO EL MUNDO?",
...
},
{
	...
	"AH, POR CIERTO, TOME LAS LLAVES DE LA SALA DE ESTAR Y ASI NO ME MOLESTA MA\201\245ANA TEMPRANO SI QUIERE VER LOS DIBUJOS",
...
},
{
	...
	"VEAMOS. \250DONDE HE PUESTO EL DISCO ESTE DE \"U\201\245AS ARRASCANDO UNA PIZARRA\"?",
	"MUY BIEN. VAMOS ALLA",
	...
	"\255AH! Y POR SUPUESTO, EL INGREDIENTE PRINCIPAL: UNAS HOJAS DE UNA EXTRA\201\245A PLANTA LLAMADA FERNAN",
	...
	"HAY UNA GRUTA QUE LLEVA DIRECTAMENTE AL CASTILLO Y QUE ESE LOCO FAN DE ELVIS, IGOR, USA PARA BAJAR AL PUEBLO POR LAS MA\201\245ANAS",

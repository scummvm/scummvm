...
int DeskbotScript::process(const TTroomScript *roomScript, const TTsentence *sentence) {
	...
	if (getValue(1) == 3) {
		if (sentence->localWord("competition") || sentence->contains("competition") || sentence->localWord("won") || sentence->contains("won") || sentence->localWord("winning") || sentence->contains("winning") || sentence->localWord("winner") || sentence->contains("winner") || sentence->contains("35279") || sentence->contains("3 5 2 7 9") || (g_language == Common::DE_DEU && (sentence->contains("preisaus") || sentence->contains("tombola") || sentence->contains("lotterie") || sentence->contains("gewonnen") || sentence->contains("glueck") || sentence->contains("das goldene los") || sentence->contains("sechs richtige")))) {
			...
			applyResponse();
			return 2;
		} else if (sentence->localWord("upgrade") || sentence->contains("upgrade") || sentence->localWord("secondclass")) {
	...
	if (processEntries(&_entries, _entryCount, roomScript, sentence) != 2 && processEntries(&_entries2, 0, roomScript, sentence) != 2) {
		if (sentence->localWord("sauce") || sentence->localWord("pureed")) {
			...
			if (!defaultProcess(roomScript, sentence) && processEntries(&_entries3, 0, roomScript, sentence) != 2 && processEntries(_defaultEntries, 0, roomScript, sentence) != 2) {
				if (flag20)
...
int DeskbotScript::preResponse(uint id) {
	int newId = 0;
	if (getValue(1) >= 3 && (id == (uint)TRANSLATE(41176, 41190) ||
...
void DeskbotScript::setCurrentState(uint newId, uint index) {
	...
	for (uint idx = 0; idx < _states.size(); ++idx) {
		...
		if (newId == (idx == 0 ? 0 : us._newId)) {
			...
			if (!bits || (index == 1 && (bits & 1) && (bits & 4)) || (index == 0 && (bits & 2) && (bits & 4)) || (index == 3 && (bits & 1) && (bits & 8)) || (index == 2 && (bits & 2) && (bits & 8))) {
...
int DeskbotScript::preprocess(const TTroomScript *roomScript, const TTsentence *sentence) {
	...
	case 1:
		if (sentence->_category != 3 && sentence->_category != 4 && sentence->_category != 6 && sentence->_category != 10 && sentence->_category != 2) {
	...
	case 3:
		if (sentence->_category == 11 || sentence->_category == 13 || sentence->_category == 3 || sentence->localWord("upgrade")) {
	...
	case 5:
		if (isDial1Low() && getValue(1) == 4) {
			if (sentence->localWord("name") || sentence->localWord("called") || sentence->localWord("passenger")) {
	...
	case 6:
		if (isDial1Low() && getValue(1) == 4) {
			if (sentence->localWord("passenger")) {
				...
				applyFlag = true;
				stateFlag = false;
			} else if (sentence->localWord("home") || sentence->localWord("destroy")) {
				addResponse(getDialogueId(240574));
				stateFlag = true;
			} else if (sentence->localWord("name") || sentence->localWord("called") || sentence->_category == 11) {
	...
	case 7:
		if (sentence->_category == 11 || sentence->_category == 13 || (sentence->localWord("what") && sentence->localWord("wrong")) || sentence->localWord("clothes")) {
			addResponse(getDialogueId(240489));
			applyFlag = true;
			stateFlag = false;
		}
	...
	case 11:
		if (isDial0Medium() && isDial1Medium() && searchQuotes(roomScript, sentence)) {
	...
	case 75:
		if (sentence->_category == 24) {
			...
			applyFlag = true;
		} else if (sentence->localWord("good") || sentence->localWord("yes") || sentence->localWord("well") || sentence->localWord("ill") || sentence->localWord("sad")) {
	...
	case 84:
		if (sentence->_category == 12 || sentence->contains("vegetarian") || sentence->contains("vegitarian")) {
			addResponse(getDialogueId(241718));
			addResponse(getDialogueId(241709));
			applyFlag = true;
			stateFlag = false;
		} else if (sentence->contains("continental") || sentence->contains("kontinent") || sentence->contains("full") || sentence->contains("porky") || sentence->contains("the 1") || sentence->contains("the 2") || sentence->contains("former") || sentence->contains("latter") || sentence->contains("speck") || sentence->contains("wurst") || sentence->contains("englisch")) {
	...
	case 85:
		if (sentence->_category == 12 || sentence->contains("bugle") || sentence->contains("buggle") || sentence->contains("trumpet") || sentence->contains("saxophone") || sentence->contains("kazoo") || sentence->contains("blerontin 1") || sentence->contains("the 1") || sentence->contains("the 2") || sentence->contains("the 3") || sentence->contains("the 4") || sentence->contains("all of them") || sentence->contains("the lot") || sentence->contains("buegelhorn") || sentence->contains("bugelhorn") || sentence->contains("trompete") || sentence->contains("saxophon") || sentence->contains("popanz")) {
	...
	case 86:
		if (sentence->_category == 12 || sentence->_category == 11 || sentence->contains(TRANSLATE("view", "aussicht"))) {
	...
	case 87:
		if (sentence->contains("corner") || sentence->contains("on the end") || sentence->contains("balcony") || sentence->contains("neither") || sentence->contains("the 1") || sentence->contains("the 2") || sentence->contains("former") || sentence->contains("latter") || sentence->contains("either") || sentence->contains("suedlage") || sentence->contains("balkon")) {
	...
	case 88:
		...
		} else if (sentence->contains("despotic") || sentence->contains("despot") || sentence->contains("the last") || sentence->contains("latter")) {
			addResponse(getDialogueId(241688));
		} else if (sentence->contains("president") || sentence->contains("presidential") || sentence->contains("the 3") || sentence->contains("praesident")) {
	...
	case 89:
		...
		} else if (sentence->contains("queen") || sentence->contains("prince") || sentence->contains("princess") || sentence->contains("small") || sentence->contains("the 1") || sentence->contains("the 2") || sentence->contains("the 3") || sentence->contains("the 4") || sentence->contains("big") || sentence->contains("large") || sentence->contains("prinz") || sentence->contains("gross")) {
			addResponse(getDialogueId(241700));
			addResponse(getDialogueId(241739));
		} else {
	...
	case 90:
		if (sentence->contains("constitutional") || sentence->contains("const") || sentence->contains("absolute") || sentence->contains("small") || sentence->contains("the 1") || sentence->contains("the 2") || sentence->contains("big") || sentence->contains("large") || sentence->contains("verfassung") || sentence->contains("absolut") || sentence->contains("gross")) {
			addResponse(getDialogueId(241700));
			addResponse(getDialogueId(241739));
		} else {
			if (getRandomNumber(100) < 80 && sentence2C(sentence))
	...
	case 91:
		if (sentence->contains("benev") || sentence->contains("dict") || sentence->contains("small") || sentence->contains("the 1") || sentence->contains("the 2") || sentence->contains("big") || sentence->contains("large") || sentence->contains("former") || sentence->contains("latter") || sentence->contains("aufgekl") || sentence->contains("diktator") || sentence->contains("gross")) {
			addResponse(getDialogueId(241700));
			addResponse(getDialogueId(241739));
		} else {
			if (getRandomNumber(100) < 80 && sentence2C(sentence))
	...
	case 93:
		...
		if (sentence->_category == 11 || sentence->_category == 13) {
			...
			CTrueTalkManager::setFlags(CURRENT_STATE, 0);
			return 2;
		} else if (g_vm->_trueTalkManager->_quotes.find(sentence->_initialLine.c_str()) == MKTAG('F', 'I', 'S', 'H')) {
	...
	case 94:
		if (sentence->contains("seperate") || sentence->contains("separate") || sentence->contains("detached") || sentence->contains("outside") || sentence->contains("onsweet") || sentence->contains("ensuite") || sentence->contains("suite") || sentence->contains("next door") || sentence->contains("the 1") || sentence->contains("the 2") || sentence->contains("former") || sentence->contains("latter") || sentence->contains("same room") || sentence->contains("ohne") || sentence->contains("mit") || sentence->contains("die gleiche kabine") || sentence->contains("dieselbe kabine")) {
			addAssignedRoom();
			setState(0);
			CTrueTalkManager::setFlags(CURRENT_STATE, 0);
			return 2;
	...
	case 95:
		if (isDial1Medium()) {
			if ((sentence->localWord("i") && sentence->localWord("am")) || sentence->localWord("me")) {
...
int DeskbotScript::checkCommonWords(const TTsentence *sentence) {
	...
	if (quotes._loaded) {
		...
		if (tagId == MKTAG('F', 'U', 'L', 'N') || tagId == MKTAG('T', 'D', 'V', 'P') || tagId == MKTAG('H', 'E', 'R', 'O') || sentence->contains("douglas adam"))
			return 1;
		else if (tagId == MKTAG('J', 'N', 'A', 'M') || tagId == MKTAG('N', 'I', 'K', 'N') || tagId == MKTAG('B', 'O', 'Y', 'S') || tagId == MKTAG('G', 'I', 'R', 'L'))
			return 2;
	} else {
		if (sentence->contains("douglas adams") || sentence->contains("shaikh") || sentence->contains("millican") || sentence->contains("williams") || sentence->contains("henkes") || sentence->contains("kenny"))
			return 1;
		else if (sentence->contains("richard") || sentence->contains("jason") || sentence->contains("mike") || sentence->contains("renata"))
			return 2;
	}

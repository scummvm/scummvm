...
static const RoomDialogueId ROOM_DIALOGUES1_EN[] = {
    {100, 10523}, {101, 10499}, {107, 10516}, {108, 10500}, {109, 10490}, {110, 10504}, {111, 10506}, {112, 10498}, {113, 10502}, {114, 10507}, {115, 10497}, {116, 10508}, {117, 10505}, {118, 10505}, {122, 10516}, {123, 10383}, {124, 10510}, {125, 10511}, {126, 10513}, {127, 10512}, {128, 10495}, {129, 10496}, {130, 10491}, {131, 10493}, {132, 10492}, {0, 0}};
static const RoomDialogueId ROOM_DIALOGUES1_DE[] = {
    {101, 10375}, {107, 10379}, {108, 10378}, {109, 10364}, {110, 10377}, {111, 10383}, {112, 10374}, {113, 10376}, {114, 10384}, {115, 10373}, {116, 10385}, {117, 10380}, {118, 10380}, {122, 10392}, {123, 10390}, {124, 10386}, {125, 10387}, {126, 10389}, {127, 10388}, {128, 10371}, {129, 10372}, {130, 10366}, {131, 10368}, {132, 10367}, {0, 0}};

static const RoomDialogueId ROOM_DIALOGUES2_EN[] = {
    {102, 221981}, {110, 221948}, {111, 221968}, {107, 222000}, {101, 221935}, {112, 221924}, {113, 221942}, {116, 221977}, {124, 221987}, {125, 221984}, {127, 221991}, {128, 221916}, {129, 221919}, {131, 221912}, {132, 221908}, {0, 0}};
static const RoomDialogueId ROOM_DIALOGUES2_DE[] = {
    {102, 221981}, {110, 221948}, {111, 221968}, {107, 222000}, {101, 221935}, {112, 221924}, {113, 221942}, {116, 221977}, {124, 221987}, {125, 221984}, {127, 221991}, {128, 221916}, {129, 221919}, {131, 221912}, {132, 221909}, {0, 0}};
...
int DoorbotScript::process(const TTroomScript *roomScript, const TTsentence *sentence) {
	...
	if (currState) {
		...
		case 33:
			if (sentence->contains("sieve") || sentence->contains("colander") || sentence->contains("vegetable") || sentence->contains("ground") || sentence->contains("earth") || sentence->contains("garden") || sentence->contains("cheese") || sentence->contains("strainer") || sentence->contains("sieb") || sentence->contains("emmenthaler") || sentence->contains("gemuese") || sentence->contains("kaese") || sentence->contains("erde") || sentence->contains("garten")) {
		...
		case 34:
			...
			if (g_language == Common::EN_ANY) {
				...
				if (sentence->localWord("barbot") || sentence->localWord("rowbot") || sentence->localWord("liftbot") || sentence->localWord("maitredbot"))
	...
	if (processEntries(&_entries, _entryCount, roomScript, sentence) == 2 || processEntries(_defaultEntries, 0, roomScript, sentence) == 2 || defaultProcess(roomScript, sentence))
		return 2;
...
int DoorbotScript::updateState(uint oldId, uint newId, int index) {
	...
	for (uint idx = 0; idx < _states.size(); ++idx) {
		...
		if (us._newId == newId) {
			...
			if (!bits || (index == 0 && (bits == 5 || bits == 1)) || (index == 1 && (bits == 6 || bits == 2)) || (index == 2 && (bits == 9 || bits == 1)) || (index == 3 && (bits == 10 || bits == 2))) {
...
int DoorbotScript::doSentenceEntry(int val1, const int *srcIdP, const TTroomScript *roomScript, const TTsentence *sentence) {
	...
	case 6:
		...
		break;
	case 9:
		if (sentence->localWord("my") || sentence->contains("my") || sentence->contains("mein"))
			return true;
	...
	case 28:
		...
		break;
	case 29:
		if (sentence->localWord("another") || sentence->localWord("more") || sentence->localWord("additional") || sentence->contains("another") || sentence->contains("more") || sentence->contains("additional") || sentence->contains("noch ein") || sentence->contains("einen anderen") || sentence->contains("ein anderes") || sentence->contains("eine andere") || sentence->contains("zusaetzliche")) {
		...
		break;
	case 30:
		if (!sentence->localWord("because") && !sentence->contains("because") && !(g_language == Common::DE_DEU && sentence->contains("well")))
			return 1;
		break;
...
bool DoorbotScript::randomResponse(uint index) {
	...
	if (flag || (getDialRegion(1) != 1 && getRandomNumber(100) > 33) || getRandomNumber(8) <= index)
		return false;

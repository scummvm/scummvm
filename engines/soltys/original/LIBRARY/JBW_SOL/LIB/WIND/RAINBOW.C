	      ...
	      switch (k)
		{
		  ...
		  case MouseLeft:
			       if (PosToWind(MX, MY) == PAL)
				 {
			       ...
			       break;
		  case Up    : -- PAL->Vp; break;
		  case Down  : ++ PAL->Vp; break;
		  case Left  : -- PAL->Hp; break;
		  case Right : ++ PAL->Hp; break;
		}
	      PAL->Vp &= 0x07;
	      PAL->Vp &= 0x0F;

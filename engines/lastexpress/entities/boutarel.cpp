...
case kActionNone:
	...
	if (getEntities()->isInRestaurant(kEntityAnna) && getEntities()->isInRestaurant(kEntityAugust) && !getSoundQueue()->isBuffered(kEntityBoutarel) && params->param3 != kTimeInvalid) {

...
static const struct {
    ...
    {735, "201d"}, {1395, "201a"}, {1965, "201d"}, {2205, "201a"}, {3405, "201d"}, {3750, "201a"}, {3975, "201d"}, {4365, "201a"}, {4650, "201d"}, {4770, "201a"}, {4995, "201e"}, {5085, "201d"}, {5430, "201a"}, {5685, "201d"}, {5850, "201a"}, {7515, "201d"}, {7620, "201a"}, {7785, "201d"}, {7875, "201a"}, {8235, "201d"}, {8340, "201a"}, {8745, "201d"}, {8805, "201a"}, {8925, "201d"}, {8985, "201a"}, {9765, "201d"}, {9930, "201a"}, {12375, "201e"}, {12450, "201d"}, {12705, "201c"}, {13140, "201d"}, {13305, "201a"}, {13380, "201d"}, {13560, "201a"}, {14145, "201d"}, {14385, "201a"}, {14445, "201c"}, {14805, "201a"}, {16485, "201d"}, {16560, "201a"}, {16755, "201d"}, {16845, "201a"}, {17700, "201d"}, {17865, "201a"}, {18645, "201d"}, {18720, "201a"}, {19410, "201e"}, {19500, "201a"}, {22020, "201d"}, {22185, "201a"}, {22590, "201d"}, {22785, "201a"}, {23085, "201d"}, {23265, "201a"}};
...
case kActionDefault:
	if (getEntities()->isPlayerPosition(kCarRestaurant, 60) || getEntities()->isPlayerPosition(kCarRestaurant, 59) || getEntities()->isPlayerPosition(kCarRestaurant, 83) || getEntities()->isPlayerPosition(kCarRestaurant, 81) || getEntities()->isPlayerPosition(kCarRestaurant, 87))
		params->param1 = 1;
	break;
...
case kActionDrawScene:
	if (params->param1 && getEntities()->isPlayerPosition(kCarRestaurant, 51) && !getEntities()->isInSalon(kEntityBoutarel))
		...
		params->param1 = getEntities()->isPlayerPosition(kCarRestaurant, 60) || getEntities()->isPlayerPosition(kCarRestaurant, 59) || getEntities()->isPlayerPosition(kCarRestaurant, 83) || getEntities()->isPlayerPosition(kCarRestaurant, 81) || getEntities()->isPlayerPosition(kCarRestaurant, 87);
	break;
}
IMPLEMENT_FUNCTION_END
...
case kActionDrawScene:
	if (getEntities()->isInsideTrainCar(kEntityPlayer, kCarKronos) && !getEntities()->isInKronosSanctum(kEntityPlayer) && !getInventory()->hasItem(kItemFirebird) && !getEvent(kEventConcertStart)) {
...
case kActionDefault:
	...
	params->param1 = (getEntities()->isPlayerPosition(kCarKronos, 88) || getEntities()->isPlayerPosition(kCarKronos, 84) || getEntities()->isPlayerPosition(kCarKronos, 85) || getEntities()->isPlayerPosition(kCarKronos, 86) || getEntities()->isPlayerPosition(kCarKronos, 83));

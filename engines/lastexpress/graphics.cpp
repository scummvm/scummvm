...
GraphicsManagerOld::GraphicsManagerOld() : _changed(false) {
...
GraphicsManagerOld::~GraphicsManagerOld() {
...
void GraphicsManagerOld::update() {
...
void GraphicsManagerOld::change() {
	_changed = true;
}

void GraphicsManagerOld::clear(BackgroundType type) {
	clear(type, Common::Rect(640, 480));
}

void GraphicsManagerOld::clear(BackgroundType type, const Common::Rect &rect) {
	switch (type) {
	default:
...
bool GraphicsManagerOld::draw(Drawable *drawable, BackgroundType type, bool transition) {
...
Graphics::Surface *GraphicsManagerOld::getSurface(BackgroundType type) {
	switch (type) {
	default:
...
void GraphicsManagerOld::mergePlanes() {
...
void GraphicsManagerOld::updateScreen() {

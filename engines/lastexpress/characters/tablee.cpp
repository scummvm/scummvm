...
void LogicManager::CONS_TableE(int chapter) {
	switch (chapter) {
	case 0:
		_engine->getMessageManager()->setMessageHandle(
			kCharacterTableE,
			_functionsTableE[getCharacter(kCharacterTableE).callbacks[getCharacter(kCharacterTableE).currentCall]]
		);

		break;
	case 1:
		CONS_TableE_Birth(0, 0, 0, 0);
		break;
	case 2:
		CONS_TableE_StartPart2(0, 0, 0, 0);
		break;
	case 3:
		CONS_TableE_StartPart3(0, 0, 0, 0);
		break;
	case 4:
		CONS_TableE_StartPart4(0, 0, 0, 0);
		break;
	case 5:
...
void LogicManager::CONS_TableE_Birth(CONS_PARAMS) {
	CharacterCallParams *params = &getCharacter(kCharacterTableE).callParams[getCharacter(kCharacterTableE).currentCall];
	_engine->getMessageManager()->setMessageHandle(kCharacterTableE, &LogicManager::HAND_TableE_Birth);
...
void LogicManager::CONS_TableE_StartPart2(CONS_PARAMS) {
	CharacterCallParams *params = &getCharacter(kCharacterTableE).callParams[getCharacter(kCharacterTableE).currentCall];
	_engine->getMessageManager()->setMessageHandle(kCharacterTableE, &LogicManager::HAND_TableE_StartPart2);
...
void LogicManager::CONS_TableE_StartPart3(CONS_PARAMS) {
	CharacterCallParams *params = &getCharacter(kCharacterTableE).callParams[getCharacter(kCharacterTableE).currentCall];
	_engine->getMessageManager()->setMessageHandle(kCharacterTableE, &LogicManager::HAND_TableE_StartPart3);
...
void LogicManager::CONS_TableE_StartPart4(CONS_PARAMS) {
	CharacterCallParams *params = &getCharacter(kCharacterTableE).callParams[getCharacter(kCharacterTableE).currentCall];
	_engine->getMessageManager()->setMessageHandle(kCharacterTableE, &LogicManager::HAND_TableE_StartPart4);
...
void LogicManager::CONS_TableE_StartPart5(CONS_PARAMS) {
	CharacterCallParams *params = &getCharacter(kCharacterTableE).callParams[getCharacter(kCharacterTableE).currentCall];
	_engine->getMessageManager()->setMessageHandle(kCharacterTableE, &LogicManager::HAND_TableE_StartPart5);
...
void LogicManager::CONS_TableE_Idling(CONS_PARAMS) {
	CharacterCallParams *params = &getCharacter(kCharacterTableE).callParams[getCharacter(kCharacterTableE).currentCall];
	_engine->getMessageManager()->setMessageHandle(kCharacterTableE, &LogicManager::HAND_TableE_Idling);
	getCharacter(kCharacterTableE).callbacks[getCharacter(kCharacterTableE).currentCall] = 6;
...
void LogicManager::HAND_TableE_Idling(HAND_PARAMS) {
	switch (msg->action) {
	case 12:
...
void (LogicManager::*LogicManager::_functionsTableE[])(HAND_PARAMS) = {
	nullptr,
	&LogicManager::HAND_TableE_Birth,
	&LogicManager::HAND_TableE_StartPart2,
	&LogicManager::HAND_TableE_StartPart3,
	&LogicManager::HAND_TableE_StartPart4,
	&LogicManager::HAND_TableE_StartPart5,
	&LogicManager::HAND_TableE_Idling
};

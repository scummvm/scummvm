...
void LogicManager::CONS_TableF(int chapter) {
	switch (chapter) {
	case 0:
		...
		break;
	case 1:
		CONS_TableF_Birth(0, 0, 0, 0);
		break;
	case 2:
		CONS_TableF_StartPart2(0, 0, 0, 0);
		break;
	case 3:
		CONS_TableF_StartPart3(0, 0, 0, 0);
		break;
	case 4:
		CONS_TableF_StartPart4(0, 0, 0, 0);
		break;
	case 5:
...
void LogicManager::CONS_TableF_Birth(CONS_PARAMS) {
	CharacterCallParams *params = &getCharacter(kCharacterTableF).callParams[getCharacter(kCharacterTableF).currentCall];
	_engine->getMessageManager()->setMessageHandle(kCharacterTableF, &LogicManager::HAND_TableF_Birth);
...
void LogicManager::CONS_TableF_StartPart2(CONS_PARAMS) {
	CharacterCallParams *params = &getCharacter(kCharacterTableF).callParams[getCharacter(kCharacterTableF).currentCall];
	_engine->getMessageManager()->setMessageHandle(kCharacterTableF, &LogicManager::HAND_TableF_StartPart2);
...
void LogicManager::CONS_TableF_StartPart3(CONS_PARAMS) {
	CharacterCallParams *params = &getCharacter(kCharacterTableF).callParams[getCharacter(kCharacterTableF).currentCall];
	_engine->getMessageManager()->setMessageHandle(kCharacterTableF, &LogicManager::HAND_TableF_StartPart3);
...
void LogicManager::CONS_TableF_StartPart4(CONS_PARAMS) {
	CharacterCallParams *params = &getCharacter(kCharacterTableF).callParams[getCharacter(kCharacterTableF).currentCall];
	_engine->getMessageManager()->setMessageHandle(kCharacterTableF, &LogicManager::HAND_TableF_StartPart4);
...
void LogicManager::CONS_TableF_StartPart5(CONS_PARAMS) {
	CharacterCallParams *params = &getCharacter(kCharacterTableF).callParams[getCharacter(kCharacterTableF).currentCall];
	_engine->getMessageManager()->setMessageHandle(kCharacterTableF, &LogicManager::HAND_TableF_StartPart5);
...
void LogicManager::CONS_TableF_Idling(CONS_PARAMS) {
	CharacterCallParams *params = &getCharacter(kCharacterTableF).callParams[getCharacter(kCharacterTableF).currentCall];
	_engine->getMessageManager()->setMessageHandle(kCharacterTableF, &LogicManager::HAND_TableF_Idling);
	getCharacter(kCharacterTableF).callbacks[getCharacter(kCharacterTableF).currentCall] = 6;
...
void LogicManager::HAND_TableF_Idling(HAND_PARAMS) {
	switch (msg->action) {
	case 12:
...
void (LogicManager::*LogicManager::_functionsTableF[])(HAND_PARAMS) = {
	nullptr,
	&LogicManager::HAND_TableF_Birth,
	&LogicManager::HAND_TableF_StartPart2,
	&LogicManager::HAND_TableF_StartPart3,
	&LogicManager::HAND_TableF_StartPart4,
	&LogicManager::HAND_TableF_StartPart5,
	&LogicManager::HAND_TableF_Idling
};

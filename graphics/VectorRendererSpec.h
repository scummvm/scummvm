...
public:
	...
	void drawBeveledSquare(int x, int y, int w, int h, int bevel) override {
	...
	void drawString(const Graphics::Font *font, const Common::String &text,
					...
					GUI::ThemeEngine::TextAlignVertical alignV, int deltax, bool elipsis, const Common::Rect &textDrawableArea = Common::Rect(0, 0, 0, 0)) override;
	...
	void blitSubSurface(const Graphics::Surface *source, const Common::Rect &r) override;
	void blitAlphaBitmap(const Graphics::Surface *source, const Common::Rect &r) override;

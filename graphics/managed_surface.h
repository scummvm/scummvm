...
public:
	int32 &w;           /*!< Width of the surface rectangle. */
	int32 &h;           /*!< Height of the surface rectangle. */
...
public:
	 ...
	 */
	virtual void create(int32 width, int32 height);

	/**
	 * Allocate memory for the pixel data of the surface.
	 */
	virtual void create(int32 width, int32 height, const PixelFormat &pixelFormat);

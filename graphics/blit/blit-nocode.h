...
#ifndef GRAPHICS_BLIT_NOCODE_H
#define GRAPHICS_BLIT_NOCODE_H
...
//
// This file must be safe to include in modules compiled for multiple
// instruction set extensions.  Since the optimizer may emit code for
// those extensions from any code, and the linker will chose one
// definition for any functions with the same mangled name, this header
// must not contain any definitions for functions that may also exist
// in a source file compiled without those extensions.

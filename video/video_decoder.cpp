...
VideoDecoder::AudioTrack::AudioTrack(Audio::Mixer::SoundType soundType) : _volume(Audio::Mixer::kMaxChannelVolume),
                                                                          _soundType(soundType),
                                                                          _balance(0),
                                                                          _muted(false) {
}
...
VideoDecoder::StreamFileAudioTrack::StreamFileAudioTrack(Audio::Mixer::SoundType soundType) : SeekableAudioTrack(soundType) {
	_stream = 0;
}

...
CoktelDecoder::CoktelDecoder(Audio::Mixer *mixer, Audio::Mixer::SoundType soundType) : _mixer(mixer), _soundType(soundType), _width(0), _height(0), _x(0), _y(0),
...
AdvancedVMDDecoder::VMDAudioTrack::VMDAudioTrack(VMDDecoder *decoder) : AudioTrack(decoder->getSoundType()),
                                                                        _decoder(decoder) {
}

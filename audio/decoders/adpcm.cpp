...
public:
	PacketizedADPCMStream(ADPCMType type, int rate, int channels, uint32 blockAlign) : StatelessPacketizedAudioStream(rate, channels), _type(type), _blockAlign(blockAlign) {}

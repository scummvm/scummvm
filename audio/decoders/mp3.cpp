...
BaseMP3Stream::BaseMP3Stream() : _posInFrame(0),
...
MP3Stream::MP3Stream(Common::SeekableReadStream *inStream, DisposeAfterUse::Flag dispose) : BaseMP3Stream(),
...
PacketizedMP3Stream::PacketizedMP3Stream(Common::SeekableReadStream &firstPacket) : BaseMP3Stream(),
                                                                                    _finished(false) {
...
PacketizedMP3Stream::PacketizedMP3Stream(uint channels, uint rate) : BaseMP3Stream(),
                                                                     _finished(false) {
	_channels = channels;
	_rate = rate;
}

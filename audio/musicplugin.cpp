...
MusicDevice::MusicDevice(MusicPluginObject const *musicPlugin, Common::String name, MusicType mt) : _musicDriverName(_(musicPlugin->getName())), _musicDriverId(musicPlugin->getId()),

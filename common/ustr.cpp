...
U32String::U32String(const value_type *str)
  : _size(0)
  , _str(_storage) {
	if (str == nullptr) {
		_storage[0] = 0;
...
U32String::U32String(const value_type *str, uint32 len)
  : _size(0)
  , _str(_storage) {
	initWithCStr(str, len);
}

U32String::U32String(const value_type *beginP, const value_type *endP)
  : _size(0)
  , _str(_storage) {
	assert(endP >= beginP);
...
U32String::U32String(const char *str)
  : _size(0)
  , _str(_storage) {
	if (str == nullptr) {
		_storage[0] = 0;
...
U32String::U32String(const char *str, uint32 len)
  : _size(0)
  , _str(_storage) {
	initWithCStr(str, len);
}

U32String::U32String(const char *beginP, const char *endP)
  : _size(0)
  , _str(_storage) {
	assert(endP >= beginP);
	initWithCStr(beginP, endP - beginP);
...
U32String::U32String(const String &str)
  : _size(0)
  , _str(_storage) {

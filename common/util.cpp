...
Common::String DateTime::formatTime(int64 t) {
...
int64_t DateTime::dateTimeToInt64(const TimeDate &timeDate) {
...
TimeDate DateTime::intToTimeDate(int64 t) {
	TimeDate dateTime;
	int64_t seconds = t;

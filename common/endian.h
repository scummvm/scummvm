...
#define SWAP_CONSTANT_64(a) \
	((uint64)((((a) >> 56) & 0x000000FF) | (((a) >> 40) & 0x0000FF00) | (((a) >> 24) & 0x00FF0000) | (((a) >> 8) & 0xFF000000) | (((a)&0xFF000000) << 8) | (((a)&0x00FF0000) << 24) | (((a)&0x0000FF00) << 40) | (((a)&0x000000FF) << 56)))

#define SWAP_CONSTANT_32(a) \
	((uint32)((((a) >> 24) & 0x00FF) | (((a) >> 8) & 0xFF00) | (((a)&0xFF00) << 8) | (((a)&0x00FF) << 24)))

#define SWAP_CONSTANT_16(a) \
	((uint16)((((a) >> 8) & 0x00FF) | (((a) << 8) & 0xFF00)))

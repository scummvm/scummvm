...
protected:
	 ...
	 */
	void createModuleList(const std::string &moduleDir, const StringMap &defines, StringList &testDirs, StringList &includeList, StringList &excludeList, bool forDetection = false) const;

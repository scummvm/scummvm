...
static const char *const k1GUIStringsDOSCDHebrew[81] = {
	...
	"] משבצת ריקה [",
	"ביטול",
	"הזינו תיאור של המשחק השמור:",
	"שמירה",
	"נוח על משכבך בשלום, ברנדון.",
	...
	"כן",
	"לא",
	"\xCD\x0E\x17""+""\xD5\x0E\x17""+""\xDA\x0E\x17""+""\xE1\x0E\x17""+""\xE6\x0E\x17""+""\xEE\x0E\x17""+""\xF8\x0E\x17""+""\x03\x0F\x17""+""\x10\x0F\x17""+""\x18\x0F\x17""+""\x1F\x0F\x17""+$""\x0F\x17""+מהירות הליכה ",
	"מהירות טקסט ",
	"מוזיקה ",
	"צלילים ",
	"קול / טקסט "

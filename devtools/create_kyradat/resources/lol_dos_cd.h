...
static const uint16 kLoLIngameSfxIndexDOSCD[500] = {
...
static const Uint16Provider kLoLIngameSfxIndexDOSCDProvider = { ARRAYSIZE(kLoLIngameSfxIndexDOSCD), kLoLIngameSfxIndexDOSCD };

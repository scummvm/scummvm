...
static const char *const k1NoDropStringsDOSCDRussian[2] = {
	"C""\x1B\x18""]""\x1A""o""\x1C"" ""\x1C\x1D""o""\x15""o ""\x1E""pe""\x16\x1C""e""\x1F""o""\x14"" ""\x1D""a ""\x17""e""\x1C\x1B""e.",
	"He""\x14""o""\x17\x1C""o""\x7F\x1D""o ""\x1E""o""\x1B""o\x7F\x18\x1F{ ""\x1E""pe""\x16\x1C""e""\x1F."
};
...
static const char *const k1FluteStringsDOSCDRussian[40] = {
...
static const char *const k1GUIStringsDOSCDRussian[] = {
	...
	"\x03""a",
	"He""\x1F",
	"\xCD\x0E\x17""+""\xD5\x0E\x17""+""\xDA\x0E\x17""+""\xE1\x0E\x17""+""\xE6\x0E\x17""+""\xEE\x0E\x17""+""\xF8\x0E\x17""+""\x03\x0F\x17""+""\x10\x0F\x17""+""\x18\x0F\x17""+""\x1F\x0F\x17""+$""\x0F\x17""+\x03\x14\x18\x7F""e""\x1D\x18""e ",
	"C""\x1A""opoc""\x1F""{ ""\x1F""e""\x1A""c""\x1F""a",
	"My""\x17""`""\x1A""a",
	"\x05\x14""y""\x1A\x18",
	"O""\x17\x14""y\\""\x1A""a / Te""\x1A""c""\x1F",
};
...
static const char *const k1ConfigStringsDOSCDRussian[12] = {
	...
	"To""\x1B""{""\x1A""o ""\x1F""e""\x1A""c""\x1F",
	"To""\x1B""{""\x1A""o o""\x17\x14""y\\""\x1A""a",
	"O""\x17\x14""y\\""\x1A""a ""\x18"" ""\x1F""e""\x1A""c""\x1F",
	"\x1C""e""\x16\x1B""e""\x1D\x1D""o",
	"\x1D""op""\x1C""a""\x1B""{""\x1D""o",
	"\x13""`c""\x1F""po",

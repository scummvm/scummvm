static const char *const k1IntroStringsDOSSpanish[53] = {
	...
	"..."
	"\xAD"
	"Poderoso jefe de la Orden de los M"
	"\xA1"
	"sticos reales!",
	"\xA8"
	"Te he asustado?",
	...
	" me iba a dar prisa?",
	"\xAD"
	"Soy yo el que gobierna este pa"
	"\xA1"
	"s!",
	"Tu d"
	"\x82"
	"bil maleficio no me atemoriza.",
	"\xAD"
	"Anda, m"
	"\xA0"
	"tame de una vez!",
	"Me queda poco poder m"
	"\xA0"
	"gico.",
	"No te quepa ninguna duda de que vengo a hacerte da"
	"\xA4"
	"o...",
	"...Ahora eres de piedra...",
	"...pero he respetado tus ojos.",
	"No he derramado ni una l"
	"\xA0"
	"grima por Kyrandia...",
	...
	"Y es "
	"\x82"
	"l quien ahora controla la Kyragema...",
	"...fuente de toda la magia de Kyrandia!",
	"",
	"\xAD"
	"C"
	"\xA2"
	"mo te atreves a tropezar conmigo!",
	...
	"Ja ja ja...",
	"\xA8"
	"Verdad que los dedos son una maravilla?",
	"\xAD"
	...
	"TU lo has hecho!",
	"\xAD"
	"Larga vida al rey Brandon!",
	"\xAD"
	"Larga vida a los M"
	"\xA1"
	"sticos reales!",
	"\xAD"
	"Ahora vamos a reconstruir Kyrandia!",
	"\xAD"
	"Buena idea!",
	"En mi primera proclamaci"
	"\xA2"
	"n como rey...",
	"\xAD"
	"Declaro las sandalias como calzado oficial de Kyrandia!",
	"\xAD"
	"Bien hecho, Brandon!",
	"La Tierra no sufre m"
	"\xA0"
	"s...",
	"\xAD"
	"Y tus amigos han regresado!",
	"Querida Brynn...",
	"\xAD"
	"Malcolm se ha fugado!",
	"Pronto vendr"
	"\xA0"
	" a por m"
	"\xA1"
...
static const char *const k1PutDownStringDOSSpanish[1] = {
	"Mejor ser"
	"\xA0"
	" que deposite esto antes que nada."
};
...
static const char *const k1WaitAmuletStringDOSSpanish[1] = {
	"Supongo que tendr"
	"\x82"
	" que esperar a que mi amuleto recobre su poder."
};
...
static const char *const k1PoisonGoneStringDOSSpanish[2] = {
	...
	"Genial!",
	"\xAD"
	"Han desaparecido los efectos del veneno!"
};
...
static const char *const k1ThePoisonStringsDOSSpanish[4] = {
	...
	"No me siento bien...",
	"\xAD"
	"Esa serpiente debe ser\rvenenosa!"
};
...
static const char *const k1FullFlaskStringDOSSpanish[4] = {
	"Ahora el frasco est"
	"\xA0"
	" lleno\rde agua fresca y espumosa.",
	"Ahora el frasco est"
	"\xA0"
	" lleno\rde agua salada.",
	"Ahora el frasco est"
	"\xA0"
	" lleno\rde agua mineral.",
	"Agua m"
	"\xA0"
	"gica."
};
...
static const char *const k1VeryCleverStringDOSSpanish[1] = {
	"\xAD"
	"Muy listo!, pero tus in"
	"\xA3"
	"tiles esfuerzos son en vano."
};
...
static const char *const k1GUIStringsDOSSpanish[24] = {
	...
	"Qu"
	"\x82"
	" juego deseas recargar?",
	"Seleccionar una posici"
	"\xA2"
	"n para salvar:",
	"[ RANURA VACIA ]",
	"Abandonar",
	"Introduce una descripci"
	"\xA2"
	"n de tu juego salvado.",
	"Salvar",
	"Descansa en paz, Brandon.",
	"\xA8"
	"Est"
	"\xA0"
	"s seguro de que deseas Abandonar el juego?",
	"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXMen"
	"\xA3"
	" principal",
	"activado",
	"desactivado",

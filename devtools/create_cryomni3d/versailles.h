...
static char const versaillesDEBombPwd[] = "MONARCHEN IST ES NICHT GEGEBEN VOLLKOMMENHEIT ZU ERREICHEN";
...
static char const *const versaillesFRmessages[] = {
	...
	"Vous ne pouvez pas atteindre la b"
	"\x89"
	"che.", /*   4 */
	...
	"Vous n"
	"\xd5"
	"avez plus le temps de vous renseigner sur la "
	"Cour!", /*  13 */
	"Il est trop tard pour regarder les tableaux!", /*  14 */
	"Attendez ! Transmettez donc vos indices "
	"\x88"
	" l'huissier.", /*  15 */
	...
	"n'avez pas effectu"
	"\x8e"
	" toutes les actions necessaires pour "
	"la suite. Il est conseill"
	"\x8e"
	...
	"\x8e"
	" toutes les "
	"actions necessaires pour la suite. Il est conseill"
	"\x8e"
	" de "
	"SAUVEGARDER votre partie maintenant.", /*  19 */
	"Vous ne pouvez pas vous d"
	"\x8e"
	"placer en portant une "
	"\x8e"
	"chelle!", /*  20 */
	...
	"libre", /*  55 */
	"sans nom", /*  56 */
	"Attention : la partie en cours va "
	"\x90"
	"tre abandonn"
	"\x8e"
	"e.", /*  57 */
	...
	"Veuillez ins"
	"\x8e"
	"rer le CD %d et presser une touche", /*  67 */
	"Les arts", /*  68 */
	"Le r"
	"\x8f"
	"gne", /*  69 */
...
static char const *const versaillesFRpaintings[] = {
	"\"Entr"
	"\x8e"
	"e des animaux dans l'arche\"\rGerolamo Bassano", /*  0: 41201 */
	"\"Le repas d'Emma"
	"\x9f"
	"s\"\rJacopo Bassano", /*  1: 41202 */
	"\"La Madeleine aux pieds de J"
	"\x8e"
	"sus Christ\"\rSustris", /*  2: 41203 */
	...
	"\"Sainte C"
	"\x8e"
	"cile avec un ange tenant une partition "
	...
	"\"En"
	"\x8e"
	"e portant Anchise\"\rSpada", /* 26: 43100 */
	"\"David et Bethsab"
	"\x8e"
	"e\"\rV"
	"\x8e"
	...
	"\x8f"
	"se", /* 27: 43101 */
	"\"La fuite en Egypte\"\rGuido R"
	"\x8e"
	"ni ", /* 28: 43102 */
	"\"Louis XIV "
	"\x88"
	" cheval\"\rPierre Mignard", /* 29: 43103 */
	"\"La magnificience royale & le progr"
	"\x8f"
	"s des beaux "
	"arts\"\rHouasse", /* 30: 43104 */
	"\"Le Sacrifice d'Iphig"
	"\x8e"
	"nie\"\rCharles de la Fosse", /* 31: 43130 */
	"\"Buste de Louis XIV\"\rsculpt"
	"\x8e"
	" par le Chevalier Bernin ", /* 32: 43131 */
	"\"Diane d"
	"\x8e"
	"couvrant son berger Endymion endormi dans les "
	"bras de Morph"
	"\x8e"
	"e\"\rGabriel Blanchard", /* 33: 43132 */
	...
	"\x8f"
	"se", /* 35: 43141 */
	"\"La sainte Famille\"\rV"
	"\x8e"
	"ron"
	"\x8f"
	"se", /* 36: 43142 */
	"\"La famille de Darius aux pieds d'Alexandre\"\rCharles LeBrun", /* 37: 43143 */
	"\"Saint Jean-Baptiste\"\rRapha"
	"\x91"
	"l", /* 38: 43144 */
	"\"Marie de m"
	"\x8e"
	"dicis\"\rVan Dyck", /* 39: 43150 */
	"\"Hercule luttant contre Achelous\"\rGuido R"
	"\x8e"
	"ni", /* 40: 43151 */
	"\"Le Centaure Nessus porte Dejanire\"\rGuido R"
	"\x8e"
	"ni", /* 41: 43152 */
	"\"Saint Fran"
	"\x8d"
	...
	"\"Thomiris faisant tremper la t"
	"\x90"
	"te de Cyrus dans le "
	"sang\"\rRubens", /* 43: 43154 */
	"\"Hercule tuant l'Hydre\"\rGuido R"
	"\x8e"
	"ni", /* 44: 43155 */
	"\"Hercule sur le b"
	"\x9e"
	...
	"\x8e"
	"ni", /* 45: 43156 */
	"\"Portrait du Prince Palatin & de son fr"
	"\x8f"
	"re le Prince "
...
static char const *const versaillesDEmessages[] = {
	...
	"ffnen dieser T"
	"\x9f"
	"r ist zur Zeit nicht "
	"gestattet.", /*   0 */
	"Diese T"
	"\x9f"
	"r ist verschlossen.", /*   1 */
	"Diese T"
	"\x9f"
	"r ist zu.", /*   2 */
	...
	"Sie k"
	"\x9a"
	"nnen die Plane nicht erreichen.", /*   4 */
	...
	"Sie ben"
	"\x9a"
	"tigen etwas, um die Bombe zu erreichen.", /*  10 */
	"Diese Vase ist leer.", /*  11 */
	"Jetzt k"
	"\x9a"
	"nnen Sie gehen.", /*  12 */
	"Sie haben keine Zeit mehr, sich "
	"\x9f"
	"ber den Hof zu "
	"informieren!", /*  13 */
	"Es ist zu sp"
	"\x8a"
	"t, um sich die Bilder anzusehen.", /*  14 */
	"Warten Sie! Geben Sie Ihre Hinweise doch an den Diener weiter.", /*  15 */
	"Sie k"
	"\x9a"
	"nnen das Papier nicht erreichen.", /*  16 */
	"Zur Apotheke", /*  17 */
	"Vorsicht! Sie k"
	"\x9a"
	"nnen dieses Level beenden, aber Sie "
	...
	"Sie k"
	"\x9a"
	"nnen sich nicht von der Stelle bewegen, wenn Sie "
	...
	"hschrift "
	"\x9f"
	"ber die Religion", /* 125 */
	"Inschrift", /* 126 */
	"Schm"
	"\x8a"
	"hschrift "
	"\x9f"
	"ber die Regierung", /* 127 */
	"Feder", /* 128 */
	"Merkzeichen", /* 129 */
	"Fernrohr", /* 130 */
	"Vaubanplan", /* 131 */
...
static char const *const versaillesDEpaintings[] = {
	...
	"\"Magdalena zu F"
	"\x9f\xa7"
	"en Jesu Christi\"\rSustris", /*  2: 41203 */
	...
	"\"Die heilige C"
	"\x8a"
	"cilia mit einem Engel, der ein "
	"Notenblatt h"
	"\x8a"
	"lt\"\rDominiquin", /*  8: 42901 */
	"\"Don Francisco du Moncada\"\rVan Dyck", /*  9: 42902 */
	"\"Der kleine Johannes der T"
	"\x8a"
	"ufer\"\rLe Carrache", /* 10: 42903 */
	"\"Der heilige Matth"
	"\x8a"
	"us\"\rValentin", /* 11: 42904 */
	"\"Der Denar des C"
	"\x8a"
	"sar\"\rValentin", /* 12: 42905 */
	...
	"\"Der K"
	"\x9a"
	"nig David beim Harfenspiel\"\rDominiquin", /* 17: 42910 */
	"\"Die heilige Magdalena\"\rDominiquin", /* 18: 42911 */
	"\"Selbstportr"
	"\x8a"
	"t\"\rVan Dyck", /* 19: 42912 */
	...
	"\"Meleagros mit dem kalydonischen Eberkopf zu seinen F"
	"\x9f"
	"\xa7"
	"en\"\rJacques Rousseau", /* 23: 43090 */
	"\"Der K"
	"\x9a"
	"nig in r"
	"\x9a"
	"mischem Gewand\"\rJean Warin",
	/* 24: 43091 */ /* BUG: Switched */
	"\"Attalante\"\rJacques Rousseau", /* 25: 43092 */
	"\"\x80"
	"neas tr"
	"\x8a"
	"gt Anchises\"\rSpada", /* 26: 43100 */
	"\"David und Bethsabee\"\rV"
	"\x8e"
	"ron"
	"\x8f"
	"se", /* 27: 43101 */
	...
	"\"Die k"
	"\x9a"
	"nigliche Pracht und der Fortschritt der sch"
	"\x9a"
	"nen K"
	"\x9f"
	"nste\"\rHouasse", /* 30: 43104 */
	"\"Das Opfer der Iphigenie\"\rCharles de la fosse", /* 31: 43130 */
	"\"B"
	"\x9f"
	"ste Ludwigs XIV.\"\rSkulptur von Bernini", /* 32: 43131 */
	...
	"\"Die Emmaus-Pilger\"\rV"
	"\x8e"
	"ron"
	"\x8f"
	"se", /* 35: 43141 */
	"\"Die heilige Familie\"\rV"
	"\x8e"
	"ron"
	"\x8f"
	"se", /* 36: 43142 */
	"\"Die Familie des Darius zu F"
	"\x9f\xa7"
	"en "
	"Alexanders\"\rCharles Le Brun", /* 37: 43143 */
	"\"Der heilige Johannes der T"
	"\x8a"
	"ufer\"\rRapha"
	"\x91"
	"l", /* 38: 43144 */
	...
	"\"Herkules k"
	"\x8a"
	"mpft gegen Acheloos\"\rGuido R"
	"\x8e"
	"ni", /* 40: 43151 */
	"\"Der Zentaur Nessus tr"
	"\x8a"
	"gt Deianeira\"\rGuido R"
	"\x8e"
	"ni", /* 41: 43152 */
	"\"Der heilige Franz von Assisi, nach seiner Stigmatisierung gest"
	"\x8a"
	"rkt\"\rSeghers", /* 42: 43153 */
	...
	"\x8e"
	"ni", /* 44: 43155 */
	"\"Herkules auf dem Scheiterhaufen\"\rGuido R"
	"\x8e"
	"ni", /* 45: 43156 */
	"\"Portr"
	"\x8a"
...
static char const *const versaillesENpaintings[] = {
	...
	"feet\"\rJacques Rousseau",
	/* 23: 43090 */ /* BUG: Switched */
...
static char const *const versaillesESmessages[] = {
	...
	"Necesitar"
	"\x87"
	"s algo para poder alcanzar la bomba.", /*  10 */
	"Este jarr"
	"\x97"
	"n est"
	"\x87"
	...
	"\xc1"
	"No tienes tiempo para aprender sobre la Corte.!", /*  13 */
	"\xc1"
	"Es demasiado tarde para admirar los cuadros!", /*  14 */
	"\xc1"
	"Espera! Dale tus pistas al ujier.", /*  15 */
	"No puedes alcanzar el papel.", /*  16 */
	"A la botica.", /*  17 */
	"Aviso: Podr"
	"\x87"
	"s llegar al final de este nivel, pero no has "
	"realizado todas las acciones necesarias para poder continuar. Se "
	"te aconseja que GUARDES este juego ahora.", /*  18 */
	"Aviso: Podr"
	"\x87"
	"s llegar al final de este nivel, pero puede "
	"que no hayas realizado todas las acciones necesarias para poder "
	"continuar. Se te aconseja que GUARDES este juego ahora.", /*  19 */
	"No puedes moverte por ah"
	"\x92"
	" mientras lleves una escalera.", /*  20 */
	"Aqu"
	"\x92"
	" no hay nada m"
	"\x87"
	...
	"Consultar la zona de documentaci"
	"\x97"
	"n", /*  25 */
	...
	"           Una parte de la m"
	"\x9c"
	"sica en el disco duro (20 "
	"Mb)", /*  34 */
	"           Toda la m"
	"\x9c"
	"sica en el disco duro (92 Mb)", /*  35 */
	"           No guardar m"
	"\x9c"
	"sica en el disco duro (leer CD)", /*  36 */
	nullptr, /*  37 */
	nullptr, /*  38 */
	"Volumen", /*  39 */
	"Salir del juego", /*  40 */
	...
	"\x9c"
	" Principal", /*  60 */
	"Sumario de la Zona de Documentaci"
	"\x97"
	"n", /*  61 */
	...
	"Llave de la peque"
	"\x96"
	"a puerta de Apolo", /* 123 */
	"Comida", /* 124 */
	"Panfleto sobre religi"
	"\x97"
	"n", /* 125 */
	"Ep"
	"\x92"
...
static char const *const versaillesESpaintings[] = {
	...
	"\"Mar"
	"\x92"
	"a Magdalena a los pies de Cristo\"", /*  2: 41203 */
	...
	"\"Santa Cecilia con un "
	"\x87"
	"ngel sosteniendo una "
	...
	"rgen Mar"
	"\x92"
	"a\"\rIl Guercino", /* 34: 43140 */
	"\"Los disc"
	"\x92"
	"pulos en Emmaus\"\rVeronese", /* 35: 43141 */
	"\"La Sagrada Familia\"\rVeronese", /* 36: 43142 */
	"\"La familia de Dar"
	"\x92"
	"o a los pies de Alejandro\"\rCharles "
	"LeBrun", /* 37: 43143 */
	...
	"\"H"
	"\x8e"
	"rcules luchando contra Aqueleo\"\rGuido Reni", /* 40: 43151 */
	"\"El Centauro Nessus raptando a Deianeira\"\rGuido Reni", /* 41: 43152 */
	"\"San Francisco de As"
	"\x92"
	"s consolado tras recibir el "
	"estigma\"\rSeghers", /* 42: 43153 */
	"\"Thomiris hundiendo la cabeza de Ciro en sangre\"\rRubens", /* 43: 43154 */
	"\"H"
	"\x8e"
	"rcules destruyendo a Hydra\"\rGuido Reni", /* 44: 43155 */
	"\"H"
	"\x8e"
	"rcules en llamas\"\rGuido Reni", /* 45: 43156 */
	"\"Retrato del Pr"
	"\x92"
	"ncipe Palatine y de su hermano el Pr"
	"\x92"
	"ncipe Roberto\"\rVan Dyck", /* 46: 43157 */
...
static char const *const versaillesITmessages[] = {
	...
	"\x8f"
	" vuoto.", /*   3 */
	"Non puoi raggiungere il"
	"\xca"
	"rivestimento.", /*   4 */
	"Non c"
	"\xd5\x8f"
	" niente in questo arancio.", /*   5 */
	"Questo non "
	"\x8f"
	" un arancio!", /*   6 */
	"\xe9"
	...
	"\xe9"
	" troppo tardi per guardare i quadri!", /*  14 */
...
static char const *const versaillesITpaintings[] = {
	...
	"\"Ercole in lotta con Achel"
	"\x98"
	"o\"\rGuido Reni", /* 40: 43151 */

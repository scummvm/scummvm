...
const char *gameDataFr[] = {
	...
	"A vous de jouer$",
	"OK !$",
	"Soudain Max survient avec votre  valise : \"Merci de votre visite !  Détective \"privé\"... de bon sens et de discrétion sans doute\" . Déçu démoralisé, vous quittez le manoir@Vous ètes NUL !$",

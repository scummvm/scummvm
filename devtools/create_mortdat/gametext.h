...
const char *gameDataEn[] =  {
	...
	"Mother died suddenly. And yet her health had seemed to improveÇ$",
...
const char *gameDataFr[] = {
	...
	"Des goóts et des couleurs!$",
	"Mauve qui peut!$",
	"Priäre de laisser en sortant...$",
	"Trou noir troublant$",
	...
	"Un endroit bien peu visitÇ$",
	"HumiditÇ et moisissure$",
	"Avis aux colporteurs...$",
	"Corps putrÇfiÇ : cryptomanie mortelle!$",
	"Et en plus... des piäges dÇsamorcÇs!$",
	"C'est dÇjÖ ouvert$",
	"Danger : avalanches$",
	"Une odeur de saintetÇ!$",
	"Une bÉtisse imposante$",
	"L'envers du mystäre!$",
	"Drìle d'horoscope!$",
	"Tant va la cruche...$",
	"Une porte en chäne$",
	...
	"Les armoiries$",
	"$",
	"Max, le domestique, vous accueille puis vous conduit Ö votre chambre$",
	"Mortevielle, le 16/2/51@         Mon cher JÇrìme,@ Suite Ö mon tÇlÇgramme, je vous fais part des raisons de mon inquiÇtude :il y a un an, Murielle, ma dame de compagnie, disparaissait . DÇpart ayant rapport avec le renouveau financier du Manoir, ou... Silence difficile Ö comprendre, surtout pour mon fils Guy . N'ayant pu jusqu'Ö prÇsent, faire le jour sur cette affaire, je compte sur vous pour la mener Ö bien . Si mon Çtat de santÇ ne s'amÇliorait pas, prenez les dÇcisions qui vous sembleront le plus  appropriÇes...@             AmitiÇs. JULIA DEFRANCK$",
	"Plus tard, Guy vous apprendra le suicide de LÇo...  apräs un pari insensÇ aux courses!$",
	"F3: encore@F8: suite$",
	"Le maåtre des lieux$",
	"Le futur hÇritier$",
	"Le fils de JULIA$",
	...
	"Impossible$",
	"áa tache !$",
	"Un traitÇ sur l'histoire de la rÇgion$",
	"Quelques piäces$",
	"Premier commandement...$",
	"Des pÇtales plein les narines !$",
	"Pique, Coeur...$",
	"áa ne manque pas de cachets !$",
	"Un roman d'amour$",
	...
	"Atchoum! De la p... poussiäre$",
	"La toile est signÇe... pas le papier peint !$",
	"Pas de chance, rien !$",
	"Soyez plus discret !$",
	"Les volets sont clos$",
	"De la neige, encore de la neige !$",
	"GÇnial : une toile de maåtre !$",
	"Aucun doute : une vÇritable imitation$",
	"Hum ! Vous tiquez : de l'antique en toc !$",
	"Une piäce rare de valeur !$",
	"Rien de remarquable$",
	"Linge, objets personnels...$",
	"Pas n'importe oó !$",
	"Ce n'est pas l'heure !$",
	"On ne parle pas la bouche pleine ! Donc, une fois le repas terminÇ...$",
	"Quelqu'un entre, s'affaire, ressort...$",
	"On s'approche de votre cachette !$",
	"On vous surprend !$",
	"Non : vous àtes trop chargÇ !$",
	"Essayez de nouveau$",
	"Vous restez perplexe !?$",
	"Vous quittez le Manoir. A Paris, un message vous attend...$",
	"Aãe, aãe, aãe !$",
	"Rien de plus$",
	"Le son paraåt normal$",
	"Ca ne bouge pas$",
	"On vous rÇpond$",
	"Pas le moment !$",
	"Màme matiäre, autre face !$",
	"Le reflet est piquÇ, mais le cadre est d'or$",
	"Bibelots, babioles...$",
	"Vous essuyez un Çchec !$",
	"Il est des odeurs... qu'il vaut mieux ne pas voir !$",
	"Des produits mÇnagers$",
	"áa vous dÇmange ?$",
	"C'est coincÇ, gelÇ ! Brrrr...$",
	"Les huisseries sont bloquÇes !$",
	"Des papiers...$",
	"Non ! Le päre Noàl n'est pas coincÇ !$",
	"áa donne sur un couloir$",
	...
	"Rien ! Sang et chairs collent Ö la pierre !$",
	"Des dÇtails vous font supposer que... la mort ne fut pas immÇdiate !$",
	"Des projets vÇreux ?$",
	"Sa vie n'aurait-elle tenu qu'Ö un doigt ?$",
	"Un trÇsor se serait-il fait la malle ?$",
	"Une fente de la taille d'une piäce !$",
	"Quelques pierres pivotent... Une crypte ! Y pÇnÇtrez-vous ?$",
	"La bague tourne, le mur se referme...$",
	"Une colonne de pierres derriäre l'autel$",
	"Il y a du bruit...$",
	"OccupÇ !$",
	...
	"Ce n'est pas ouvert$",
	"Il y a dÇjÖ quelque chose$",
	"La porte est fermÇe$",
	"Pas de rÇponse$",
	"Une boule de bois pleine$",
	"Il n'y a plus de place$",
	"Une boule de bois percÇe par le travers$",
	"? ?$",
	"A vous de jouer$",
	"OK !$",
	"Soudain Max survient avec votre  valise : \"Merci de votre visite !  DÇtective \"privÇ\"... de bon sens et de discrÇtion sans doute\" . DÇáu dÇmoralisÇ, vous quittez le manoir@Vous ätes NUL !$",
	"LÇo vous interrompt : \"la tempäte est calmÇe. Je pars en ville dans 1 heure. Tenez-vous pràt!\"... Bon... Vous avez perdu du temps...  mais pas la vie$",
	"Congestion, grippe fatale : vous y restez ! Votre enquäte tombe Ö l'eau$",
	"L'eau monte träs vite et refroidit vos derniäres illusions...  Avant que vous n'ayez eu le temps de rÇagir, vous ätes mort!$",
	"A peine ätes-vous au fond du puits qu'une main tranche la corde... Adieu la vie!$",
	"La tempäte recouvre vos traces . Un mur de silence s'abat sur vos Çpaules . Lentement vous succombez Ö la morsure du froid !$",
	"Pas si seul que áa ! Une lame glacÇe s'enfonce dans votre dos. A l'avenir, soyez plus prudent!$",
	"Vous ignorez la responsabilitÇ exacte de LÇo dans la mort de Murielle... Est-elle morte sur le coup ? De toutes faáons les problämes familiaux dÇcouverts lors de votre enquäte justifient l'attitude de LÇo... Vous n'ätes pas sór que Julia vous ait appelÇ pour áa mais c'est suffisant pour vous ! Par respect pour elle, et apräs  certaines prÇcautions, vous avez une entrevue rÇvÇlatrice avec LÇo$",
	"$",
	"Vous n'avez pas les clefs du Manoir . Vos appels restent sans rÇponse . Vous allez attraper... la mort !$",
	"D'un mouvement circulaire, l'ÇpÇe vous fend par le travers : tripes et boyaux Ö l'air, bonjour les vers!$",
	"Home, Sweet home !$",
	"Mystäre d'une porte close$",
	"Charme envoótant de vieilles piäces$",
	"La faim au ventre$",
	"Plus präs du ciel? Pas sór !$",
	"Peur du noir?$",
	...
	"A la dÇcouverte de...$",
	"Attention Ö ce que cache...$",
	"Une descente aux Enfers !$",
	"Si ce n'est pas dans vos cordes :@       ne soyez pas sot!$",
	"Avant la mise en piäce !$",
	"Gros plan sur :$",
	"Vous remarquez particuliärement...$",
	"Et encore...$",
	"C'est fini !$",
	"Un peu de lecture$",
	...
	"Trop tard$",
	"$",
	"Comme un regard profond tout couvert de peaux-pierres, pointant  son oeil obscur aux astres de lumiäre, il est la gorge reliant le ciel et les enfers . Il faut aller au fond de cette artäre comme un rat au coeur màme de la terre !@Lundi,  Mardi,  Mercredi, Dimanche du 1e lundi au 1e dimanche, tu installeras \"ce rat\" entre chacun des jours . N'omets rien car ta venue serait ta retenue !@Porte ton fardeau comme un oeuf nouveau et donne lui le jour avec force et amour.$",
	"10/1/50: Nous avons rÇsolu le mystäre du manuscrit et localisÇ la crypte . Est-ce l'idÇe d'aboutir dans ce qui n'Çtait qu'un \"räve\" qui me rend si anxieuse ?@Je regrette de m'àtre engagÇe vis Ö vis de LÇo . Non! je dois continuer ! J'aurais dó mettre Guy au courant... mais, depuis une semaine, je n'ai aucune nouvelle .$",
	"Porte ta priäre au lieu saint qui se doit, changes-en l'air, tu auras la matiäre !@Du pilier de la haute sagesse, le soleil aux genoux te montrera l'espace par lequel ton Öme s'ouvrira un chemin et gagnera son äre . Avance comme un OrphÇe peu soucieux des tÇnäbres : le blanc est ta couleur, l'or ta demeure . Eclaire ton chemin jusqu'Ö la mystÇrieuse . Offre-lui le cercle de l'homme aux trois facettes . Qu'il regagne le monde et qu'il tourne avec lui dans la richesse premiäre.$",
	"Les montagnes sont les crocs d'une gueule dantesque ouverte Ö l'infini de quelqu' orgie cÇleste, mastiquant des Çtoiles comme nous broyons du noir .@Tu dÇposeras l'accord de pierre Ö tes pieds, le rire du silence sur la gamme d'en haut et dans ta main droite, une toile d'un mätre . Tu passeras ainsi entre les deux croissants, par delÖ les abåmes du Mur du Silence . La ClÇ des champs est Ö ta portÇe, tu n'as qu'Ö retrouver la note qui dÇnote.$",
	"                DECEMBRE@   9 REMISE     518    13 AGIOS       23@  19 VIREMENT  1203    17 TRESOR    1598@      TOTAL     1721        TOTAL    1721$",
	"  Le 5/01/51@@              Luc, mon amour@ Guy connaåt notre liaison . A la suite d'une dispute, je lui ai tout dit . Je ne pense qu'Ö toi !  Max me relance mais j'ai dÇfinitivement rompu avec lui . Qu'il reste Ö ses gamelles . Quand pourrons-nous nous voir seuls ? Pour toi je divorcerai...   Je t'aime .@             ton Eva$",
	"  Mortevielle, le 10/2/51@@              Pat,@ Je te rappelle que tu me dois  50000 F que je t'ai prÇtÇs pour ton affaire . J'en ai besoin, peux-tu me les rendre assez vite?@              Guy$",
	"  Mortevielle, le 15/2/51@              Maåtre,@ Je vous Çcris au sujet de notre affaire.  Je suis dÇcidÇ  Ö aller jusqu'au bout, certain que mon associÇ, Pat DEFRANCK, a falsifiÇ  un livre de comptes . MalgrÇ$",
	" Une pipe$",
	" Un stylo Ö plume$",
	" Un briquet Ö essence$",
	" Une cornue$",
	" Un blaireau$",
	" Un pot de peinture$",
	" Une flute$",
	...
	"C'est le massif montagneux que l'on aperáoit devant le manoir$",
	"Je n'en sais rien !$",
	"Elle est morte d'une embolie pulmonaire$",
	"Ma mÇre est morte soudainement . Son Çtat semblait pourtant s'àtre amÇliorÇ$",
	"Madame DEFRANCK est morte d'un coup de froid$",
	"Elle est morte d'une embolie pulmonaire$",
	"Pardonnez moi mais je prÇfäre, actuellement garder le silence$",
	"Ce sont toujours les meilleurs qui partent les premiers$",
	"J'aimais beaucoup ma märe . Je regrette seulement qu'elle soit morte dans le manoir des DEFRANCK$",
	"C'est une rÇgion qui a un passÇ chargÇ et j'ai largement de quoi m'occuper . Et puis j'aime beaucoup les chevaux..$",
	"C'est un passionnÇ d'histoire et un joueur invÇtÇrÇ . D'ailleurs, voici un an il a gagnÇ une grosse somme$",
	"Il a dÇjÖ beaucoup a faire avec la gestion et l'entretien du manoir...$",
	"Je suis PDG d'une petite sociÇtÇ de parfums . Mais quand je suis ici, je me repose$",
	"C'est un homme dynamique qui a rÇussi dans le parfum$",
	"Lui ! C'est un arriviste vÇreux ! Les parfums ont du endormir son bon sens . D'ailleurs ici il passe ses soirÇes dans sa chambre$",
	"J'ai ÇtÇ träs prÇoccupÇ par la santÇ de ma märe, et maintenant je n'ai plus goñt Ö rien$",
	"Il aurait mieux fait de s'occuper un peu plus de moi et un peu moins de sa märe$",
	"Ce sont ses affaires...$",
	"Il n'a pas trop de chance en ce moment bien que ses affaires soient satisfaisantes$",
	"Je travaille avec Pat mais áa ne va pas träs fort en ce moment$",
	"Ah oui ?! Il a des occupations ? Il ferait bien de s'en occuper sÇrieusement alors$",
	"Lui et Pat sont associÇs . Je crois que áa ne va pas trop mal$",
	"Je m'occupe de moi et c'est dÇjÖ beaucoup . Et vous ?$",
	"Oh áa ! Je lui fais confiance . Elle sait s'occuper$",
	"Mais ! Vous n'avez pas encore dÇcouvert son occupation principale..?$",
	"Elle fait dans la dÇcoration avec beaucoup degoñt d'ailleurs. Elle est toujours träs bien habillÇe$",
	"Si les bijoux vous interessent, j'ai quelques affaires interessantes Ö saisir rapidement$",
	"Les bijoux...$",
	"Je ne sais pas, mais j'aimerais bien qu'il s'occupe un peu moins de mes affaires !$",
	"Quand on est une femme d'intÇrieur on trouve toujours de quoi s'occuper...$",
	"Elle pourrait rester sans rien faire, mais non ! Elle coud, elle lit ...$",
	"Elle n'a sñrement pas des occupations träs Çpanouissantes ...$",
	"Une femme comme il n'y en a plus : Elle s'interesse a tout !$",
	"Entre la cuisine et le mÇnage, je n'ai pas beaucoup de temps Ö vous accorder$",
	"Je ne sais pas comment il s'y prend pour tout faire . C'est merveilleux !$",
	"Il en ferait plus si il s'occupait moins des ragìts et de la bouteille$",
	"Je suis träs indÇpendant . Tant qu'on ne s'occupe pas de mes affaires : Pas de probläme$",
	"C'est un Çgoãste . Je me demande si il aime autre chose que ses chevaux et ses grimoires$",
	"Je crois qu'il s'entend bien avec tout le monde, mis Ö part, peut àtre, avec Guy$",
	"C'est un homme de caractäre . Il faut savoir le prendre ..$",
	"Les affaires sont les affaires . Quant Ö la famille, je la laisse pour ce qu'elle est ...$",
	"Relations ? Relations amicales ? Relations financiäres sans doute$",
	"Moi je n'ai rien Ö lui reprocher$",
	"C'est un homme d'affaire dÇbrouillard . Il nage parfois Ö contre-courant mais ... il s'en sortira toujours$",
	"Ils m'ennuient tous .. Non ! Ce n'est màme pas áa .. Quoique .. certains ..$",
	"A l'inverse de sa märe, c'est une personne träs renfermÇe ! Alors question relations ..$",
	"Il doit sans doute faire beaucoup d'effort pour rester agrÇable malgrÇ tous ses ennuis$",
	"Ses relations amoureuses : C'est terminÇ . Ses relations avec moi : Pas vraiment commencÇes . Quant aux autres : Je ne suis pas les \"autres\"$",
	"J'aime bien tout le monde, tant qu'on ne m'escroque pas$",
	"Il ne suffit pas d'avoir un peu d'argent et d'àtre beau parleur pour plaire Ö tout le monde$",
	"Sans histoire .. C'est quelqu'un d'agrÇable et gÇnÇreux . De plus, il ne manque pas d'humour$",
	"Actuellement je m'entends plutìt bien avec tout le monde . Mais, ici, je ne vais pas m'Çtendre sur le sujet$",
	"Beau plumage, mais áa ne vole pas haut ... Parlez en Ö son mari$",
	"C'est pour un rendez-vous ?$",
	"Elle est träs vivante ! Elle ne s'embarrasse pas de prÇjugÇs stupides$",
	"Dans mon mÇtier, on cìtoit surtout des belles femmes et des truands$",
	"La seule valeur sñre chez lui, c'est ses bijoux .. Et sa femme, mais áa il ne s'en rend pas compte$",
	"C'est quelqu'un d'interessant . De pas toujours facile Ö comprendre, mais qui mÇrite le dÇtour$",
	"Je ne dÇteste personne, mais j'aime les choses et les gens quand ils sont Ö leur place$",
	"C'est entre nous . Mais voyez : quand je parle avec elle, je me sens vite Ö l'Çtroit !$",
	"Pour ne pas s'entendre avec elle, faut y mettre de la mauvaise volontÇ$",
	"Vous savez dans mon mÇtier on entend tout mais on ne retient rien, et le service est bien fait$",
	"C'est un hypocrite, un larbin ! Personnellement je ne lui fais pas confiance$",
	"Je ne connait pas le fond de sa pensÇe mais c'est quelqu'un de toujours träs correct et impeccable$",
	"C'Çtait une personne qui a vÇcu au manoir, il y a un an .. peut àtre plus$",
	"C'Çtait plus qu'une amie pour ma märe . En ces moments, j'aurais aimÇ qu'elle soit Ö mes cotÇs$",
	"Murielle a ÇtÇ la dame de compagnie de Julia$",
	"Elle aussi, faisait des recherches ...$",
	"C'Çtait une femme träs cultivÇe . Son brusque dÇpart, il y a un an, m'a surpris et beaucoup chagrinÇ$",
	"Elle partageait avec LÇo sa passion de l'histoire et de la rÇgion$",
	"Je crois que tout le monde l'aimait bien$",
	"Elle s'entendait bien avec tout le monde . Elle aimait beaucoup son fils . Quant aux relations belle-märe, belle-fille ..$",
	"A part LÇo, elle avait de träs bon rapport avec Max ...$",
	"Bien que vos relations furent peu soutenues, JÇrìme, elle vous portait toujours dans son coeur ...$",
	"A part sa famille, pas grand monde$",
	"Ah oui ! Je crois qu'elle a beaucoup regrettÇ le dÇpart de cette amie .. euh ! Marielle .. ou Mireille ...$",
	"Non rien !$",
	"Non ... Pas que le sache$",
	"J'ai connu Julia en achetant le manoir . C'Çtait son seul bien . Mais toute ma fortune Çtait la sienne ...$",
	"Si ce n'est quelques objets personnels, je crois qu'elle n'avait plus rien Ö elle$",
	"Je crois que toute sa fortune venait de LÇo . Alors, Pfuuut !$",
	"A part la lettre pour vous que j'ai postÇ, rien de bien important !$",
	"J'ai ÇtÇ träs heureuse qu'elle m'offre sa bible reliÇe$",
	"Ca a ÇtÇ rapide et elle n'a pas eu le temps de prendre des dispositions particuliäres$",
	"Son dernier prÇsent m'a surpris$",
	"Quel cadeau ?$",
	"Un chandellier ...$",
	"Oui, j'ai eu un cadeau . Ma femme a màme eu une bible$",
	"Et bien oui ! Comme tout le monde, je crois$",
	"Un poignard$",
	"Je n'ai jamais ÇtÇ fouiller dans le grenier !$",
	...
	"Elle Çtait träs charmante, mais c'Çtait surtout la dame de compagnie de Julia$",
	"C'est la seule femme vraiment interessante que j'ai rencontrÇ$",
	"Elle avait de grandes connaissances historiques, et la consulter Çtait träs enrichissant$",
	"Je me suis toujours demandÇ ce que certains pouvaient lui trouver !$",
	"Si la chambre est fermÇe, demandez Ö LÇo$",
	"J'ai fermÇ sa chambre apräs sa mort et j'aimerais qu'il en soit ainsi encore un certain temps$",
	"Vous savez ce que c'est : Des relations familiales$",
	"Durant toutes ces annÇes, je ne l'ai jamais servie Ö contre-coeur$",
	"Je l'aimais autant qu'elle m'aimais, je crois$",
	"De quel droit avez-vous pÇnÇtrÇ dans la chambre de ma femme ?!!$",
	"C'est sans doute la photo de Murielle avec le filleul de Julia$",
	"Je ne me rappelle pas$",
	"C'est Murielle . C'est moi qui l'ai prise. et d'ailleurs elle est tirÇe Ö l'envers$",
	"Vous àtes bien curieux !... C'est sans valeur$",
	"Grimoires, parchemins et manuscrits : C'est le domaine de LÇo$",
	"Dommage que la devise soit manquante ...$",
	"C'est träs beau ... Et träs vieux ...$",
	"Tiens ! C'est un endroit que je n'ai jamais visitÇ$",
	"D'aprÇs LÇo, il semblerait que les Lunes soient plus rÇcentes$",
	"Màme par ce temps, vous avez dÇnichÇ un soleil ...$",
	"Profond et inquiÇtant : Le progräs a du bon$",
	"Ca reste pour moi le plus grand des mystäres$",
	"Les derniers temps elle parlait d'un voyage . Et puis ...$",
	"Il y a un peu plus d'un an, un soir, elle a dÇcidÇ de partir ...$",
	"De toutes faáons elle n'Çtait pas faite pour vivre ici$",
	"Quoi ?! Quel corps ? Quel crypte ?$",
	"Si il y en a, je ne les ai jamais trouvÇ ...$",
	"Bien sñr ! ... Et des fantìmes aussi ...$",
	"C'est la plus vielle de la rÇgion : Elle date du XI eme siäcle$",
	"Elle fut lÇgärement restaurÇe apräs la rÇvolution$",
	"Julia aimait beaucoup la peinture$",
	"Ils ont diffÇrents styles, mais n'ont pas tous une träs grande valeur$",
	"Que faites-vous lÖ ?$",
	"Je suis sñr que vous cherchez quelque chose ici$",
	"Je vous Çcoute$",
	"Que dÇsirez-vous ?$",
	"Oui ?$",
	"Je suis Ö vous ...$",
	...
	"Allez-y$",
	"C'est Ö quel sujet ?$",
	"Max : Ö votre service, monsieur$",
	"De toutes faáons vous n'avez rien Ö faire ici ! Sortez !!$",
	"Vous àtes trop curieux !$",
	"JÇrìme ! Il y a longtemps ... Quelle tristesse, Julia est morte . Sa famille est ici : Guy, son fils . Eva, sa brue . LÇo, son mari bien sñr . Son beau fils, Pat . Des cousins : Bob, Ida, Luc . La tempäte redouble, il vous faut rester . Les repas sont Ö 12h et 19h et il y a un recueillement Ö la chapelle tous les jours Ö 10h$",
	"En vous voyant j'ai compris que vous decouvririez la vÇritÇ ... Car je savais pourquoi vous veniez : J'avais retrouvÇ le brouillon de la lettre de Julia . Mais je suis träs joueur, alors ... Elle n'avait pas voulu que votre tÉche soit trop facile, pour me protÇger, sans doute, mais elle n'a pu mourir avec cette incertitude sur la conscience . Avez vous dÇcouvert que le mur du silence est le nom que les maáons ont donnÇ au mur qui porte ce blason, lors de la construction du manoir ? .. Et ces cadeaux que Julia a laissÇ avant de mourir Çtaient autant de faux indices qui ne servaient qu'Ö faire ressortir l'importance des parchemins ... Effectivement, il y a plus d'un an, je travailais avec Murielle au dÇcryptage de ces manuscrits que je venais de trouver . Ma femme a fait la relation entre notre travail et la disparition de Murielle mais elle n'a jamais eu de preuves . Si ce n'est cette bague qu'elle a retrouvÇ un jour dans mes affaires . Une nuit, nous nous sommes aventurÇs dans le passage secret que nous avions dÇcouvert . Murielle est morte par accident dans la piäce de la vierge . J'ai rÇcupÇrÇ la bague rapidement, trouvÇ le trÇsor et me suis enfuis . Je ne pensais pas qu'elle vivait encore, et je n'ai rien dit car j'avais besoin d'argent . J'ai fait passer cette somme sur le compte des courses de chevaux ...Partez maintenant, puisque vous n'àtes pas de la police . Laissez moi seul !$",
	"FÇvrier 1951 ... Profession : detective privÇ . Le froid figeait Paris et mes affaires lorsque ...$",
	"Une lettre, un appel, des souvenirs d'une enfance encore proche . Que de jeux dans les piäces dÇlabrÇes du manoir de Mortevielle . Julia, une vieille femme a prÇsent .$",
	" au bureau$",
	" Ö la cuisine$",
	" Ö la cave$",
	" dans le couloir$",
	...
	"Elle s'est suicidÇe$",
	"Elle est morte assassinÇe$",
	"Elle est morte accidentellement$",
	"Elle est morte naturellement$",
	"D'oó provenait l'argent qui a permis la restauration du manoir ?$",
	"chantage$",
	"travail$",
	"hÇritage$",
	"courses$",
	...
	"Julia a laissÇ une sÇrie d'indices . Ceux-ci sont reprÇsentÇs en un seul lieu . Lequel ?$",
	"Chapelle$",
	"ExtÇrieur$",
	"Cave$",
	"Grenier$",
	...
	"Chambre Luc/Ida$",
	"Chambre Guy/Eva$",
	"L'indice principal qui vous a permis d'arriver Ö la porte du souterrain est :$",
	"Un poignard$",
	"Une bague$",
	"Un livre$",
	"Un parchemin$",
	...
	"Quatre$",
	"Cinq$",
	"Combien de personnes sont mÇlÇes Ö cette histoire - Julia y comprise, vous exceptÇ - ?$",
	"Neuf$",
	"Dix$",
	"Onze$",
	"Quel Çtait le prÇnom de la personne inconnue ?$",
	"Mireille$",
	"Franáoise$",
	"Maguy$",
	"Emilie$",
	"Murielle$",
	"Sophie$",
	"De qui Murielle Çtait-elle la maåtresse ?$",
	"Bob$",
	"Luc$",
	"Guy$",
	"LÇo$",
	...
	"[1][ |Seul le hazard vous a permis d'arriver ici . Vous prÇfÇrez|retourner enquÇter afin de mieux comprendre ...][ok]$",
	"[1][ |InsÇrez la disquette 1 dans le lecteur A][ok]$",
	"[1][ |! ERREUR DISQUETTE !|On arrete tout][ok]$",
	"[1][ |Vous devriez avoir remarquÇ|00% des indices][ok]$",
	"[1][ |InsÇrez la disquette 2 dans le lecteur A][ok]$",
	"[1][ |Avant d'aller plus loin, vous faites|un point sur l'Çtat de vos connaissances][ok]$",
	" MASTER .$",
	"  rorL$",
};

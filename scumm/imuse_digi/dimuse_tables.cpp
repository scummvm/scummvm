...
const imuseDigTable _digStateMusicTable[] = {
	...
	{3, 1140, "stateAstInside",      0, 0, "ASTERO~3.IMU"},
	{3, 1150, "stateAstCore",        0, 2, "ASTERO~4.IMU"},
	{3, 1200, "stateCanyonClose",    0, 1, "CANYON~1.IMU"},
	{3, 1205, "stateCanyonClose_m",  0, 0, "CANYON~2.IMU"},
	{3, 1210, "stateCanyonOver",     0, 1, "CANYON~3.IMU"},
	{3, 1220, "stateCanyonWreck",    0, 1, "CANYON~4.IMU"},
	{3, 1300, "stateNexusCanyon",   10, 0, "NEXUS(~1.IMU"},
	{3, 1310, "stateNexusPlan",     10, 0, "NEXUS(~1.IMU"},
	{3, 1320, "stateNexusRamp",     10, 0, "NEXUS(~2.IMU"},
	{3, 1330, "stateNexusMuseum",   10, 0, "NEXUS(~3.IMU"},
	{3, 1340, "stateNexusMap",      10, 0, "NEXUS(~4.IMU"},
	{3, 1350, "stateNexusTomb",     10, 0, "NE3706~5.IMU"},
	{3, 1360, "stateNexusCath",     10, 0, "NE3305~5.IMU"},
	{3, 1370, "stateNexusAirlock",   0, 0, "NE2D3A~5.IMU"},
	{3, 1380, "stateNexusPowerOff",  0, 1, "NE8522~5.IMU"},
	{3, 1400, "stateMuseumTramNear", 0, 1, "TRAM(M~1.IMU"},
	{3, 1410, "stateMuseumTramFar",  0, 0, "TRAM(M~2.IMU"},
	{3, 1420, "stateMuseumLockup",   0, 0, "MUSEUM~1.IMU"},
	{3, 1433, "stateMuseumPool",    22, 1, "MUSEUM~2.IMU"},
	{3, 1436, "stateMuseumSpire",   22, 2, "MUSEUM~3.IMU"},
	{3, 1440, "stateMuseumMuseum",  22, 2, "MUSEUM~4.IMU"},
	{3, 1450, "stateMuseumLibrary",  0, 0, "MUB575~5.IMU"},
	{3, 1460, "stateMuseumCavern",   0, 0, "MUF9BE~5.IMU"},
	{3, 1500, "stateTombTramNear",   0, 1, "TRAM(T~1.IMU"},
	{3, 1510, "stateTombBase",      28, 2, "TOMB(A~1.IMU"},
	{3, 1520, "stateTombSpire",     28, 2, "TOMB(A~2.IMU"},
	{3, 1530, "stateTombCave",      28, 2, "TOMB(A~3.IMU"},
	{3, 1540, "stateTombCrypt",     31, 1, "TOMB(C~1.IMU"},
	{3, 1550, "stateTombGuards",    31, 1, "TOMB(C~2.IMU"},
	{3, 1560, "stateTombInner",      0, 1, "TOMB(I~1.IMU"},
	{3, 1570, "stateTombCreator1",   0, 0, "TOMB(C~3.IMU"},
	{3, 1580, "stateTombCreator2",   0, 0, "TOMB(C~4.IMU"},
	{3, 1600, "statePlanTramNear",   0, 1, "TRAM(P~1.IMU"},
	{3, 1610, "statePlanTramFar",    0, 0, "TRAM(P~2.IMU"},
	{3, 1620, "statePlanBase",      38, 2, "PLAN(A~1.IMU"},
	{3, 1630, "statePlanSpire",     38, 2, "PLAN(A~2.IMU"},
	{3, 1650, "statePlanDome",       0, 0, "PLAN(D~1.IMU"},
	{3, 1700, "stateMapTramNear",    0, 1, "TRAM(M~3.IMU"},
	{3, 1710, "stateMapTramFar",     0, 0, "TRAM(M~4.IMU"},
	{3, 1720, "stateMapCanyon",     43, 2, "MAP(AM~1.IMU"},
	{3, 1730, "stateMapExposed",    43, 2, "MAP(AM~2.IMU"},
	{3, 1750, "stateMapNestEmpty",  43, 2, "MAP(AM~4.IMU"},
	{3, 1760, "stateMapNestMonster", 0, 0, "MAP(MO~1.IMU"},
	{3, 1770, "stateMapKlein",       0, 0, "MAP(KL~1.IMU"},
	{3, 1800, "stateCathTramNear",   0, 1, "TRAM(C~1.IMU"},
	{3, 1810, "stateCathTramFar",    0, 0, "TRAM(C~2.IMU"},
	{3, 1820, "stateCathLab",       50, 1, "CATH(A~1.IMU"},
	{3, 1830, "stateCathOutside",   50, 1, "CATH(A~2.IMU"},
	{3, 1900, "stateWorldMuseum",   52, 0, "WORLD(~1.IMU"},
	{3, 1901, "stateWorldPlan",     52, 0, "WORLD(~2.IMU"},
	{3, 1902, "stateWorldTomb",     52, 0, "WORLD(~3.IMU"},
	{3, 1903, "stateWorldMap",      52, 0, "WORLD(~4.IMU"},
	{3, 1904, "stateWorldCath",     52, 0, "WO3227~5.IMU"},
	{3, 1910, "stateEye1",           0, 0, "EYE1~1.IMU"},
	{3, 1911, "stateEye2",           0, 0, "EYE2~1.IMU"},
	{3, 1912, "stateEye3",           0, 0, "EYE3~1.IMU"},
	{3, 1913, "stateEye4",           0, 0, "EYE4~1.IMU"},
	{3, 1914, "stateEye5",           0, 0, "EYE5~1.IMU"},
	{3, 1915, "stateEye6",           0, 0, "EYE6~1.IMU"},
	{3, 1916, "stateEye7",           0, 0, "EYE7~1.IMU"},
	{0,   -1,  "",                   0, 0, ""}
};
...
const imuseComiTable _comiStateMusicTable[] = {
	...
	{3, 1098, "stateCredits1",      0, 0,   60, "1098-C~1.IMX"},
	{3, 1099, "stateMenu",          0, 0,   60, "1099-M~1.IMX"},
	{3, 1100, "stateHold1",         4, 0,   60, "1100-H~1.IMX"},
	{3, 1101, "stateWaterline1",    4, 0,   60, "1101-W~1.IMX"},
	{3, 1102, "stateHold2",         6, 1,   60, "1102-H~1.IMX"},
	{3, 1103, "stateWaterline2",    6, 0,   60, "1103-W~1.IMX"},
	{3, 1104, "stateCannon",        0, 0,   60, "1104-C~1.IMX"},
	{3, 1105, "stateTreasure",      0, 0,   60, "1105-T~1.IMX"},
	{3, 1200, "stateFortBase",     10, 1,   60, "1200-F~1.IMX"},
	{3, 1201, "statePreFort",      10, 1,   60, "1201-P~1.IMX"},
	{3, 1202, "statePreVooOut",    12, 0,   60, "1202-P~1.IMX"},
	{3, 1203, "statePreVooIn",     12, 0,   60, "1203-P~1.IMX"},
	{3, 1204, "statePreVooLady",   12, 0,   60, "1204-P~1.IMX"},
	{3, 1205, "stateVoodooOut",     0, 0,   60, "1205-V~1.IMX"},
	{3, 1210, "stateVoodooIn",      0, 0,   60, "1210-V~1.IMX"},
	{12,1212, "stateVoodooInAlt",   0, 1,   42, "1210-V~1.IMX"},
	{3, 1215, "stateVoodooLady",    0, 0,   60, "1215-V~1.IMX"},
	{3, 1219, "statePrePlundermap", 0, 0,   60, "1219-P~1.IMX"},
	{3, 1220, "statePlundermap",    0, 0,   60, "1220-P~1.IMX"},
	{3, 1222, "statePreCabana",     0, 0,   60, "1222-P~1.IMX"},
	{3, 1223, "stateCabana",        0, 0,   60, "1223-C~1.IMX"},
	{3, 1224, "statePostCabana",   23, 0,   60, "1224-P~1.IMX"},
	{3, 1225, "stateBeachClub",    23, 0,   60, "1225-B~1.IMX"},
	{3, 1230, "stateCliff",         0, 0,   60, "1230-C~1.IMX"},
	{3, 1232, "stateBelly",         0, 0,   48, "1232-B~1.IMX"},
	{3, 1235, "stateQuicksand",     0, 0,   60, "1235-Q~1.IMX"},
	{3, 1240, "stateDangerBeach",   0, 0,   48, "1240-D~1.IMX"},
	{12,1241, "stateDangerBeachAlt",0, 2,   48, "1240-D~1.IMX"},
	{3, 1245, "stateRowBoat",       0, 0,   60, "1245-R~1.IMX"},
	{3, 1247, "stateAlongside",     0, 0,   48, "1247-A~1.IMX"},
	{12,1248, "stateAlongsideAlt",  0, 1,   48, "1247-A~1.IMX"},
	{3, 1250, "stateChimpBoat",     0, 0,   30, "1250-C~1.IMX"},
	{3, 1255, "stateMrFossey",      0, 0,   48, "1255-M~1.IMX"},
	{3, 1259, "statePreTown",       0, 0,   60, "1259-P~1.IMX"},
	{3, 1260, "stateTown",          0, 0,   60, "1260-T~1.IMX"},
	{3, 1264, "statePreMeadow",     0, 0,   60, "1264-P~1.IMX"},
	{3, 1265, "stateMeadow",        0, 0,   60, "1265-M~1.IMX"},
	{3, 1266, "stateMeadowAmb",     0, 0,   60, "1266-M~1.IMX"},
	{3, 1270, "stateWardrobePre",  40, 0,   60, "1270-W~1.IMX"},
	{3, 1272, "statePreShow",      40, 0,   60, "1272-P~1.IMX"},
	{3, 1274, "stateWardrobeShow", 42, 0,   60, "1274-W~1.IMX"},
	{3, 1276, "stateShow",         42, 0,   60, "1276-S~1.IMX"},
	{3, 1277, "stateWardrobeJug",  44, 0,   60, "1277-W~1.IMX"},
	{3, 1278, "stateJuggling",     44, 0,   60, "1278-J~1.IMX"},
	{3, 1279, "statePostShow",      0, 0,   60, "1279-P~1.IMX"},
	{3, 1280, "stateChickenShop",   0, 0,   60, "1280-C~1.IMX"},
	{3, 1285, "stateBarberShop",   48, 0,   60, "1285-B~1.IMX"},
	{3, 1286, "stateVanHelgen",    48, 0,   60, "1286-V~1.IMX"},
	{3, 1287, "stateBill",         48, 0,   60, "1287-B~1.IMX"},
	{3, 1288, "stateHaggis",       48, 0,   60, "1288-H~1.IMX"},
	{3, 1289, "stateRottingham",   48, 0,   60, "1289-R~1.IMX"},
	{3, 1305, "stateDeck",          0, 0,   60, "1305-D~1.IMX"},
	{3, 1310, "stateCombatMap",     0, 0,   60, "1310-C~1.IMX"},
	{3, 1320, "stateShipCombat",    0, 0,   60, "1320-S~1.IMX"},
	{3, 1325, "stateSwordfight",    0, 0,   60, "1325-S~1.IMX"},
	{3, 1327, "stateSwordRott",     0, 0,   60, "1327-S~1.IMX"},
	{3, 1330, "stateTownEdge",      0, 0,   60, "1330-T~1.IMX"},
	{3, 1335, "stateSwordLose",     0, 0,   60, "1335-S~1.IMX"},
	{3, 1340, "stateSwordWin",      0, 0,   60, "1340-S~1.IMX"},
	{3, 1345, "stateGetMap",        0, 0,   60, "1345-G~1.IMX"},
	{3, 1400, "stateWreckBeach",    0, 0,   60, "1400-W~1.IMX"},
	{3, 1405, "stateBloodMap",     63, 0,   60, "1405-B~1.IMX"},
	{3, 1410, "stateClearing",      0, 0,   60, "1410-C~1.IMX"},
	{3, 1415, "stateLighthouse",   63, 0,   60, "1415-L~1.IMX"},
	{3, 1420, "stateVillage",      66, 0,   60, "1420-V~1.IMX"},
	{3, 1423, "stateVolcano",      66, 0,   60, "1423-V~1.IMX"},
	{3, 1425, "stateAltar",        66, 0,   60, "1425-A~1.IMX"},
	{3, 1430, "stateHotelOut",      0, 0,   60, "1430-H~1.IMX"},
	{3, 1435, "stateHotelBar",     70, 0,   60, "1435-H~1.IMX"},
	{3, 1440, "stateHotelIn",      70, 0,   60, "1440-H~1.IMX"},
	{3, 1445, "stateTarotLady",    70, 0,   60, "1445-T~1.IMX"},
	{3, 1447, "stateGoodsoup",     70, 0,   60, "1447-G~1.IMX"},
	{3, 1448, "stateGuestRoom",     0, 0,   60, "1448-G~1.IMX"},
	{3, 1450, "stateWindmill",     63, 0,   60, "1450-W~1.IMX"},
	{3, 1455, "stateCemetary",      0, 0,   60, "1455-C~1.IMX"},
	{3, 1460, "stateCrypt",        77, 0,   60, "1460-C~1.IMX"},
	{3, 1463, "stateGraveDigger",  77, 0,   60, "1463-G~1.IMX"},
	{3, 1465, "stateMonkey1",       0, 0,   60, "1465-M~1.IMX"},
	{3, 1475, "stateStanDark",      0, 0,   60, "1475-S~1.IMX"},
	{3, 1477, "stateStanLight",     0, 0,   60, "1477-S~1.IMX"},
	{3, 1480, "stateEggBeach",     63, 0,   60, "1480-E~1.IMX"},
	{3, 1485, "stateSkullIsland",   0, 0,   60, "1485-S~1.IMX"},
	{3, 1490, "stateSmugglersCave", 0, 0,   60, "1490-S~1.IMX"},
	{3, 1500, "stateLeChuckTalk",   0, 0,   60, "1500-L~1.IMX"},
	{3, 1505, "stateCarnival",      0, 0,   60, "1505-C~1.IMX"},
	{3, 1511, "stateHang",         87, 0,   60, "1511-H~1.IMX"},
	{3, 1512, "stateRum",          87, 0,   60, "1512-RUM.IMX"},
	{3, 1513, "stateTorture",      87, 0,   60, "1513-T~1.IMX"},
	{3, 1514, "stateSnow",         87, 0,   60, "1514-S~1.IMX"},
	{3, 1515, "stateCredits",       0, 0,   60, "1515-C~1.IMX"},
	{3, 1520, "stateCarnAmb",       0, 0,   60, "1520-C~1.IMX"},
	{0,   -1, "",                   0, 0,    0, ""}
};

...
#define GS_SET_DISPLAY(width, height, xpos, ypos) \
	(((uint64)(height - 1) << 44) | ((uint64)0x9FF << 32) | ((((2560 + (width - 1)) / width) - 1) << 23) | (ypos << 12) | (xpos * (2560 / width)))

#define GS_SET_DISPLAY_MODE(mode) \
	(((uint64)(mode.h - 1) << 44) | ((uint64)(mode.vclk - 1) << 32) | ((mode.magh - 1) << 23) | (mode.dy << 12) | (mode.dx << 2))
...
#define GS_SET_TEX0(tbp, tbw, psm, tw, th, tcc, tfx, cbp, cpsm, csm, csa, cld) \
	((uint64)(tbp) | ((uint64)(tbw) << 14) | ((uint64)(psm) << 20) | ((uint64)(tw) << 26) | ((uint64)(th) << 30) | ((uint64)(tcc) << 34) | ((uint64)(tfx) << 35) | ((uint64)(cbp) << 37) | ((uint64)(cpsm) << 51) | ((uint64)(csm) << 55) | ((uint64)(csa) << 56) | ((uint64)(cld) << 61))

#define GIF_SET_TAG(nloop, eop, pre, prim, flg, nreg) \
	((uint64)(nloop) | ((uint64)(eop) << 15) | ((uint64)(pre) << 46) | ((uint64)(prim) << 47) | ((uint64)(flg) << 58) | ((uint64)(nreg) << 60))
...
#define GS_SET_TEST(ate, atst, aref, afail, date, datm, zte, ztst) \
	((uint64)(ate) | ((uint64)(atst) << 1) | ((uint64)(aref) << 4) | ((uint64)(afail) << 12) | ((uint64)(date) << 14) | ((uint64)(datm) << 15) | ((uint64)(zte) << 16) | ((uint64)(ztst) << 17))

#define FILTER_NEAREST 0
#define FILTER_LINEAR 1

#define GS_SET_TEX1(lcm, mxl, mmag, mmin, mtba, l, k) \
	((uint64)(lcm) | ((uint64)(mxl) << 2) | ((uint64)(mmag) << 5) | ((uint64)(mmin) << 6) | ((uint64)(mtba) << 9) | ((uint64)(l) << 19) | ((uint64)(k) << 32))
...
#define GS_SET_PRIM(prim, iip, tme, fge, abe, aa1, fst, ctxt, fix) \
	((uint64)(prim) | ((uint64)(iip) << 3) | ((uint64)(tme) << 4) | ((uint64)(fge) << 5) | ((uint64)(abe) << 6) | ((uint64)(aa1) << 7) | ((uint64)(fst) << 8) | ((uint64)(ctxt) << 9) | ((uint64)(fix) << 10))

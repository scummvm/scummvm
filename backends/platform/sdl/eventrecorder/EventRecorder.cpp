...
#ifdef SDL_BACKEND
#include "backends/platform/sdl/eventrecorder/onscreendialog.h"
#endif
...
namespace Common {
DECLARE_SINGLETON(Backends::EventRecorder::EventRecorder);
}
...
void EventRecorder::init(Common::String recordFileName, RecordMode mode) {
	...
	if (_recordMode != kPassthrough) {
		_controlPanel = new OnScreenDialog(_recordMode == kRecorderRecord);
	}
	if (_recordMode == kRecorderPlayback) {

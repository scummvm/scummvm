...
cd dist-generic
mv scummvm scummvm-2.9.2pre-atari-lite
zip -r -9 scummvm-2.9.2pre-atari-lite.zip scummvm-2.9.2pre-atari-lite
cd -

mv dist-generic/scummvm-2.9.2pre-atari-lite.zip ..

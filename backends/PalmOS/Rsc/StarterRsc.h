...
//
//	Generated at 12:17:05  on vendredi 13 février 2004
//
...
#define MiscOptionsOKButton                       1670	//(Left Origin = 5, Top Origin = 139, Width = 36, Height = 12, Usable = 1, Anchor Left = 1, Frame = 1, Non-bold Frame = 1, Font = Standard)
#define MiscOptionsCancelButton                   1671	//(Left Origin = 46, Top Origin = 139, Width = 36, Height = 12, Usable = 1, Anchor Left = 1, Frame = 1, Non-bold Frame = 1, Font = Standard)
#define MiscOptionsVibratorCheckbox               1601	//(Left Origin = 4, Top Origin = 45, Width = 128, Height = 12, Usable = 1, Selected = 0, Group ID = 0, Font = Standard)
#define MiscOptionsNoAutoOffCheckbox              1602	//(Left Origin = 4, Top Origin = 52, Width = 152, Height = 12, Usable = 1, Selected = 0, Group ID = 0, Font = Standard)
#define MiscOptionsStdPaletteCheckbox             1603	//(Left Origin = 4, Top Origin = 59, Width = 146, Height = 12, Usable = 1, Selected = 0, Group ID = 0, Font = Standard)
#define MiscOptionsAutoResetCheckbox              1604	//(Left Origin = 4, Top Origin = 66, Width = 105, Height = 12, Usable = 1, Selected = 0, Group ID = 0, Font = Standard)
#define MiscOptionsLargerStackCheckbox            1605	//(Left Origin = 4, Top Origin = 73, Width = 100, Height = 12, Usable = 1, Selected = 0, Group ID = 0, Font = Standard)
#define MiscOptionsFullscreenCheckbox             1621	//(Left Origin = 4, Top Origin = 98, Width = 100, Height = 12, Usable = 1, Selected = 0, Group ID = 0, Font = Standard)
#define MiscOptionsAspectRatioCheckbox            1622	//(Left Origin = 4, Top Origin = 105, Width = 100, Height = 12, Usable = 1, Selected = 0, Group ID = 0, Font = Standard)
#define MiscOptionsDebugCheckbox                  1623	//(Left Origin = 4, Top Origin = 112, Width = 100, Height = 12, Usable = 1, Selected = 0, Group ID = 0, Font = Standard)
#define MiscOptionsDemoCheckbox                   1624	//(Left Origin = 4, Top Origin = 119, Width = 100, Height = 12, Usable = 1, Selected = 0, Group ID = 0, Font = Standard)
#define MiscOptionsCopyProtectionCheckbox         1625	//(Left Origin = 4, Top Origin = 126, Width = 120, Height = 12, Usable = 1, Selected = 0, Group ID = 0, Font = Standard)
#define MiscOptionsDebugLevelField                1630	//(Left Origin = 103, Top Origin = 105, Width = 12, Height = 12, Usable = 1, Editable = 1, Underline = 1, Single Line = 1, Dynamic Size = 0, Left Justified = 1, Max Characters = 1, Font = Standard, Auto Shift = 0, Has Scroll Bar = 0, Numeric = 1)
#define MiscOptionsTabTitlePalmLabel              1600	//(Left Origin = 4, Top Origin = 33, Usable = 1, Font = Bold)
#define MiscOptionsTabTitleScummLabel             1620	//(Left Origin = 4, Top Origin = 86, Usable = 1, Font = Bold)
#define MiscOptionsTabPalmPushButton              1672	//(Left Origin = 4, Top Origin = 16, Width = 40, Height = 12, Usable = 1, Group ID = 0, Font = Standard)
#define MiscOptionsTabScummPushButton             1673	//(Left Origin = 45, Top Origin = 18, Width = 50, Height = 10, Usable = 1, Group ID = 0, Font = Standard)
...
#define SoundDriverList                           1811	//(Left Origin = 54, Top Origin = 40, Width = 80, Usable = 0, Font = Standard, Visible Items = 5)

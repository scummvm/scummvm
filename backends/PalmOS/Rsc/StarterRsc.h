...
//
//	Generated at 8:20:46 PM on Tuesday, July 29, 2003
//
...
#define MiscOptionsOKButton                       1608	//(Left Origin = 5, Top Origin = 138, Width = 36, Height = 12, Usable = 1, Anchor Left = 1, Frame = 1, Non-bold Frame = 1, Font = Standard)
#define MiscOptionsCancelButton                   1609	//(Left Origin = 46, Top Origin = 138, Width = 36, Height = 12, Usable = 1, Anchor Left = 1, Frame = 1, Non-bold Frame = 1, Font = Standard)
...
#define MiscOptionsDebugCheckbox                  1606	//(Left Origin = 4, Top Origin = 92, Width = 100, Height = 12, Usable = 1, Selected = 0, Group ID = 0, Font = Standard)
#define MiscOptionsWriteIniCheckbox               1610	//(Left Origin = 4, Top Origin = 104, Width = 99, Height = 12, Usable = 1, Selected = 0, Group ID = 0, Font = Standard)
#define MiscOptionsAutoResetCheckbox              1611	//(Left Origin = 4, Top Origin = 64, Width = 105, Height = 12, Usable = 1, Selected = 0, Group ID = 0, Font = Standard)
#define MiscOptionsDemoCheckbox                   1612	//(Left Origin = 4, Top Origin = 116, Width = 100, Height = 12, Usable = 1, Selected = 0, Group ID = 0, Font = Standard)
#define MiscOptionsDebugLevelField                1607	//(Left Origin = 103, Top Origin = 92, Width = 12, Height = 12, Usable = 1, Editable = 1, Underline = 1, Single Line = 1, Dynamic Size = 0, Left Justified = 1, Max Characters = 1, Font = Standard, Auto Shift = 0, Has Scroll Bar = 0, Numeric = 1)
#define MiscOptionsUnnamed1601Label               1601	//(Left Origin = 4, Top Origin = 16, Usable = 1, Font = Bold)
#define MiscOptionsUnnamed1605Label               1605	//(Left Origin = 4, Top Origin = 80, Usable = 1, Font = Bold)

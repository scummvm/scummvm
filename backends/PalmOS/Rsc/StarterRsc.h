...
//
//	Generated at 12:57:59  on mercredi 4 juin 2003
//
...
#define MiscOptionsUnnamed1605Label               1605	//(Left Origin = 4, Top Origin = 87, Usable = 1, Font = Bold)
...
#define SoundTempoField                           1802	//(Left Origin = 54, Top Origin = 53, Width = 16, Height = 12, Usable = 1, Editable = 1, Underline = 1, Single Line = 1, Dynamic Size = 0, Left Justified = 1, Max Characters = 3, Font = Standard, Auto Shift = 0, Has Scroll Bar = 0, Numeric = 1)
...
#define SoundUnnamed1807Label                     1807	//(Left Origin = 72, Top Origin = 54, Usable = 1, Font = Standard)
#define SoundDriverList                           1811	//(Left Origin = 54, Top Origin = 40, Width = 80, Usable = 0, Font = Standard, Visible Items = 2)
#define SoundDriverPopTrigger                     1805	//(Left Origin = 54, Top Origin = 40, Width = 93, Height = 12, Usable = 1, Anchor Left = 1, Font = Standard, List ID = 1811)
...
#define MainOptionsMisc                           1004	//  Command Key: M

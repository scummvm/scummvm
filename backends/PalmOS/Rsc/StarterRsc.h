...
#define MiscOptionsDebugCheckbox                  1606	//(Left Origin = 4, Top Origin = 96, Width = 100, Height = 12, Usable = 1, Selected = 0, Group ID = 0, Font = Standard)
#define MiscOptionsWriteIniCheckbox               1610	//(Left Origin = 4, Top Origin = 108, Width = 99, Height = 12, Usable = 1, Selected = 0, Group ID = 0, Font = Standard)
...
#define MiscOptionsDebugLevelField                1607	//(Left Origin = 103, Top Origin = 96, Width = 12, Height = 12, Usable = 1, Editable = 1, Underline = 1, Single Line = 1, Dynamic Size = 0, Left Justified = 1, Max Characters = 1, Font = Standard, Auto Shift = 0, Has Scroll Bar = 0, Numeric = 1)
#define MiscOptionsUnnamed1601Label               1601	//(Left Origin = 4, Top Origin = 16, Usable = 1, Font = Bold)
#define MiscOptionsUnnamed1605Label               1605	//(Left Origin = 4, Top Origin = 84, Usable = 1, Font = Bold)

...
//
//	Generated at 10:55:49  on mardi 2 décembre 2003
//
...
#define MiscOptionsVibratorCheckbox               1601	//(Left Origin = 4, Top Origin = 56, Width = 128, Height = 12, Usable = 1, Selected = 0, Group ID = 0, Font = Standard)
#define MiscOptionsNoAutoOffCheckbox              1602	//(Left Origin = 4, Top Origin = 63, Width = 152, Height = 12, Usable = 1, Selected = 0, Group ID = 0, Font = Standard)
#define MiscOptionsStdPaletteCheckbox             1603	//(Left Origin = 4, Top Origin = 70, Width = 146, Height = 12, Usable = 1, Selected = 0, Group ID = 0, Font = Standard)
#define MiscOptionsAutoResetCheckbox              1604	//(Left Origin = 4, Top Origin = 77, Width = 105, Height = 12, Usable = 1, Selected = 0, Group ID = 0, Font = Standard)
#define MiscOptionsLargerStackCheckbox            1605	//(Left Origin = 4, Top Origin = 84, Width = 100, Height = 12, Usable = 1, Selected = 0, Group ID = 0, Font = Standard)
#define MiscOptionsFullscreenCheckbox             1621	//(Left Origin = 4, Top Origin = 109, Width = 100, Height = 12, Usable = 1, Selected = 0, Group ID = 0, Font = Standard)
#define MiscOptionsDebugCheckbox                  1622	//(Left Origin = 4, Top Origin = 116, Width = 100, Height = 12, Usable = 1, Selected = 0, Group ID = 0, Font = Standard)
#define MiscOptionsDemoCheckbox                   1623	//(Left Origin = 4, Top Origin = 123, Width = 100, Height = 12, Usable = 1, Selected = 0, Group ID = 0, Font = Standard)
#define MiscOptionsDebugLevelField                1630	//(Left Origin = 103, Top Origin = 116, Width = 12, Height = 12, Usable = 1, Editable = 1, Underline = 1, Single Line = 1, Dynamic Size = 0, Left Justified = 1, Max Characters = 1, Font = Standard, Auto Shift = 0, Has Scroll Bar = 0, Numeric = 1)
#define MiscOptionsTabTitlePalmLabel              1600	//(Left Origin = 4, Top Origin = 44, Usable = 1, Font = Bold)
#define MiscOptionsTabTitleScummLabel             1620	//(Left Origin = 4, Top Origin = 97, Usable = 1, Font = Bold)
...
#define MainGamesMemoryCards                      1104	//  Command Key: C

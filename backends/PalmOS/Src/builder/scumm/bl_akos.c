...
static void addAkos_oldScaleTable() {
	UInt8 oldScaleTable[256] = {
	...
	writeRecord(oldScaleTable, sizeof(oldScaleTable), GBVARS_OLDSCALETABLE_INDEX , GBVARS_SCUMM);
}

...
#ifndef BACKENDS_GRAPHICS_GLESKMS_GRAPHICS_H
#define BACKENDS_GRAPHICS_GLESKMS_GRAPHICS_H
...
class OpenGLRPIGraphicsManager : public OpenGL::OpenGLGraphicsManager, public SdlGraphicsManager, public Common::EventObserver {
public:
	OpenGLRPIGraphicsManager(SdlEventSource *eventSource);
	virtual ~OpenGLRPIGraphicsManager();
